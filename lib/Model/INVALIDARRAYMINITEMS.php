...
/**
 * INVALIDARRAYMINITEMS Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDARRAYMINITEMS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_ARRAY_MIN_ITEMS';
    ...
    public const ISSUE_INVALID_ARRAY_MIN_ITEMS = 'INVALID_ARRAY_MIN_ITEMS';
    public const DESCRIPTION_THE_NUMBER_OF_ITEMS_IN_AN_ARRAY_PARAMETER_IS_TOO_SMALL = 'The number of items in an array parameter is too small.';
    ...
    {
        return [
            self::ISSUE_INVALID_ARRAY_MIN_ITEMS,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_NUMBER_OF_ITEMS_IN_AN_ARRAY_PARAMETER_IS_TOO_SMALL,
        ];
    }
