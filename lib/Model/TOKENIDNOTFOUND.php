...
/**
 * TOKENIDNOTFOUND Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TOKENIDNOTFOUND implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TOKEN_ID_NOT_FOUND';
    ...
    public const ISSUE_TOKEN_ID_NOT_FOUND = 'TOKEN_ID_NOT_FOUND';
    public const DESCRIPTION_SPECIFIED_TOKEN_WAS_NOT_FOUND__VERIFY_THE_TOKEN_AND_TRY_THE_REQUEST_AGAIN = 'Specified token was not found. Verify the token and try the request again.';
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_TOKEN_WAS_NOT_FOUND__VERIFY_THE_TOKEN_AND_TRY_THE_REQUEST_AGAIN,
        ];
    }
