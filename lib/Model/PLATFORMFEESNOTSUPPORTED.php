...
/**
 * PLATFORMFEESNOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PLATFORMFEESNOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PLATFORM_FEES_NOT_SUPPORTED';
    ...
    public const ISSUE_PLATFORM_FEES_NOT_SUPPORTED = 'PLATFORM_FEES_NOT_SUPPORTED';
    public const DESCRIPTION_THE_API_CALLER_IS_NOT_ENABLED_TO_PROCESS_TRANSACTIONS_BY_SPECIFYING_PLATFORM_FEES__PLEASE_WORK_WITH_YOUR_PAY_PAL_ACCOUNT_MANAGER_TO_ENABLE_THIS_OPTION_FOR_YOUR_ACCOUNT = 'The API Caller is not enabled to process transactions by specifying 'platform_fees'. Please work with your PayPal Account Manager to enable this option for your account.';
    ...
    {
        return [
            self::ISSUE_PLATFORM_FEES_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_IS_NOT_ENABLED_TO_PROCESS_TRANSACTIONS_BY_SPECIFYING_PLATFORM_FEES__PLEASE_WORK_WITH_YOUR_PAY_PAL_ACCOUNT_MANAGER_TO_ENABLE_THIS_OPTION_FOR_YOUR_ACCOUNT,
        ];
    }
