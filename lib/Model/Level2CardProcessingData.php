...
/**
 * Level2CardProcessingData Class Doc Comment
 *
 * @category Class
 ...
 */
class Level2CardProcessingData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'level_2_card_processing_data';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['invoice_id']) && (mb_strlen($this->container['invoice_id']) > 17)) {
            $invalidProperties[] = "invalid value for 'invoice_id', the character length must be smaller than or equal to 17.";
        }
        ...
        if (!is_null($this->container['invoice_id']) && !preg_match("/^[\\w‘\\-.,\":;\\!?]*$/", $this->container['invoice_id'])) {
            $invalidProperties[] = "invalid value for 'invoice_id', must be conform to the pattern /^[\\w‘\\-.,\":;\\!?]*$/.";
        }
    ...
    public function setInvoiceId($invoice_id)
    {
        ...
        if ((mb_strlen($invoice_id) > 17)) {
            throw new \InvalidArgumentException('invalid length for $invoice_id when calling Level2CardProcessingData., must be smaller than or equal to 17.');
        }
        if ((mb_strlen($invoice_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $invoice_id when calling Level2CardProcessingData., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\w‘\\-.,\":;\\!?]*$/", $invoice_id))) {
            throw new \InvalidArgumentException("invalid value for \$invoice_id when calling Level2CardProcessingData., must conform to the pattern /^[\\w‘\\-.,\":;\\!?]*$/.");
        }
