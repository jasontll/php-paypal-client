...
class StoreInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'store_info';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['store_id']) && !preg_match("/^[a-zA-Z0-9]*$/", $this->container['store_id'])) {
            $invalidProperties[] = "invalid value for 'store_id', must be conform to the pattern /^[a-zA-Z0-9]*$/.";
        }

        if (!is_null($this->container['terminal_id']) && (mb_strlen($this->container['terminal_id']) > 60)) {
            $invalidProperties[] = "invalid value for 'terminal_id', the character length must be smaller than or equal to 60.";
        }
     ...
     * Sets store_id
     *
     * @param string|null $store_id The ID of a store for a merchant in the system of record.
     *
     * @return self
     */
    public function setStoreId($store_id)
    {
        ...
        if ((mb_strlen($store_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $store_id when calling StoreInfo., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($store_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_id when calling StoreInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]*$/", $store_id))) {
            throw new \InvalidArgumentException("invalid value for \$store_id when calling StoreInfo., must conform to the pattern /^[a-zA-Z0-9]*$/.");
        }
     ...
     * Sets terminal_id
     *
     * @param string|null $terminal_id The terminal ID for the checkout stand in a merchant store.
     *
     * @return self
     */
    public function setTerminalId($terminal_id)
    {
        ...
        if ((mb_strlen($terminal_id) > 60)) {
            throw new \InvalidArgumentException('invalid length for $terminal_id when calling StoreInfo., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($terminal_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $terminal_id when calling StoreInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]*$/", $terminal_id))) {
            throw new \InvalidArgumentException("invalid value for \$terminal_id when calling StoreInfo., must conform to the pattern /^[a-zA-Z0-9]*$/.");
        }
