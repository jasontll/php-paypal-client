...
/**
 * INVALIDPREVIOUSTRANSACTIONREFERENCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPREVIOUSTRANSACTIONREFERENCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PREVIOUS_TRANSACTION_REFERENCE';
    ...
    public const ISSUE_INVALID_PREVIOUS_TRANSACTION_REFERENCE = 'INVALID_PREVIOUS_TRANSACTION_REFERENCE';
    public const DESCRIPTION_THE_AUTHORIZATION_OR_CAPTURE_REFERENCED_BY_PREVIOUS_TRANSACTION_REFERENCE_IS_NOT_VALID__THIS_COULD_BE_EITHER_BECAUSE_THE_PREVIOUS_TRANSACTION_REFERENCE_IS_NOT_FOUND_OR_DOESNT_BELONG_TO_THE_PAYEE__PLEASE_USE_A_VALID_PREVIOUS_TRANSACTION_REFERENCE = 'The authorization or capture referenced by `previous_transaction_reference` is not valid. This could be either because the previous_transaction_reference is not found or doesn't belong to the payee. Please use a valid `previous_transaction_reference`.';
    ...
    {
        return [
            self::ISSUE_INVALID_PREVIOUS_TRANSACTION_REFERENCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_AUTHORIZATION_OR_CAPTURE_REFERENCED_BY_PREVIOUS_TRANSACTION_REFERENCE_IS_NOT_VALID__THIS_COULD_BE_EITHER_BECAUSE_THE_PREVIOUS_TRANSACTION_REFERENCE_IS_NOT_FOUND_OR_DOESNT_BELONG_TO_THE_PAYEE__PLEASE_USE_A_VALID_PREVIOUS_TRANSACTION_REFERENCE,
        ];
    }
