...
/**
 * INVALIDACCOUNTSTATUS Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDACCOUNTSTATUS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_ACCOUNT_STATUS';
    ...
    public const ISSUE_INVALID_ACCOUNT_STATUS = 'INVALID_ACCOUNT_STATUS';
    public const DESCRIPTION_ACCOUNT_VALIDATIONS_FAILED_FOR_THE_USER = 'Account validations failed for the user.';
    ...
    {
        return [
            self::ISSUE_INVALID_ACCOUNT_STATUS,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ACCOUNT_VALIDATIONS_FAILED_FOR_THE_USER,
        ];
    }
