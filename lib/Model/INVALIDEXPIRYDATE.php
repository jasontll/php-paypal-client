...
/**
 * INVALIDEXPIRYDATE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDEXPIRYDATE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_EXPIRY_DATE';
    ...
    public const ISSUE_INVALID_EXPIRY_DATE = 'INVALID_EXPIRY_DATE';
    public const DESCRIPTION_EXPIRY_DATE_IS_INVALID__EXPIRY_DATE_SHOULD_BE_A_DATE_IN_FUTURE_AND_WITHIN_THE_THRESHOLD_FOR_THE_PAYMENT_SOURCE = 'Expiry date is invalid. Expiry date should be a date in future and within the threshold for the payment source.';
    ...
    {
        return [
            self::ISSUE_INVALID_EXPIRY_DATE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_EXPIRY_DATE_IS_INVALID__EXPIRY_DATE_SHOULD_BE_A_DATE_IN_FUTURE_AND_WITHIN_THE_THRESHOLD_FOR_THE_PAYMENT_SOURCE,
        ];
    }
