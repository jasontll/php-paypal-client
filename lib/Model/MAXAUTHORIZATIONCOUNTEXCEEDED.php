...
/**
 * MAXAUTHORIZATIONCOUNTEXCEEDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MAXAUTHORIZATIONCOUNTEXCEEDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MAX_AUTHORIZATION_COUNT_EXCEEDED';
    ...
    public const ISSUE_MAX_AUTHORIZATION_COUNT_EXCEEDED = 'MAX_AUTHORIZATION_COUNT_EXCEEDED';
    public const DESCRIPTION_MAXIMUM_NUMBER_OF_AUTHORIZATION_ALLOWED_FOR_THE_ORDER_IS_REACHED__PLEASE_CONTACT_CUSTOMER_SUPPORT_IF_YOU_NEED_TO_INCREASE_YOUR_LIMIT = 'Maximum number of authorization allowed for the order is reached. Please contact Customer Support if you need to increase your limit.';
    ...
    {
        return [
            self::ISSUE_MAX_AUTHORIZATION_COUNT_EXCEEDED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_MAXIMUM_NUMBER_OF_AUTHORIZATION_ALLOWED_FOR_THE_ORDER_IS_REACHED__PLEASE_CONTACT_CUSTOMER_SUPPORT_IF_YOU_NEED_TO_INCREASE_YOUR_LIMIT,
        ];
    }
