...
/**
 * VAULTINSTRUCTIONDUPLICATED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VAULTINSTRUCTIONDUPLICATED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VAULT_INSTRUCTION_DUPLICATED';
    ...
    public const ISSUE_VAULT_INSTRUCTION_DUPLICATED = 'VAULT_INSTRUCTION_DUPLICATED';
    public const DESCRIPTION_ONLY_ONE_VAULT_INSTRUCTION_IS_ALLOWED__PLEASE_USE_VAULT_STORE_IN_VAULT_TO_PROVIDE_VAULT_INSTRUCTION = 'Only one vault instruction is allowed. Please use `vault.store_in_vault` to provide vault instruction.';
    ...
    {
        return [
            self::ISSUE_VAULT_INSTRUCTION_DUPLICATED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ONLY_ONE_VAULT_INSTRUCTION_IS_ALLOWED__PLEASE_USE_VAULT_STORE_IN_VAULT_TO_PROVIDE_VAULT_INSTRUCTION,
        ];
    }
