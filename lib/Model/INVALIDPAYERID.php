...
/**
 * INVALIDPAYERID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPAYERID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PAYER_ID';
    ...
    public const ISSUE_INVALID_PAYER_ID = 'INVALID_PAYER_ID';
    public const DESCRIPTION_THE_PAYER_ID_IS_NOT_VALID = 'The payer ID is not valid.';
    ...
    {
        return [
            self::DESCRIPTION_THE_PAYER_ID_IS_NOT_VALID,
        ];
    }
