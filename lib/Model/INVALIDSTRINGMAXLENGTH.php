...
/**
 * INVALIDSTRINGMAXLENGTH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDSTRINGMAXLENGTH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_STRING_MAX_LENGTH';
    ...
    public const ISSUE_INVALID_STRING_MAX_LENGTH = 'INVALID_STRING_MAX_LENGTH';
    public const DESCRIPTION_THE_VALUE_OF_A_FIELD_IS_TOO_LONG = 'The value of a field is too long.';
    ...
    {
        return [
            self::ISSUE_INVALID_STRING_MAX_LENGTH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_VALUE_OF_A_FIELD_IS_TOO_LONG,
        ];
    }
