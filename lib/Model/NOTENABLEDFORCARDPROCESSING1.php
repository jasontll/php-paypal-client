...
/**
 * NOTENABLEDFORCARDPROCESSING1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTENABLEDFORCARDPROCESSING1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ENABLED_FOR_CARD_PROCESSING_1';
    ...
    public const DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_CARD_PAYMENTS__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT = 'The API Caller account is not setup to be able to process card payments. Please contact PayPal customer support.';
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_CARD_PAYMENTS__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT,
        ];
    }
