...
/**
 * OrdersTrackCreate422IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersTrackCreate422IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_track_create_422_issues_inner';
    ...
    public const ISSUE_MSP_NOT_SUPPORTED = 'MSP_NOT_SUPPORTED';
    public const DESCRIPTION_MULTIPLE_PURCHASE_UNITS_ARE_NOT_SUPPORTED_FOR_THIS_OPERATION = 'Multiple purchase units are not supported for this operation.';
    ...
    {
        return [
            self::DESCRIPTION_MULTIPLE_PURCHASE_UNITS_ARE_NOT_SUPPORTED_FOR_THIS_OPERATION,
        ];
    }
