...
/**
 * CAPTURESTATUSNOTVALID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CAPTURESTATUSNOTVALID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CAPTURE_STATUS_NOT_VALID';
    ...
    public const ISSUE_CAPTURE_STATUS_NOT_VALID = 'CAPTURE_STATUS_NOT_VALID';
    public const DESCRIPTION_INVALID_CAPTURE_STATUS__TRACKER_INFORMATION_CAN_ONLY_BE_ADDED_TO_CAPTURES_IN_COMPLETED_STATE = 'Invalid capture status. Tracker information can only be added to captures in `COMPLETED` state.';
    ...
    {
        return [
            self::ISSUE_CAPTURE_STATUS_NOT_VALID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_INVALID_CAPTURE_STATUS__TRACKER_INFORMATION_CAN_ONLY_BE_ADDED_TO_CAPTURES_IN_COMPLETED_STATE,
        ];
    }
