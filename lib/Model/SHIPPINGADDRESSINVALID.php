...
/**
 * SHIPPINGADDRESSINVALID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SHIPPINGADDRESSINVALID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SHIPPING_ADDRESS_INVALID';
    ...
    public const ISSUE_SHIPPING_ADDRESS_INVALID = 'SHIPPING_ADDRESS_INVALID';
    public const DESCRIPTION_PROVIDED_SHIPPING_ADDRESS_IS_INVALID = 'Provided shipping address is invalid.';
    ...
    {
        return [
            self::ISSUE_SHIPPING_ADDRESS_INVALID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PROVIDED_SHIPPING_ADDRESS_IS_INVALID,
        ];
    }
