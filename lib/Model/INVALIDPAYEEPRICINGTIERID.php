...
/**
 * INVALIDPAYEEPRICINGTIERID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPAYEEPRICINGTIERID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PAYEE_PRICING_TIER_ID';
    ...
    public const ISSUE_INVALID_PAYEE_PRICING_TIER_ID = 'INVALID_PAYEE_PRICING_TIER_ID';
    public const DESCRIPTION_PLEASE_CHECK_THE_VALUE_SPECIFIED_OR_CONFIRM_WITH_YOUR_ACCOUNT_MANAGER_THAT_THE_PAYEE_PRICING_TIER_ID_SPECIFIED_HAS_BEEN_SETUP_FOR_THE_ACCOUNT = 'Please check the value specified or confirm with your Account Manager that the 'payee_pricing_tier_id' specified has been setup for the account.';
    ...
    {
        return [
            self::ISSUE_INVALID_PAYEE_PRICING_TIER_ID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PLEASE_CHECK_THE_VALUE_SPECIFIED_OR_CONFIRM_WITH_YOUR_ACCOUNT_MANAGER_THAT_THE_PAYEE_PRICING_TIER_ID_SPECIFIED_HAS_BEEN_SETUP_FOR_THE_ACCOUNT,
        ];
    }
