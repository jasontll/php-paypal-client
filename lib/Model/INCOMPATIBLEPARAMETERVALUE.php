...
/**
 * INCOMPATIBLEPARAMETERVALUE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INCOMPATIBLEPARAMETERVALUE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INCOMPATIBLE_PARAMETER_VALUE';
    ...
    public const ISSUE_INCOMPATIBLE_PARAMETER_VALUE = 'INCOMPATIBLE_PARAMETER_VALUE';
    public const DESCRIPTION_THE_VALUE_OF_THE_FIELD_IS_INCOMPATIBLE_REDUNDANT_WITH_OTHER_FIELDS_IN_THE_ORDER = 'The value of the field is incompatible/redundant with other fields in the order.';
    ...
    {
        return [
            self::ISSUE_INCOMPATIBLE_PARAMETER_VALUE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_VALUE_OF_THE_FIELD_IS_INCOMPATIBLE_REDUNDANT_WITH_OTHER_FIELDS_IN_THE_ORDER,
        ];
    }
