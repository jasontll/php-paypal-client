...
/**
 * DECLINEDDUETORELATEDTXN Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DECLINEDDUETORELATEDTXN implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DECLINED_DUE_TO_RELATED_TXN';
    ...
    public const ISSUE_DECLINED_DUE_TO_RELATED_TXN = 'DECLINED_DUE_TO_RELATED_TXN';
    public const DESCRIPTION_ONE_OR_MORE_TRANSACTIONS_IN_THIS_ORDER_DID_NOT_SUCCEED__SINCE_THIS_ORDER_IS_BEING_PROCESSED_AS_AN_ALL_OR_NONE_ORDER_IF_ONE_OR_MORE_TRANSACTIONS_IN_THIS_ORDER_DO_NOT_SUCCEED_THEN_ALL_PURCHASE_UNITS_ARE_MARKED_DECLINED_AND_WILL_NOT_BE_PROCESSED = 'One or more transactions in this Order did not succeed. Since this Order is being processed as an All or None Order, if one or more transactions in this Order do not succeed, then all purchase units are marked declined and will not be processed.';
    ...
    {
        return [
            self::ISSUE_DECLINED_DUE_TO_RELATED_TXN,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ONE_OR_MORE_TRANSACTIONS_IN_THIS_ORDER_DID_NOT_SUCCEED__SINCE_THIS_ORDER_IS_BEING_PROCESSED_AS_AN_ALL_OR_NONE_ORDER_IF_ONE_OR_MORE_TRANSACTIONS_IN_THIS_ORDER_DO_NOT_SUCCEED_THEN_ALL_PURCHASE_UNITS_ARE_MARKED_DECLINED_AND_WILL_NOT_BE_PROCESSED,
        ];
    }
