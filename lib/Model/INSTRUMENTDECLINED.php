...
/**
 * INSTRUMENTDECLINED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INSTRUMENTDECLINED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INSTRUMENT_DECLINED';
    ...
    public const ISSUE_INSTRUMENT_DECLINED = 'INSTRUMENT_DECLINED';
    public const DESCRIPTION_THE_INSTRUMENT_PRESENTED__WAS_EITHER_DECLINED_BY_THE_PROCESSOR_OR_BANK_OR_IT_CANT_BE_USED_FOR_THIS_PAYMENT = 'The instrument presented  was either declined by the processor or bank, or it can't be used for this payment.';
    ...
    {
        return [
            self::ISSUE_INSTRUMENT_DECLINED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_INSTRUMENT_PRESENTED__WAS_EITHER_DECLINED_BY_THE_PROCESSOR_OR_BANK_OR_IT_CANT_BE_USED_FOR_THIS_PAYMENT,
        ];
    }
