...
/**
 * SAVEORDERNOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SAVEORDERNOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SAVE_ORDER_NOT_SUPPORTED';
    ...
    public const ISSUE_SAVE_ORDER_NOT_SUPPORTED = 'SAVE_ORDER_NOT_SUPPORTED';
    public const DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_SETUP_IN_A_WAY_THAT_DOES_NOT_ALLOW_IT_TO_BE_USED_FOR_SAVING_THE_ORDER__THIS_FUNCTIONALITY_IS_NOT_AVAILABLE_FOR_PAY_PAL_COMMERCE_PLATFORM_FOR_PLATFORMS__MARKETPLACES = 'The API caller account is setup in a way that does not allow it to be used for saving the order. This functionality is not available for PayPal Commerce Platform for Platforms & Marketplaces.';
    ...
    {
        return [
            self::ISSUE_SAVE_ORDER_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_SETUP_IN_A_WAY_THAT_DOES_NOT_ALLOW_IT_TO_BE_USED_FOR_SAVING_THE_ORDER__THIS_FUNCTIONALITY_IS_NOT_AVAILABLE_FOR_PAY_PAL_COMMERCE_PLATFORM_FOR_PLATFORMS__MARKETPLACES,
        ];
    }
