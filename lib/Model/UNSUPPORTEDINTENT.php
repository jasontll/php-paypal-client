...
/**
 * UNSUPPORTEDINTENT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UNSUPPORTEDINTENT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNSUPPORTED_INTENT';
    ...
    public const ISSUE_UNSUPPORTED_INTENT = 'UNSUPPORTED_INTENT';
    public const DESCRIPTION_INTENTAUTHORIZE_IS_NOT_SUPPORTED_FOR_MULTIPLE_PURCHASE_UNITS__ONLY_INTENTCAPTURE_IS_SUPPORTED = '`intent=AUTHORIZE` is not supported for multiple purchase units. Only `intent=CAPTURE` is supported.';
    ...
    {
        return [
            self::DESCRIPTION_INTENTAUTHORIZE_IS_NOT_SUPPORTED_FOR_MULTIPLE_PURCHASE_UNITS__ONLY_INTENTCAPTURE_IS_SUPPORTED,
        ];
    }
