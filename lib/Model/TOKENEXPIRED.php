...
/**
 * TOKENEXPIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TOKENEXPIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TOKEN_EXPIRED';
    ...
    public const ISSUE_TOKEN_EXPIRED = 'TOKEN_EXPIRED';
    public const DESCRIPTION_THE_TOKEN_IS_EXPIRED_AND_CANNOT_BE_USED_FOR_PAYMENT = 'The token is expired and cannot be used for payment.';
    ...
    {
        return [
            self::DESCRIPTION_THE_TOKEN_IS_EXPIRED_AND_CANNOT_BE_USED_FOR_PAYMENT,
        ];
    }
