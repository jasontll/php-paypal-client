...
/**
 * CobrandedCard Class Doc Comment
 *
 * @category Class
 ...
 */
class CobrandedCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cobranded_card';
    ...
    protected static $openAPITypes = [
        'labels' => 'string[]',
        'payee' => '\OpenAPI\Client\Model\PayeeBase',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['labels']) && (count($this->container['labels']) < 1)) {
    ...
    public function setLabels($labels)
    {
        ...
        if ((count($labels) > 25)) {
            throw new \InvalidArgumentException('invalid value for $labels when calling CobrandedCard., number of items must be less than or equal to 25.');
        }
        if ((count($labels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $labels when calling CobrandedCard., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets payee
     *
     * @param \OpenAPI\Client\Model\PayeeBase|null $payee payee
     *
     * @return self
     */
