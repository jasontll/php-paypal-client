...
/**
 * INVALIDPLATFORMFEESACCOUNT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPLATFORMFEESACCOUNT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PLATFORM_FEES_ACCOUNT';
    ...
    public const ISSUE_INVALID_PLATFORM_FEES_ACCOUNT = 'INVALID_PLATFORM_FEES_ACCOUNT';
    public const DESCRIPTION_THE_SPECIFIED_PLATFORM_FEES_PAYEE_ACCOUNT_IS_EITHER_INVALID_OR_ACCOUNT_SETUP_IS_INCOMPLETE_PLEASE_WORK_WITH_YOUR_PAY_PAL_ACCOUNT_MANAGER_TO_ENABLE_THIS_OPTION_FOR_YOUR_ACCOUNT = 'The specified platform_fees payee account is either invalid or account setup is incomplete.Please work with your PayPal Account Manager to enable this option for your account.';
    ...
    {
        return [
            self::ISSUE_INVALID_PLATFORM_FEES_ACCOUNT,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_SPECIFIED_PLATFORM_FEES_PAYEE_ACCOUNT_IS_EITHER_INVALID_OR_ACCOUNT_SETUP_IS_INCOMPLETE_PLEASE_WORK_WITH_YOUR_PAY_PAL_ACCOUNT_MANAGER_TO_ENABLE_THIS_OPTION_FOR_YOUR_ACCOUNT,
        ];
    }
