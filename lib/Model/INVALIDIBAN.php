 ...
 */
class INVALIDIBAN implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_IBAN';
    ...
    public const ISSUE_INVALID_IBAN = 'INVALID_IBAN';
    public const DESCRIPTION_IBAN_PROVIDED_IS_NOT_A_VALID_BANK_ACCOUNT_NUMBER = 'IBAN provided is not a valid bank account number.';
    ...
    {
        return [
            self::DESCRIPTION_IBAN_PROVIDED_IS_NOT_A_VALID_BANK_ACCOUNT_NUMBER,
        ];
    }
