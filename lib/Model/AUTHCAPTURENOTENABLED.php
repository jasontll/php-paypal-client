...
/**
 * AUTHCAPTURENOTENABLED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AUTHCAPTURENOTENABLED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AUTH_CAPTURE_NOT_ENABLED';
    ...
    public const ISSUE_AUTH_CAPTURE_NOT_ENABLED = 'AUTH_CAPTURE_NOT_ENABLED';
    public const DESCRIPTION_AUTHORIZATION_AND_CAPTURE_FEATURE_IS_NOT_ENABLED_FOR_THE_MERCHANT__MAKE_SURE_THAT_THE_RECIPIENT_OF_THE_FUNDS_IS_A_VERIFIED_BUSINESS_ACCOUNT = 'Authorization and Capture feature is not enabled for the merchant. Make sure that the recipient of the funds is a verified business account.';
    ...
    {
        return [
            self::ISSUE_AUTH_CAPTURE_NOT_ENABLED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_AUTHORIZATION_AND_CAPTURE_FEATURE_IS_NOT_ENABLED_FOR_THE_MERCHANT__MAKE_SURE_THAT_THE_RECIPIENT_OF_THE_FUNDS_IS_A_VERIFIED_BUSINESS_ACCOUNT,
        ];
    }
