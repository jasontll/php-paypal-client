...
/**
 * PATCHVALUEREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PATCHVALUEREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PATCH_VALUE_REQUIRED';
    ...
    public const ISSUE_PATCH_VALUE_REQUIRED = 'PATCH_VALUE_REQUIRED';
    public const DESCRIPTION_PLEASE_SPECIFY_A_VALUE_TO_FOR_THE_FIELD_THAT_IS_BEING_PATCHED = 'Please specify a 'value' to for the field that is being patched.';
    ...
    {
        return [
            self::ISSUE_PATCH_VALUE_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PLEASE_SPECIFY_A_VALUE_TO_FOR_THE_FIELD_THAT_IS_BEING_PATCHED,
        ];
    }
