...
class COMPLIANCEVIOLATION implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'COMPLIANCE_VIOLATION';
    ...
    public const ISSUE_COMPLIANCE_VIOLATION = 'COMPLIANCE_VIOLATION';
    public const DESCRIPTION_TRANSACTION_IS_DECLINED_DUE_TO_COMPLIANCE_VIOLATION = 'Transaction is declined due to compliance violation.';
    ...
    {
        return [
            self::ISSUE_COMPLIANCE_VIOLATION,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_TRANSACTION_IS_DECLINED_DUE_TO_COMPLIANCE_VIOLATION,
        ];
    }
