...
/**
 * PREVIOUSTRANSACTIONREFERENCEVOIDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PREVIOUSTRANSACTIONREFERENCEVOIDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PREVIOUS_TRANSACTION_REFERENCE_VOIDED';
    ...
    public const ISSUE_PREVIOUS_TRANSACTION_REFERENCE_VOIDED = 'PREVIOUS_TRANSACTION_REFERENCE_VOIDED';
    public const DESCRIPTION_THE_STATUS_OF_AUTHORIZATION_REFERENCED_BY_PREVIOUS_TRANSACTION_REFERENCE_IS_VOIDED_AND_HENCE_CANNOT_BE_USED_FOR_THIS_ORDER__PLEASE_USE_A_PREVIOUS_TRANSACTION_REFERENCE_WHOSE_STATUS_IS_NOT_VOIDED = 'The status of authorization referenced by `previous_transaction_reference` is `VOIDED` and hence cannot be used for this order. Please use a `previous_transaction_reference` whose status is not `VOIDED`.';
    ...
    {
        return [
            self::ISSUE_PREVIOUS_TRANSACTION_REFERENCE_VOIDED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_STATUS_OF_AUTHORIZATION_REFERENCED_BY_PREVIOUS_TRANSACTION_REFERENCE_IS_VOIDED_AND_HENCE_CANNOT_BE_USED_FOR_THIS_ORDER__PLEASE_USE_A_PREVIOUS_TRANSACTION_REFERENCE_WHOSE_STATUS_IS_NOT_VOIDED,
        ];
    }
