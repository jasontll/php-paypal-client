...
/**
 * ORDERALREADYAUTHORIZED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERALREADYAUTHORIZED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_ALREADY_AUTHORIZED';
    ...
    public const DESCRIPTION_ORDER_ALREADY_CAPTURED__IF_INTENTCAPTURE_ONLY_ONE_CAPTURE_PER_ORDER_IS_ALLOWED = 'Order already captured. If 'intent=CAPTURE' only one capture per order is allowed.';
    ...
    {
        return [
            self::DESCRIPTION_ORDER_ALREADY_CAPTURED__IF_INTENTCAPTURE_ONLY_ONE_CAPTURE_PER_ORDER_IS_ALLOWED,
        ];
    }
