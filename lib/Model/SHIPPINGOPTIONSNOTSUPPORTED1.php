...
/**
 * SHIPPINGOPTIONSNOTSUPPORTED1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SHIPPINGOPTIONSNOTSUPPORTED1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SHIPPING_OPTIONS_NOT_SUPPORTED_1';
    ...
    public const ISSUE_SHIPPING_OPTIONS_NOT_SUPPORTED = 'SHIPPING_OPTIONS_NOT_SUPPORTED';
    public const DESCRIPTION_SHIPPING_OPTIONS_ARE_NOT_SUPPORTED_WHEN_APPLICATION_CONTEXT_SHIPPING_PREFERENCE_IS_SET_AS_NO_SHIPPING_OR_SET_PROVIDED_ADDRESS = 'Shipping options are not supported when 'application_context.shipping_preference' is set as 'NO_SHIPPING' or 'SET_PROVIDED_ADDRESS'.';
    ...
    {
        return [
            self::ISSUE_SHIPPING_OPTIONS_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SHIPPING_OPTIONS_ARE_NOT_SUPPORTED_WHEN_APPLICATION_CONTEXT_SHIPPING_PREFERENCE_IS_SET_AS_NO_SHIPPING_OR_SET_PROVIDED_ADDRESS,
        ];
    }
