...
/**
 * PAYPALTRANSACTIONIDNOTFOUND Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYPALTRANSACTIONIDNOTFOUND implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYPAL_TRANSACTION_ID_NOT_FOUND';
    ...
    public const ISSUE_PAYPAL_TRANSACTION_ID_NOT_FOUND = 'PAYPAL_TRANSACTION_ID_NOT_FOUND';
    public const DESCRIPTION_SPECIFIED_PAYPAL_TRANSACTION_ID_WAS_NOT_FOUND__VERIFY_THE_VALUE_AND_TRY_THE_REQUEST_AGAIN = 'Specified `paypal_transaction_id` was not found. Verify the value and try the request again.';
    ...
    {
        return [
            self::ISSUE_PAYPAL_TRANSACTION_ID_NOT_FOUND,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_PAYPAL_TRANSACTION_ID_WAS_NOT_FOUND__VERIFY_THE_VALUE_AND_TRY_THE_REQUEST_AGAIN,
        ];
    }
