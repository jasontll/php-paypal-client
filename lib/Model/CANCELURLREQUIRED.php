...
/**
 * CANCELURLREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CANCELURLREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CANCEL_URL_REQUIRED';
    ...
    public const ISSUE_CANCEL_URL_REQUIRED = 'CANCEL_URL_REQUIRED';
    public const DESCRIPTION_THE_CANCEL_URL_IS_REQUIRED_WHEN_ATTEMPTING_TO_VAULT_THIS_SOURCE = 'The cancel url is required when attempting to vault this source.';
    ...
    {
        return [
            self::ISSUE_CANCEL_URL_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_CANCEL_URL_IS_REQUIRED_WHEN_ATTEMPTING_TO_VAULT_THIS_SOURCE,
        ];
    }
