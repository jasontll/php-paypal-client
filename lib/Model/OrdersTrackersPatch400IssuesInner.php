...
/**
 * OrdersTrackersPatch400IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersTrackersPatch400IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_trackers_patch_400_issues_inner';
    ...
    public const ISSUE_MALFORMED_REQUEST_JSON = 'MALFORMED_REQUEST_JSON';
    public const DESCRIPTION_THE_REQUEST_JSON_IS_NOT_WELL_FORMED = 'The request JSON is not well formed.';
    ...
    {
        return [
            self::ISSUE_MALFORMED_REQUEST_JSON,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_REQUEST_JSON_IS_NOT_WELL_FORMED,
        ];
    }
