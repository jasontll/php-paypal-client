...
/**
 * AMOUNTNOTPATCHABLE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AMOUNTNOTPATCHABLE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AMOUNT_NOT_PATCHABLE';
    ...
    public const ISSUE_AMOUNT_NOT_PATCHABLE = 'AMOUNT_NOT_PATCHABLE';
    public const DESCRIPTION_THE_AMOUNT_CANNOT_BE_UPDATED_AS_THE_PAYER_HAS_CHOSEN_AND_APPROVED_A_SPECIFIC_FINANCING_OFFER_FOR_A_GIVEN_AMOUNT__PLEASE_CREATE_A_NEW_ORDER_WITH_THE_UPDATED_ORDER_AMOUNT_AND_HAVE_THE_PAYER_APPROVE_THE_NEW_PAYMENT_TERMS = 'The amount cannot be updated as the 'payer' has chosen and approved a specific financing offer for a given amount. Please Create a new Order with the updated Order amount and have the 'payer' approve the new payment terms.';
    ...
    {
        return [
            self::ISSUE_AMOUNT_NOT_PATCHABLE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_AMOUNT_CANNOT_BE_UPDATED_AS_THE_PAYER_HAS_CHOSEN_AND_APPROVED_A_SPECIFIC_FINANCING_OFFER_FOR_A_GIVEN_AMOUNT__PLEASE_CREATE_A_NEW_ORDER_WITH_THE_UPDATED_ORDER_AMOUNT_AND_HAVE_THE_PAYER_APPROVE_THE_NEW_PAYMENT_TERMS,
        ];
    }
