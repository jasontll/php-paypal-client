...
/**
 * COUNTRYNOTSUPPORTEDBYPAYMENTSOURCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class COUNTRYNOTSUPPORTEDBYPAYMENTSOURCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'COUNTRY_NOT_SUPPORTED_BY_PAYMENT_SOURCE';
    ...
    public const ISSUE_COUNTRY_NOT_SUPPORTED_BY_PAYMENT_SOURCE = 'COUNTRY_NOT_SUPPORTED_BY_PAYMENT_SOURCE';
    public const DESCRIPTION_COUNTRY_CODE_PROVIDED_IS_NOT_SUPPORTED_BY_THE_PROVIDED_PAYMENT_SOURCE = 'Country code provided is not supported by the provided payment source.';
    ...
    {
        return [
            self::ISSUE_COUNTRY_NOT_SUPPORTED_BY_PAYMENT_SOURCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_COUNTRY_CODE_PROVIDED_IS_NOT_SUPPORTED_BY_THE_PROVIDED_PAYMENT_SOURCE,
        ];
    }
