...
/**
 * NOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_SUPPORTED';
    ...
    public const ISSUE_NOT_SUPPORTED = 'NOT_SUPPORTED';
    public const DESCRIPTION_THIS_FIELD_IS_NOT_CURRENTLY_SUPPORTED = 'This field is not currently supported.';
    ...
    {
        return [
            self::DESCRIPTION_THIS_FIELD_IS_NOT_CURRENTLY_SUPPORTED,
        ];
    }
