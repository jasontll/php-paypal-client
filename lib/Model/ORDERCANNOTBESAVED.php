...
/**
 * ORDERCANNOTBESAVED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERCANNOTBESAVED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_CANNOT_BE_SAVED';
    ...
    public const ISSUE_ORDER_CANNOT_BE_SAVED = 'ORDER_CANNOT_BE_SAVED';
    public const DESCRIPTION_THE_OPTION_TO_SAVE_AN_ORDER_IS_ONLY_AVAILABLE_IF_THE_INTENT_IS_AUTHORIZE_AND_PROCESSING_INSTRUCTION_USES_ONE_OF_THE_ORDER_SAVED_OPTIONS__FOR_EXAMPLE_INTENTAUTHORIZE_PROCESSING_INSTRUCTIONORDER_SAVED_EXPLICITLY__PLEASE_CHANGE_THE_INTENT_AND_OR_PROCESSING_INSTRUCTION_AND_TRY_AGAIN = 'The option to save an order is only available if the `intent` is AUTHORIZE and `processing_instruction` uses one of the `ORDER_SAVED` options. For example, `intent`=AUTHORIZE, `processing_instruction`=ORDER_SAVED_EXPLICITLY. Please change the intent and/or processing_instruction` and try again.';
    ...
    {
        return [
            self::ISSUE_ORDER_CANNOT_BE_SAVED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_OPTION_TO_SAVE_AN_ORDER_IS_ONLY_AVAILABLE_IF_THE_INTENT_IS_AUTHORIZE_AND_PROCESSING_INSTRUCTION_USES_ONE_OF_THE_ORDER_SAVED_OPTIONS__FOR_EXAMPLE_INTENTAUTHORIZE_PROCESSING_INSTRUCTIONORDER_SAVED_EXPLICITLY__PLEASE_CHANGE_THE_INTENT_AND_OR_PROCESSING_INSTRUCTION_AND_TRY_AGAIN,
        ];
    }
