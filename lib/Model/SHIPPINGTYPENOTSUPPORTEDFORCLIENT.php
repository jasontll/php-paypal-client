...
/**
 * SHIPPINGTYPENOTSUPPORTEDFORCLIENT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SHIPPINGTYPENOTSUPPORTEDFORCLIENT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SHIPPING_TYPE_NOT_SUPPORTED_FOR_CLIENT';
    ...
    public const ISSUE_SHIPPING_TYPE_NOT_SUPPORTED_FOR_CLIENT = 'SHIPPING_TYPE_NOT_SUPPORTED_FOR_CLIENT';
    public const DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_SUPPORT_A_SHIPPING_TYPEPICKUP_IN_PERSON__THIS_FEATURE_IS_ONLY_SUPPORTED_FOR_A_HREFHTTPS__WWW_PAYPAL_COM_US_BUSINESS_PLATFORMS_AND_MARKETPLACESPAY_PAL_COMMERCE_PLATFORM_FOR_PLATFORMS_AND_MARKETPLACES_A = 'The API Caller account is not setup to be able to support a `shipping.type`=`PICKUP_IN_PERSON`. This feature is only supported for <a href=\"https://www.paypal.com/us/business/platforms-and-marketplaces\">PayPal Commerce Platform for Platforms and Marketplaces</a>.';
    ...
    {
        return [
            self::ISSUE_SHIPPING_TYPE_NOT_SUPPORTED_FOR_CLIENT,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_SUPPORT_A_SHIPPING_TYPEPICKUP_IN_PERSON__THIS_FEATURE_IS_ONLY_SUPPORTED_FOR_A_HREFHTTPS__WWW_PAYPAL_COM_US_BUSINESS_PLATFORMS_AND_MARKETPLACESPAY_PAL_COMMERCE_PLATFORM_FOR_PLATFORMS_AND_MARKETPLACES_A,
        ];
    }
