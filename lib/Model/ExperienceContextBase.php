...
/**
 * ExperienceContextBase Class Doc Comment
 *
 * @category Class
 ...
 */
class ExperienceContextBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'experience_context_base';
    ...
    */
    ...
    public function setBrandName($brand_name)
    {
        ...
        if ((mb_strlen($brand_name) > 127)) {
            throw new \InvalidArgumentException('invalid length for $brand_name when calling ExperienceContextBase., must be smaller than or equal to 127.');
        }
        if ((mb_strlen($brand_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $brand_name when calling ExperienceContextBase., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^.*$/", $brand_name))) {
            throw new \InvalidArgumentException("invalid value for \$brand_name when calling ExperienceContextBase., must conform to the pattern /^.*$/.");
        }
    ...
    public function setLocale($locale)
    {
        ...
        if ((mb_strlen($locale) > 10)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling ExperienceContextBase., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($locale) < 2)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling ExperienceContextBase., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[a-z]{2}(?:-[A-Z][a-z]{3})?(?:-(?:[A-Z]{2}|[0-9]{3}))?$/", $locale))) {
            throw new \InvalidArgumentException("invalid value for \$locale when calling ExperienceContextBase., must conform to the pattern /^[a-z]{2}(?:-[A-Z][a-z]{3})?(?:-(?:[A-Z]{2}|[0-9]{3}))?$/.");
        }
    ...
    public function setShippingPreference($shipping_preference)
    {
        ...
        if ((mb_strlen($shipping_preference) > 24)) {
            throw new \InvalidArgumentException('invalid length for $shipping_preference when calling ExperienceContextBase., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($shipping_preference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipping_preference when calling ExperienceContextBase., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Z_]+$/", $shipping_preference))) {
            throw new \InvalidArgumentException("invalid value for \$shipping_preference when calling ExperienceContextBase., must conform to the pattern /^[A-Z_]+$/.");
        }
