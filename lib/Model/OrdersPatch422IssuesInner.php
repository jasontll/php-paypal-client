...
/**
 * OrdersPatch422IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersPatch422IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_patch_422_issues_inner';
    ...
    public const ISSUE_AMOUNT_CHANGE_NOT_ALLOWED = 'AMOUNT_CHANGE_NOT_ALLOWED';
    public const DESCRIPTION_THE_AMOUNT_SPECIFIED_IS_DIFFERENT_FROM_THE_AMOUNT_AUTHORIZED_BY_PAYER = 'The amount specified is different from the amount authorized by payer.';
    ...
    {
        return [
            self::ISSUE_AMOUNT_CHANGE_NOT_ALLOWED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_AMOUNT_SPECIFIED_IS_DIFFERENT_FROM_THE_AMOUNT_AUTHORIZED_BY_PAYER,
        ];
    }
