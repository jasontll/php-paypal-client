...
/**
 * ONEOFPARAMETERSREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ONEOFPARAMETERSREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ONE_OF_PARAMETERS_REQUIRED';
    ...
    public const ISSUE_ONE_OF_PARAMETERS_REQUIRED = 'ONE_OF_PARAMETERS_REQUIRED';
    ...
    {
        return [
            self::ISSUE_ONE_OF_PARAMETERS_REQUIRED,
        ];
    }
