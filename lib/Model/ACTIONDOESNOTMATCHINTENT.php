...
/**
 * ACTIONDOESNOTMATCHINTENT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ACTIONDOESNOTMATCHINTENT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ACTION_DOES_NOT_MATCH_INTENT';
    ...
    public const ISSUE_ACTION_DOES_NOT_MATCH_INTENT = 'ACTION_DOES_NOT_MATCH_INTENT';
    public const DESCRIPTION_ORDER_WAS_CREATED_WITH_AN_INTENT_TO_CAPTURE__PLEASE_USE_V2_CHECKOUT_ORDERS_ORDER_ID_CAPTURE_TO_COMPLETE_THE_TRANSACTION_OR_ALTERNATELY_CREATE_AN_ORDER_WITH_AN_INTENT_OF_AUTHORIZE = 'Order was created with an intent to 'CAPTURE'. Please use v2/checkout/orders/order_id/capture to complete the transaction or alternately Create an order with an intent of 'AUTHORIZE'.';
    ...
    {
        return [
            self::ISSUE_ACTION_DOES_NOT_MATCH_INTENT,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ORDER_WAS_CREATED_WITH_AN_INTENT_TO_CAPTURE__PLEASE_USE_V2_CHECKOUT_ORDERS_ORDER_ID_CAPTURE_TO_COMPLETE_THE_TRANSACTION_OR_ALTERNATELY_CREATE_AN_ORDER_WITH_AN_INTENT_OF_AUTHORIZE,
        ];
    }
