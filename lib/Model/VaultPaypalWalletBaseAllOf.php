...
/**
 * VaultPaypalWalletBaseAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VaultPaypalWalletBaseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vault_paypal_wallet_base_allOf';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['usage_type']) && (mb_strlen($this->container['usage_type']) > 255)) {
            $invalidProperties[] = "invalid value for 'usage_type', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['usage_type']) && (mb_strlen($this->container['usage_type']) < 1)) {
            $invalidProperties[] = "invalid value for 'usage_type', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['usage_type']) && !preg_match("/^[0-9A-Z_]+$/", $this->container['usage_type'])) {
     ...
     * Sets description
     *
     * @param string|null $description The description displayed to PayPal consumer on the approval flow for PayPal, as well as on the PayPal payment token management experience on PayPal.com.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 128)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VaultPaypalWalletBaseAllOf., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VaultPaypalWalletBaseAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setUsagePattern($usage_pattern)
    {
        ...
        if ((mb_strlen($usage_pattern) > 30)) {
            throw new \InvalidArgumentException('invalid length for $usage_pattern when calling VaultPaypalWalletBaseAllOf., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($usage_pattern) < 1)) {
            throw new \InvalidArgumentException('invalid length for $usage_pattern when calling VaultPaypalWalletBaseAllOf., must be bigger than or equal to 1.');
        }
     ...
     * Sets usage_type
     *
     * @param string|null $usage_type The usage type associated with the PayPal payment token.
     *
     * @return self
     */
    public function setUsageType($usage_type)
    {
        ...
        if ((mb_strlen($usage_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $usage_type when calling VaultPaypalWalletBaseAllOf., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($usage_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $usage_type when calling VaultPaypalWalletBaseAllOf., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $usage_type))) {
            throw new \InvalidArgumentException("invalid value for \$usage_type when calling VaultPaypalWalletBaseAllOf., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
     ...
     * Sets customer_type
     *
     * @param string|null $customer_type The customer type associated with the PayPal payment token. This is to indicate whether the customer acting on the merchant / platform is either a business or a consumer.
     *
     * @return self
     */
    public function setCustomerType($customer_type)
    {
        ...
        if ((mb_strlen($customer_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_type when calling VaultPaypalWalletBaseAllOf., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($customer_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_type when calling VaultPaypalWalletBaseAllOf., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $customer_type))) {
            throw new \InvalidArgumentException("invalid value for \$customer_type when calling VaultPaypalWalletBaseAllOf., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
