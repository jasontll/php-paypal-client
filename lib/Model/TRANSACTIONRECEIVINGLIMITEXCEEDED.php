...
/**
 * TRANSACTIONRECEIVINGLIMITEXCEEDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TRANSACTIONRECEIVINGLIMITEXCEEDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TRANSACTION_RECEIVING_LIMIT_EXCEEDED';
    ...
    public const ISSUE_TRANSACTION_RECEIVING_LIMIT_EXCEEDED = 'TRANSACTION_RECEIVING_LIMIT_EXCEEDED';
    public const DESCRIPTION_THE_TRANSACTION_EXCEEDS_THE_RECEIVERS_RECEIVING_LIMIT = 'The transaction exceeds the receiver's receiving limit.';
    ...
    {
        return [
            self::ISSUE_TRANSACTION_RECEIVING_LIMIT_EXCEEDED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_TRANSACTION_EXCEEDS_THE_RECEIVERS_RECEIVING_LIMIT,
        ];
    }
