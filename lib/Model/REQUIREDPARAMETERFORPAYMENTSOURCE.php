...
/**
 * REQUIREDPARAMETERFORPAYMENTSOURCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class REQUIREDPARAMETERFORPAYMENTSOURCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'REQUIRED_PARAMETER_FOR_PAYMENT_SOURCE';
    ...
    public const ISSUE_REQUIRED_PARAMETER_FOR_PAYMENT_SOURCE = 'REQUIRED_PARAMETER_FOR_PAYMENT_SOURCE';
    public const DESCRIPTION_THE_PARAMETER_IS_REQUIRED_FOR_PROVIDED_PAYMENT_SOURCE = 'The parameter is required for provided payment source.';
    ...
    {
        return [
            self::ISSUE_REQUIRED_PARAMETER_FOR_PAYMENT_SOURCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PARAMETER_IS_REQUIRED_FOR_PROVIDED_PAYMENT_SOURCE,
        ];
    }
