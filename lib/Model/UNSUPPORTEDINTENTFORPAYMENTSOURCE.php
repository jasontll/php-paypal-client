...
/**
 * UNSUPPORTEDINTENTFORPAYMENTSOURCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UNSUPPORTEDINTENTFORPAYMENTSOURCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNSUPPORTED_INTENT_FOR_PAYMENT_SOURCE';
    ...
    public const ISSUE_UNSUPPORTED_INTENT_FOR_PAYMENT_SOURCE = 'UNSUPPORTED_INTENT_FOR_PAYMENT_SOURCE';
    public const DESCRIPTION_INTENTAUTHORIZE_IS_NOT_SUPPORTED_FOR_THE_SPECIFIED_PAYMENT_SOURCE__ONLY_INTENTCAPTURE_IS_SUPPORTED = '`intent=AUTHORIZE` is not supported for the specified payment_source. Only `intent=CAPTURE` is supported.';
    ...
    {
        return [
            self::ISSUE_UNSUPPORTED_INTENT_FOR_PAYMENT_SOURCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_INTENTAUTHORIZE_IS_NOT_SUPPORTED_FOR_THE_SPECIFIED_PAYMENT_SOURCE__ONLY_INTENTCAPTURE_IS_SUPPORTED,
        ];
    }
