...
/**
 * AGREEMENTALREADYCANCELLED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AGREEMENTALREADYCANCELLED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AGREEMENT_ALREADY_CANCELLED';
    ...
    public const ISSUE_AGREEMENT_ALREADY_CANCELLED = 'AGREEMENT_ALREADY_CANCELLED';
    public const DESCRIPTION_THE_REQUESTED_AGREEMENT_IS_ALREADY_CANCELED = 'The requested agreement is already canceled.';
    ...
    {
        return [
            self::ISSUE_AGREEMENT_ALREADY_CANCELLED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_REQUESTED_AGREEMENT_IS_ALREADY_CANCELED,
        ];
    }
