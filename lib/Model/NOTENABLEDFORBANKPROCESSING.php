...
/**
 * NOTENABLEDFORBANKPROCESSING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTENABLEDFORBANKPROCESSING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ENABLED_FOR_BANK_PROCESSING';
    ...
    public const ISSUE_NOT_ENABLED_FOR_BANK_PROCESSING = 'NOT_ENABLED_FOR_BANK_PROCESSING';
    public const DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_BANK_PAYMENTS__PLEASE_CONTACT_YOUR_PAY_PAL_ACCOUNT_MANAGER = 'The API Caller account is not setup to be able to process bank payments. Please contact your PayPal account manager.';
    ...
    {
        return [
            self::ISSUE_NOT_ENABLED_FOR_BANK_PROCESSING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_BANK_PAYMENTS__PLEASE_CONTACT_YOUR_PAY_PAL_ACCOUNT_MANAGER,
        ];
    }
