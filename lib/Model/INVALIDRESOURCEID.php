...
/**
 * INVALIDRESOURCEID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDRESOURCEID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_RESOURCE_ID';
    ...
    public const DESCRIPTION_SPECIFIED_RESOURCE_ID_DOES_NOT_EXIST__PLEASE_CHECK_THE_RESOURCE_ID_AND_TRY_AGAIN = 'Specified resource ID does not exist. Please check the resource ID and try again.';
    ...
    {
        return [
            self::ISSUE_INVALID_RESOURCE_ID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_RESOURCE_ID_DOES_NOT_EXIST__PLEASE_CHECK_THE_RESOURCE_ID_AND_TRY_AGAIN,
        ];
    }
