...
/**
 * MULTICURRENCYORDER Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MULTICURRENCYORDER implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MULTI_CURRENCY_ORDER';
    ...
    public const ISSUE_MULTI_CURRENCY_ORDER = 'MULTI_CURRENCY_ORDER';
    public const DESCRIPTION_MULTIPLE_DIFFERING_VALUES_OF_CURRENCY_CODE_ARE_NOT_SUPPORTED__ENTIRE_ORDER_REQUEST_MUST_HAVE_THE_SAME_CURRENCY_CODE = 'Multiple differing values of currency_code are not supported. Entire Order request must have the same currency_code.';
    ...
    {
        return [
            self::ISSUE_MULTI_CURRENCY_ORDER,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_MULTIPLE_DIFFERING_VALUES_OF_CURRENCY_CODE_ARE_NOT_SUPPORTED__ENTIRE_ORDER_REQUEST_MUST_HAVE_THE_SAME_CURRENCY_CODE,
        ];
    }
