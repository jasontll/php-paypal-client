...
/**
 * MISSINGREQUIREDPARAMETER2 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MISSINGREQUIREDPARAMETER2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MISSING_REQUIRED_PARAMETER_2';
    ...
    public const DESCRIPTION_A_REQUIRED_FIELD___PARAMETER_IS_MISSING = 'A required field / parameter is missing';
    ...
    {
        return [
            self::DESCRIPTION_A_REQUIRED_FIELD___PARAMETER_IS_MISSING,
        ];
    }
