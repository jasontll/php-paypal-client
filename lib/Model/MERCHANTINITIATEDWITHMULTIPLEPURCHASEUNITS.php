...
/**
 * MERCHANTINITIATEDWITHMULTIPLEPURCHASEUNITS Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MERCHANTINITIATEDWITHMULTIPLEPURCHASEUNITS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MERCHANT_INITIATED_WITH_MULTIPLE_PURCHASE_UNITS';
    ...
    public const ISSUE_MERCHANT_INITIATED_WITH_MULTIPLE_PURCHASE_UNITS = 'MERCHANT_INITIATED_WITH_MULTIPLE_PURCHASE_UNITS';
    public const DESCRIPTION_STORED_PAYMENT_SOURCE_PAYMENT_INITIATOR__MERCHANT_IS_NOT_SUPPORTED_IF_MORE_THAN_ONE_PURCHASE_UNIT_IS_PRESENT_IN_THE_ORDER__MERCHANT_INITIATED_PAYMENTS_ARE_NOT_SUPPORTED_FROM_ORDERS_WITH_MORE_THAN_ONE_PURCHASE_UNIT__PLEASE_RETRY_THE_REQUEST_WITH_MULTIPLE_ORDER_REQUESTS__ONE_FOR_EACH_PURCHASE_UNIT = '`stored_payment_source.payment_initiator` = `MERCHANT` is not supported if more than one purchase_unit is present in the Order. Merchant initiated payments are not supported from orders with more than one purchase_unit. Please retry the request with multiple Order requests (one for each purchase_unit).';
    ...
    {
        return [
            self::ISSUE_MERCHANT_INITIATED_WITH_MULTIPLE_PURCHASE_UNITS,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_STORED_PAYMENT_SOURCE_PAYMENT_INITIATOR__MERCHANT_IS_NOT_SUPPORTED_IF_MORE_THAN_ONE_PURCHASE_UNIT_IS_PRESENT_IN_THE_ORDER__MERCHANT_INITIATED_PAYMENTS_ARE_NOT_SUPPORTED_FROM_ORDERS_WITH_MORE_THAN_ONE_PURCHASE_UNIT__PLEASE_RETRY_THE_REQUEST_WITH_MULTIPLE_ORDER_REQUESTS__ONE_FOR_EACH_PURCHASE_UNIT,
        ];
    }
