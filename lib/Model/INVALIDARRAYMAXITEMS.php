...
/**
 * INVALIDARRAYMAXITEMS Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDARRAYMAXITEMS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_ARRAY_MAX_ITEMS';
    ...
    public const ISSUE_INVALID_ARRAY_MAX_ITEMS = 'INVALID_ARRAY_MAX_ITEMS';
    public const DESCRIPTION_THE_NUMBER_OF_ITEMS_IN_AN_ARRAY_PARAMETER_IS_TOO_LARGE = 'The number of items in an array parameter is too large.';
    ...
    {
        return [
            self::ISSUE_INVALID_ARRAY_MAX_ITEMS,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_NUMBER_OF_ITEMS_IN_AN_ARRAY_PARAMETER_IS_TOO_LARGE,
        ];
    }
