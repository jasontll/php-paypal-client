...
/**
 * CITYREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CITYREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CITY_REQUIRED';
    ...
    public const ISSUE_CITY_REQUIRED = 'CITY_REQUIRED';
    public const DESCRIPTION_THE_SPECIFIED_COUNTRY_REQUIRES_A_CITY__ADDRESS_ADMIN_AREA_2 = 'The specified country requires a city (address.admin_area_2).';
    ...
    {
        return [
            self::DESCRIPTION_THE_SPECIFIED_COUNTRY_REQUIRES_A_CITY__ADDRESS_ADMIN_AREA_2,
        ];
    }
