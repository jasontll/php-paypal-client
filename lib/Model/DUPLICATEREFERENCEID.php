...
/**
 * DUPLICATEREFERENCEID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DUPLICATEREFERENCEID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DUPLICATE_REFERENCE_ID';
    ...
    public const ISSUE_DUPLICATE_REFERENCE_ID = 'DUPLICATE_REFERENCE_ID';
    public const DESCRIPTION_REFERENCE_ID_MUST_BE_UNIQUE_IF_MULTIPLE_PURCHASE_UNIT_ARE_PROVIDED = '`reference_id` must be unique if multiple `purchase_unit` are provided.';
    ...
    {
        return [
            self::ISSUE_DUPLICATE_REFERENCE_ID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_REFERENCE_ID_MUST_BE_UNIQUE_IF_MULTIPLE_PURCHASE_UNIT_ARE_PROVIDED,
        ];
    }
