...
/**
 * DONATIONITEMSNOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DONATIONITEMSNOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DONATION_ITEMS_NOT_SUPPORTED';
    ...
    public const ISSUE_DONATION_ITEMS_NOT_SUPPORTED = 'DONATION_ITEMS_NOT_SUPPORTED';
    public const DESCRIPTION_IF_PURCHASE_UNIT_HAS_DONATION_AS_THE_ITEMS_CATEGORY_THEN_THE_ORDER_CAN_AT_MOST_HAVE_ONE_PURCHASE_UNIT__MULTIPLE_PURCHASE_UNITS_ARE_NOT_SUPPORTED_IF_EITHER_OF_THEM_HAVE_AT_LEAST_ONE_ITEMS_WITH_CATEGORY_AS_DONATION = 'If 'purchase_unit' has \"DONATION\" as the 'items.category' then the Order can at most have one purchase_unit. Multiple purchase_units are not supported if either of them have at least one items with category as \"DONATION\".';
    ...
    {
        return [
            self::ISSUE_DONATION_ITEMS_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_IF_PURCHASE_UNIT_HAS_DONATION_AS_THE_ITEMS_CATEGORY_THEN_THE_ORDER_CAN_AT_MOST_HAVE_ONE_PURCHASE_UNIT__MULTIPLE_PURCHASE_UNITS_ARE_NOT_SUPPORTED_IF_EITHER_OF_THEM_HAVE_AT_LEAST_ONE_ITEMS_WITH_CATEGORY_AS_DONATION,
        ];
    }
