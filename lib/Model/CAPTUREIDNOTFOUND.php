...
/**
 * CAPTUREIDNOTFOUND Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CAPTUREIDNOTFOUND implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CAPTURE_ID_NOT_FOUND';
    ...
    public const ISSUE_CAPTURE_ID_NOT_FOUND = 'CAPTURE_ID_NOT_FOUND';
    public const DESCRIPTION_SPECIFIED_CAPTURE_ID_DOES_NOT_EXIST__CHECK_THE_CAPTURE_ID_AND_TRY_AGAIN = 'Specified capture ID does not exist. Check the capture ID and try again.';
    ...
    {
        return [
            self::ISSUE_CAPTURE_ID_NOT_FOUND,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_CAPTURE_ID_DOES_NOT_EXIST__CHECK_THE_CAPTURE_ID_AND_TRY_AGAIN,
        ];
    }
