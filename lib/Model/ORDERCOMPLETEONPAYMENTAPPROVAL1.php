...
/**
 * ORDERCOMPLETEONPAYMENTAPPROVAL1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERCOMPLETEONPAYMENTAPPROVAL1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_COMPLETE_ON_PAYMENT_APPROVAL_1';
    ...
    public const DESCRIPTION_A_PROCESSING_INSTRUCTION_OF_ORDER_COMPLETE_ON_PAYMENT_APPROVAL_IS_REQUIRED_FOR_THE_SPECIFIED_PAYMENT_SOURCE = 'A processing_instruction of `ORDER_COMPLETE_ON_PAYMENT_APPROVAL` is required for the specified payment_source.';
    ...
    {
        return [
            self::DESCRIPTION_A_PROCESSING_INSTRUCTION_OF_ORDER_COMPLETE_ON_PAYMENT_APPROVAL_IS_REQUIRED_FOR_THE_SPECIFIED_PAYMENT_SOURCE,
        ];
    }
