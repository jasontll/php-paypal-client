...
/**
 * PAYMENTSOURCENOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYMENTSOURCENOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYMENT_SOURCE_NOT_SUPPORTED';
    ...
    public const ISSUE_PAYMENT_SOURCE_NOT_SUPPORTED = 'PAYMENT_SOURCE_NOT_SUPPORTED';
    public const DESCRIPTION_THE_PAYER_SELECTED_METHOD_OF_PAYMENT_IS_NOT_SUPPORTED_WHEN_MULTIPLE_PURCHASE_UNITS_ARE_SPECIFIED_FOR_AN_ORDER = 'The payer selected method of payment is not supported when multiple purchase units are specified for an Order.';
    ...
    {
        return [
            self::ISSUE_PAYMENT_SOURCE_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PAYER_SELECTED_METHOD_OF_PAYMENT_IS_NOT_SUPPORTED_WHEN_MULTIPLE_PURCHASE_UNITS_ARE_SPECIFIED_FOR_AN_ORDER,
        ];
    }
