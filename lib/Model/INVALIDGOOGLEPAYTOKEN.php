...
/**
 * INVALIDGOOGLEPAYTOKEN Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDGOOGLEPAYTOKEN implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_GOOGLE_PAY_TOKEN';
    ...
    public const ISSUE_INVALID_GOOGLE_PAY_TOKEN = 'INVALID_GOOGLE_PAY_TOKEN';
    public const DESCRIPTION_THE_GOOGLE_PAY_TOKEN_IS_INVALID__PAY_PAL_WAS_NOT_ABLE_TO_DECRYPT_THE_GOOGLEPAY_TOKEN_OR_PAY_PAL_WAS_NOT_ABLE_TO_FIND_THE_NECESSARY_DATA_IN_THE_TOKEN_AFTER_DECRYPTION = 'The google pay token is invalid. PayPal was not able to decrypt the googlepay token or PayPal was not able to find the necessary data in the token after decryption.';
    ...
    {
        return [
            self::ISSUE_INVALID_GOOGLE_PAY_TOKEN,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_GOOGLE_PAY_TOKEN_IS_INVALID__PAY_PAL_WAS_NOT_ABLE_TO_DECRYPT_THE_GOOGLEPAY_TOKEN_OR_PAY_PAL_WAS_NOT_ABLE_TO_FIND_THE_NECESSARY_DATA_IN_THE_TOKEN_AFTER_DECRYPTION,
        ];
    }
