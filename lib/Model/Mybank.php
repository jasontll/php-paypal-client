 ...
 */
class Mybank implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mybank';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 300)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Mybank., must be smaller than or equal to 300.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Mybank., must be bigger than or equal to 3.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Mybank., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Mybank., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^([A-Z]{2}|C2)$/", $country_code))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling Mybank., must conform to the pattern /^([A-Z]{2}|C2)$/.");
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling Mybank., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($bic) < 8)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling Mybank., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^[A-Z-a-z0-9]{4}[A-Z-a-z]{2}[A-Z-a-z0-9]{2}([A-Z-a-z0-9]{3})?$/", $bic))) {
            throw new \InvalidArgumentException("invalid value for \$bic when calling Mybank., must conform to the pattern /^[A-Z-a-z0-9]{4}[A-Z-a-z]{2}[A-Z-a-z0-9]{2}([A-Z-a-z0-9]{3})?$/.");
        }
    ...
    public function setIbanLastChars($iban_last_chars)
    {
        ...
        if ((mb_strlen($iban_last_chars) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban_last_chars when calling Mybank., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($iban_last_chars) < 4)) {
            throw new \InvalidArgumentException('invalid length for $iban_last_chars when calling Mybank., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{4}/", $iban_last_chars))) {
            throw new \InvalidArgumentException("invalid value for \$iban_last_chars when calling Mybank., must conform to the pattern /[a-zA-Z0-9]{4}/.");
        }
