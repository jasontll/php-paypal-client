...
class Name2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'name-2';
    ...
    */
    ...
    public function setPrefix($prefix)
    {
        ...
        if ((mb_strlen($prefix) > 140)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling Name2., must be smaller than or equal to 140.');
        }
    ...
    public function setGivenName($given_name)
    {
        ...
        if ((mb_strlen($given_name) > 140)) {
            throw new \InvalidArgumentException('invalid length for $given_name when calling Name2., must be smaller than or equal to 140.');
        }
    ...
    public function setSurname($surname)
    {
        ...
        if ((mb_strlen($surname) > 140)) {
            throw new \InvalidArgumentException('invalid length for $surname when calling Name2., must be smaller than or equal to 140.');
        }
    ...
    public function setMiddleName($middle_name)
    {
        ...
        if ((mb_strlen($middle_name) > 140)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling Name2., must be smaller than or equal to 140.');
        }
    ...
    public function setSuffix($suffix)
    {
        ...
        if ((mb_strlen($suffix) > 140)) {
            throw new \InvalidArgumentException('invalid length for $suffix when calling Name2., must be smaller than or equal to 140.');
        }
    ...
    public function setFullName($full_name)
    {
        ...
        if ((mb_strlen($full_name) > 300)) {
            throw new \InvalidArgumentException('invalid length for $full_name when calling Name2., must be smaller than or equal to 300.');
        }
