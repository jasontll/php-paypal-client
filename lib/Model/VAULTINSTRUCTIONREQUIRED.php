...
/**
 * VAULTINSTRUCTIONREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VAULTINSTRUCTIONREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VAULT_INSTRUCTION_REQUIRED';
    ...
    public const ISSUE_VAULT_INSTRUCTION_REQUIRED = 'VAULT_INSTRUCTION_REQUIRED';
    public const DESCRIPTION_VAULT_INSTRUCTION_IS_REQUIRED__PLEASE_USE_VAULT_STORE_IN_VAULT_TO_PROVIDE_VAULT_INSTRUCTION = 'Vault instruction is required. Please use `vault.store_in_vault` to provide vault instruction.';
    ...
    {
        return [
            self::ISSUE_VAULT_INSTRUCTION_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_VAULT_INSTRUCTION_IS_REQUIRED__PLEASE_USE_VAULT_STORE_IN_VAULT_TO_PROVIDE_VAULT_INSTRUCTION,
        ];
    }
