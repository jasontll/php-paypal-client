...
/**
 * INVALIDPLATFORMFEESAMOUNT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPLATFORMFEESAMOUNT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PLATFORM_FEES_AMOUNT';
    ...
    public const ISSUE_INVALID_PLATFORM_FEES_AMOUNT = 'INVALID_PLATFORM_FEES_AMOUNT';
    public const DESCRIPTION_THE_PLATFORM_FEES_AMOUNT_CANNOT_BE_GREATER_THAN_ORDER_AMOUNT = 'The platform_fees amount cannot be greater than order amount.';
    ...
    {
        return [
            self::ISSUE_INVALID_PLATFORM_FEES_AMOUNT,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PLATFORM_FEES_AMOUNT_CANNOT_BE_GREATER_THAN_ORDER_AMOUNT,
        ];
    }
