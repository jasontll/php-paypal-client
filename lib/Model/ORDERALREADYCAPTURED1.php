...
/**
 * ORDERALREADYCAPTURED1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERALREADYCAPTURED1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_ALREADY_CAPTURED_1';
    ...
    public const ISSUE_ORDER_ALREADY_CAPTURED = 'ORDER_ALREADY_CAPTURED';
    public const DESCRIPTION_ORDER_ALREADY_CAPTURED_IF_INTENTCAPTURE_ONLY_ONE_CAPTURE_PER_ORDER_IS_ALLOWED = 'Order already captured.If 'intent=CAPTURE' only one capture per order is allowed.';
    ...
    {
        return [
            self::ISSUE_ORDER_ALREADY_CAPTURED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ORDER_ALREADY_CAPTURED_IF_INTENTCAPTURE_ONLY_ONE_CAPTURE_PER_ORDER_IS_ALLOWED,
        ];
    }
