...
/**
 * PAYEEBLOCKEDTRANSACTION Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEEBLOCKEDTRANSACTION implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_BLOCKED_TRANSACTION';
    ...
    public const ISSUE_PAYEE_BLOCKED_TRANSACTION = 'PAYEE_BLOCKED_TRANSACTION';
    public const DESCRIPTION_THE_FRAUD_SETTINGS_FOR_THIS_SELLER_ARE_SUCH_THAT_THIS_PAYMENT_CANNOT_BE_EXECUTED = 'The Fraud settings for this seller are such that this payment cannot be executed.';
    ...
    {
        return [
            self::ISSUE_PAYEE_BLOCKED_TRANSACTION,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_FRAUD_SETTINGS_FOR_THIS_SELLER_ARE_SUCH_THAT_THIS_PAYMENT_CANNOT_BE_EXECUTED,
        ];
    }
