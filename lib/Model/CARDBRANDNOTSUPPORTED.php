...
/**
 * CARDBRANDNOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CARDBRANDNOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CARD_BRAND_NOT_SUPPORTED';
    ...
    public const ISSUE_CARD_BRAND_NOT_SUPPORTED = 'CARD_BRAND_NOT_SUPPORTED';
    public const DESCRIPTION_PROCESSING_OF_THIS_CARD_BRAND_IS_NOT_SUPPORTED__PLEASE_USE_ANOTHER_CARD_TO_CONTINUE_WITH_THIS_TRANSACTION = 'Processing of this card brand is not supported. Please use another card to continue with this transaction.';
    ...
    {
        return [
            self::ISSUE_CARD_BRAND_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PROCESSING_OF_THIS_CARD_BRAND_IS_NOT_SUPPORTED__PLEASE_USE_ANOTHER_CARD_TO_CONTINUE_WITH_THIS_TRANSACTION,
        ];
    }
