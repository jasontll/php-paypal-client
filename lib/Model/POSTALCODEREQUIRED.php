...
/**
 * POSTALCODEREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class POSTALCODEREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'POSTAL_CODE_REQUIRED';
    ...
    public const ISSUE_POSTAL_CODE_REQUIRED = 'POSTAL_CODE_REQUIRED';
    public const DESCRIPTION_THE_SPECIFIED_COUNTRY_REQUIRES_A_POSTAL_CODE = 'The specified country requires a postal code.';
    ...
    {
        return [
            self::ISSUE_POSTAL_CODE_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_SPECIFIED_COUNTRY_REQUIRES_A_POSTAL_CODE,
        ];
    }
