...
/**
 * UNSUPPORTEDSHIPPINGTYPE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UNSUPPORTEDSHIPPINGTYPE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNSUPPORTED_SHIPPING_TYPE';
    ...
    public const ISSUE_UNSUPPORTED_SHIPPING_TYPE = 'UNSUPPORTED_SHIPPING_TYPE';
    public const DESCRIPTION_THE_PROVIDED_SHIPPING_TYPE_IS_ONLY_SUPPORTED_FOR_APPLICATION_CONTEXT_SHIPPING_PREFERENCESET_PROVIDED_ADDRESS_OR_NO_SHIPPING = 'The provided `shipping.type` is only supported for `application_context.shipping_preference`=`SET_PROVIDED_ADDRESS` or `NO_SHIPPING`.';
    ...
    {
        return [
            self::ISSUE_UNSUPPORTED_SHIPPING_TYPE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PROVIDED_SHIPPING_TYPE_IS_ONLY_SUPPORTED_FOR_APPLICATION_CONTEXT_SHIPPING_PREFERENCESET_PROVIDED_ADDRESS_OR_NO_SHIPPING,
        ];
    }
