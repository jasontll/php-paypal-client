...
/**
 * NOTENABLEDTOVAULTPAYMENTSOURCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTENABLEDTOVAULTPAYMENTSOURCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ENABLED_TO_VAULT_PAYMENT_SOURCE';
    ...
    public const ISSUE_NOT_ENABLED_TO_VAULT_PAYMENT_SOURCE = 'NOT_ENABLED_TO_VAULT_PAYMENT_SOURCE';
    public const DESCRIPTION_THE_API_CALLER_OR_THE_MERCHANT_ON_WHOSE_BEHALF_THE_API_CALL_IS_INITIATED_IS_NOT_ALLOWED_TO_VAULT_THE_GIVEN_SOURCE__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT_FOR_ASSISTANCE = 'The API caller or the merchant on whose behalf the API call is initiated is not allowed to vault the given source. Please contact PayPal customer support for assistance.';
    ...
    {
        return [
            self::ISSUE_NOT_ENABLED_TO_VAULT_PAYMENT_SOURCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_OR_THE_MERCHANT_ON_WHOSE_BEHALF_THE_API_CALL_IS_INITIATED_IS_NOT_ALLOWED_TO_VAULT_THE_GIVEN_SOURCE__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT_FOR_ASSISTANCE,
        ];
    }
