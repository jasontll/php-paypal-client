...
/**
 * ORDERCOMPLETEDORVOIDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERCOMPLETEDORVOIDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_COMPLETED_OR_VOIDED';
    ...
    public const ISSUE_ORDER_COMPLETED_OR_VOIDED = 'ORDER_COMPLETED_OR_VOIDED';
    public const DESCRIPTION_ORDER_IS_VOIDED_OR_COMPLETED_AND_HENCE_CANNOT_BE_AUTHORIZED = 'Order is voided or completed and hence cannot be authorized.';
    ...
    {
        return [
            self::ISSUE_ORDER_COMPLETED_OR_VOIDED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ORDER_IS_VOIDED_OR_COMPLETED_AND_HENCE_CANNOT_BE_AUTHORIZED,
        ];
    }
