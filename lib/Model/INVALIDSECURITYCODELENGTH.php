...
/**
 * INVALIDSECURITYCODELENGTH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDSECURITYCODELENGTH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_SECURITY_CODE_LENGTH';
    ...
    public const ISSUE_INVALID_SECURITY_CODE_LENGTH = 'INVALID_SECURITY_CODE_LENGTH';
    public const DESCRIPTION_THE_SECURITY_CODE_LENGTH_IS_INVALID_FOR_THE_SPECIFIED_CARD_BRAND = 'The security_code length is invalid for the specified card brand.';
    ...
    {
        return [
            self::ISSUE_INVALID_SECURITY_CODE_LENGTH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_SECURITY_CODE_LENGTH_IS_INVALID_FOR_THE_SPECIFIED_CARD_BRAND,
        ];
    }
