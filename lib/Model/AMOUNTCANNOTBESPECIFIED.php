...
/**
 * AMOUNTCANNOTBESPECIFIED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AMOUNTCANNOTBESPECIFIED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AMOUNT_CANNOT_BE_SPECIFIED';
    ...
    public const ISSUE_AMOUNT_CANNOT_BE_SPECIFIED = 'AMOUNT_CANNOT_BE_SPECIFIED';
    public const DESCRIPTION_AN_AUTHORIZATION_AMOUNT_CAN_ONLY_BE_SPECIFIED_IF_AN_ORDER_HAS_BEEN_SAVED_BY_CALLING__V2_CHECKOUT_ORDERS_ORDER_ID_SAVE___PLEASE_SAVE_THE_ORDER_AND_TRY_AGAIN = 'An authorization amount can only be specified if an Order has been saved by calling /v2/checkout/orders/{order_id}/save.  Please save the order and try again.';
    ...
    {
        return [
            self::ISSUE_AMOUNT_CANNOT_BE_SPECIFIED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_AN_AUTHORIZATION_AMOUNT_CAN_ONLY_BE_SPECIFIED_IF_AN_ORDER_HAS_BEEN_SAVED_BY_CALLING__V2_CHECKOUT_ORDERS_ORDER_ID_SAVE___PLEASE_SAVE_THE_ORDER_AND_TRY_AGAIN,
        ];
    }
