...
class AddressDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Address_Details';
    ...
    */
    ...
    public function setStreetNumber($street_number)
    {
        ...
        if ((mb_strlen($street_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $street_number when calling AddressDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setStreetName($street_name)
    {
        ...
        if ((mb_strlen($street_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling AddressDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setStreetType($street_type)
    {
        ...
        if ((mb_strlen($street_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $street_type when calling AddressDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setDeliveryService($delivery_service)
    {
        ...
        if ((mb_strlen($delivery_service) > 100)) {
            throw new \InvalidArgumentException('invalid length for $delivery_service when calling AddressDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setBuildingName($building_name)
    {
        ...
        if ((mb_strlen($building_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $building_name when calling AddressDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setSubBuilding($sub_building)
    {
        ...
        if ((mb_strlen($sub_building) > 100)) {
            throw new \InvalidArgumentException('invalid length for $sub_building when calling AddressDetails., must be smaller than or equal to 100.');
        }
