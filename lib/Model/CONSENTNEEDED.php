...
/**
 * CONSENTNEEDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CONSENTNEEDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CONSENT_NEEDED';
    ...
    public const ISSUE_CONSENT_NEEDED = 'CONSENT_NEEDED';
    public const DESCRIPTION_CONSENT_NEEDED = 'CONSENT_NEEDED';
    ...
    {
        return [
            self::DESCRIPTION_CONSENT_NEEDED,
        ];
    }
