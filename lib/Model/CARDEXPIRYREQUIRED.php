...
/**
 * CARDEXPIRYREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CARDEXPIRYREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CARD_EXPIRY_REQUIRED';
    ...
    public const ISSUE_CARD_EXPIRY_REQUIRED = 'CARD_EXPIRY_REQUIRED';
    public const DESCRIPTION_THE_CARD_EXPIRY_IS_REQUIRED_WHEN_ATTEMPTING_TO_PROCESS_PAYMENT_WITH_CARD = 'The card expiry is required when attempting to process payment with card.';
    ...
    {
        return [
            self::ISSUE_CARD_EXPIRY_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_CARD_EXPIRY_IS_REQUIRED_WHEN_ATTEMPTING_TO_PROCESS_PAYMENT_WITH_CARD,
        ];
    }
