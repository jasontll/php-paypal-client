...
/**
 * MULTIPLESHIPPINGOPTIONSELECTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MULTIPLESHIPPINGOPTIONSELECTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MULTIPLE_SHIPPING_OPTION_SELECTED';
    ...
    public const ISSUE_MULTIPLE_SHIPPING_OPTION_SELECTED = 'MULTIPLE_SHIPPING_OPTION_SELECTED';
    public const DESCRIPTION_ONLY_ONE_SHIPPING_OPTION_CAN_BE_SET_TO_SELECTED__TRUE = 'Only one shipping.option can be set to 'selected = true'.';
    ...
    {
        return [
            self::ISSUE_MULTIPLE_SHIPPING_OPTION_SELECTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ONLY_ONE_SHIPPING_OPTION_CAN_BE_SET_TO_SELECTED__TRUE,
        ];
    }
