...
/**
 * TRANSACTIONLIMITEXCEEDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TRANSACTIONLIMITEXCEEDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TRANSACTION_LIMIT_EXCEEDED';
    ...
    public const ISSUE_TRANSACTION_LIMIT_EXCEEDED = 'TRANSACTION_LIMIT_EXCEEDED';
    public const DESCRIPTION_TOTAL_PAYMENT_AMOUNT_EXCEEDED_TRANSACTION_LIMIT = 'Total payment amount exceeded transaction limit.';
    ...
    {
        return [
            self::ISSUE_TRANSACTION_LIMIT_EXCEEDED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_TOTAL_PAYMENT_AMOUNT_EXCEEDED_TRANSACTION_LIMIT,
        ];
    }
