...
/**
 * PAYERACCOUNTRESTRICTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYERACCOUNTRESTRICTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYER_ACCOUNT_RESTRICTED';
    ...
    public const ISSUE_PAYER_ACCOUNT_RESTRICTED = 'PAYER_ACCOUNT_RESTRICTED';
    public const DESCRIPTION_PAYER_ACCOUNT_RESTRICTED = 'PAYER_ACCOUNT_RESTRICTED';
    ...
    {
        return [
            self::ISSUE_PAYER_ACCOUNT_RESTRICTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PAYER_ACCOUNT_RESTRICTED,
        ];
    }
