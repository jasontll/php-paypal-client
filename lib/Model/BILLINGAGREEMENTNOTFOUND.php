...
/**
 * BILLINGAGREEMENTNOTFOUND Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BILLINGAGREEMENTNOTFOUND implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BILLING_AGREEMENT_NOT_FOUND';
    ...
    public const ISSUE_BILLING_AGREEMENT_NOT_FOUND = 'BILLING_AGREEMENT_NOT_FOUND';
    public const DESCRIPTION_THE_REQUESTED_BILLING_AGREEMENT_TOKEN_WAS_NOT_FOUND = 'The requested Billing Agreement token was not found.';
    ...
    {
        return [
            self::ISSUE_BILLING_AGREEMENT_NOT_FOUND,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_REQUESTED_BILLING_AGREEMENT_TOKEN_WAS_NOT_FOUND,
        ];
    }
