...
/**
 * RETURNURLREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RETURNURLREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RETURN_URL_REQUIRED';
    ...
    public const ISSUE_RETURN_URL_REQUIRED = 'RETURN_URL_REQUIRED';
    public const DESCRIPTION_THE_RETURN_URL_IS_REQUIRED_WHEN_ATTEMPTING_TO_VAULT_THIS_SOURCE = 'The return url is required when attempting to vault this source.';
    ...
    {
        return [
            self::ISSUE_RETURN_URL_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_RETURN_URL_IS_REQUIRED_WHEN_ATTEMPTING_TO_VAULT_THIS_SOURCE,
        ];
    }
