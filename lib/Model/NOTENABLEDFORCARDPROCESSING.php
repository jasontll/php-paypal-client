...
/**
 * NOTENABLEDFORCARDPROCESSING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTENABLEDFORCARDPROCESSING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ENABLED_FOR_CARD_PROCESSING';
    ...
    public const ISSUE_NOT_ENABLED_FOR_CARD_PROCESSING = 'NOT_ENABLED_FOR_CARD_PROCESSING';
    public const DESCRIPTION_THE_RECIPIENT_FOR_WHICH_THE_API_CALL_IS_MADE_ON_BEHALF_OF_IS_NOT_ENABLED_FOR_CARD_PROCESSING__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT = 'The recipient for which the API call is made on behalf of is not enabled for card processing. Please contact PayPal customer support.';
    ...
    {
        return [
            self::ISSUE_NOT_ENABLED_FOR_CARD_PROCESSING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_RECIPIENT_FOR_WHICH_THE_API_CALL_IS_MADE_ON_BEHALF_OF_IS_NOT_ENABLED_FOR_CARD_PROCESSING__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT,
        ];
    }
