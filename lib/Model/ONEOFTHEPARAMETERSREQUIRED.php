...
/**
 * ONEOFTHEPARAMETERSREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ONEOFTHEPARAMETERSREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ONE_OF_THE_PARAMETERS_REQUIRED';
    ...
    public const ISSUE_ONE_OF_THE_PARAMETERS_REQUIRED = 'ONE_OF_THE_PARAMETERS_REQUIRED';
    public const DESCRIPTION_ONE_OR_MORE_FIELD_IS_REQUIRED_TO_CONTINUE_WITH_THIS_REQUEST = 'One or more field is required to continue with this request.';
    ...
    {
        return [
            self::ISSUE_ONE_OF_THE_PARAMETERS_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ONE_OR_MORE_FIELD_IS_REQUIRED_TO_CONTINUE_WITH_THIS_REQUEST,
        ];
    }
