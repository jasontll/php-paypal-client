...
/**
 * NOTPATCHABLE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTPATCHABLE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_PATCHABLE';
    ...
    public const ISSUE_NOT_PATCHABLE = 'NOT_PATCHABLE';
    public const DESCRIPTION_CANNOT_BE_PATCHED = 'Cannot be patched.';
    ...
    {
        return [
            self::DESCRIPTION_CANNOT_BE_PATCHED,
        ];
    }
