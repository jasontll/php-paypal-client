...
/**
 * BILLINGADDRESSINVALID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BILLINGADDRESSINVALID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BILLING_ADDRESS_INVALID';
    ...
    public const ISSUE_BILLING_ADDRESS_INVALID = 'BILLING_ADDRESS_INVALID';
    public const DESCRIPTION_PROVIDED_BILLING_ADDRESS_IS_INVALID = 'Provided billing address is invalid.';
    ...
    {
        return [
            self::ISSUE_BILLING_ADDRESS_INVALID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PROVIDED_BILLING_ADDRESS_IS_INVALID,
        ];
    }
