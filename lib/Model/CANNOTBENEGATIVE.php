...
/**
 * CANNOTBENEGATIVE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CANNOTBENEGATIVE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CANNOT_BE_NEGATIVE';
    ...
    public const ISSUE_CANNOT_BE_NEGATIVE = 'CANNOT_BE_NEGATIVE';
    public const DESCRIPTION_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0__IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED = 'Must be greater than or equal to 0. If the currency supports decimals, only two decimal place precision is supported.';
    ...
    {
        return [
            self::DESCRIPTION_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0__IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED,
        ];
    }
