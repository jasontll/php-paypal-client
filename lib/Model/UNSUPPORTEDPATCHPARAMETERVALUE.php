...
/**
 * UNSUPPORTEDPATCHPARAMETERVALUE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UNSUPPORTEDPATCHPARAMETERVALUE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNSUPPORTED_PATCH_PARAMETER_VALUE';
    ...
    public const ISSUE_UNSUPPORTED_PATCH_PARAMETER_VALUE = 'UNSUPPORTED_PATCH_PARAMETER_VALUE';
    public const DESCRIPTION_THE_VALUE_SPECIFIED_FOR_THIS_FIELD_IS_NOT_CURRENTLY_SUPPORTED = 'The value specified for this field is not currently supported.';
    ...
    {
        return [
            self::ISSUE_UNSUPPORTED_PATCH_PARAMETER_VALUE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_VALUE_SPECIFIED_FOR_THIS_FIELD_IS_NOT_CURRENTLY_SUPPORTED,
        ];
    }
