...
/**
 * MISSINGCRYPTOGRAM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MISSINGCRYPTOGRAM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MISSING_CRYPTOGRAM';
    ...
    public const ISSUE_MISSING_CRYPTOGRAM = 'MISSING_CRYPTOGRAM';
    public const DESCRIPTION_CRYPTOGRAM_IS_MANDATORY_FOR_ANY_CUSTOMER_INITIATED_NETWORK_TOKEN_TRANSACTIONS = 'Cryptogram is mandatory for any customer initiated network token transactions.';
    ...
    {
        return [
            self::DESCRIPTION_CRYPTOGRAM_IS_MANDATORY_FOR_ANY_CUSTOMER_INITIATED_NETWORK_TOKEN_TRANSACTIONS,
        ];
    }
