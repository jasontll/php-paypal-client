...
/**
 * PAYERCANNOTPAY1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYERCANNOTPAY1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYER_CANNOT_PAY_1';
    ...
    public const ISSUE_PAYER_CANNOT_PAY = 'PAYER_CANNOT_PAY';
    public const DESCRIPTION_PAYER_CANNOT_PAY_FOR_THIS_TRANSACTION__PLEASE_CONTACT_THE_PAYER_TO_FIND_OTHER_WAYS_TO_PAY_FOR_THIS_TRANSACTION = 'Payer cannot pay for this transaction. Please contact the payer to find other ways to pay for this transaction.';
    ...
    {
        return [
            self::DESCRIPTION_PAYER_CANNOT_PAY_FOR_THIS_TRANSACTION__PLEASE_CONTACT_THE_PAYER_TO_FIND_OTHER_WAYS_TO_PAY_FOR_THIS_TRANSACTION,
        ];
    }
