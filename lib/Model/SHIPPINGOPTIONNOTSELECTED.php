...
/**
 * SHIPPINGOPTIONNOTSELECTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SHIPPINGOPTIONNOTSELECTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SHIPPING_OPTION_NOT_SELECTED';
    ...
    public const ISSUE_SHIPPING_OPTION_NOT_SELECTED = 'SHIPPING_OPTION_NOT_SELECTED';
    public const DESCRIPTION_AT_LEAST_ONE_OF_THE_SHIPPING_OPTION_SHOULD_BE_SET_TO_SELECTED__TRUE = 'At least one of the shipping.option should be set to 'selected = true'.';
    ...
    {
        return [
            self::ISSUE_SHIPPING_OPTION_NOT_SELECTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_AT_LEAST_ONE_OF_THE_SHIPPING_OPTION_SHOULD_BE_SET_TO_SELECTED__TRUE,
        ];
    }
