...
/**
 * NOTELIGIBLEFORPAYPALTRANSACTIONIDPROCESSING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTELIGIBLEFORPAYPALTRANSACTIONIDPROCESSING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ELIGIBLE_FOR_PAYPAL_TRANSACTION_ID_PROCESSING';
    ...
    public const ISSUE_NOT_ELIGIBLE_FOR_PAYPAL_TRANSACTION_ID_PROCESSING = 'NOT_ELIGIBLE_FOR_PAYPAL_TRANSACTION_ID_PROCESSING';
    public const DESCRIPTION_API_CALLER_IS_NOT_ENABLE_TO_PROCESS_PAYMENTS_USING_PAYPAL_TRANSACTION_ID__PLEASE_CONTACT_CUSTOMER_SUPPORT_TO_REQUEST_PERMISSIONS_TO_PROCESS_TRANSACTIONS_WITH_PAY_PAL_TRANSACTION_ID = 'API caller is not enable to process payments using `paypal_transaction_id`. Please contact customer support to request permissions to process transactions with PayPal transaction ID.';
    ...
    {
        return [
            self::ISSUE_NOT_ELIGIBLE_FOR_PAYPAL_TRANSACTION_ID_PROCESSING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_API_CALLER_IS_NOT_ENABLE_TO_PROCESS_PAYMENTS_USING_PAYPAL_TRANSACTION_ID__PLEASE_CONTACT_CUSTOMER_SUPPORT_TO_REQUEST_PERMISSIONS_TO_PROCESS_TRANSACTIONS_WITH_PAY_PAL_TRANSACTION_ID,
        ];
    }
