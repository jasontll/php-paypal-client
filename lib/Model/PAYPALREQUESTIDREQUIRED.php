...
/**
 * PAYPALREQUESTIDREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYPALREQUESTIDREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYPAL_REQUEST_ID_REQUIRED';
    ...
    public const ISSUE_PAYPAL_REQUEST_ID_REQUIRED = 'PAYPAL_REQUEST_ID_REQUIRED';
    public const DESCRIPTION_A_PAY_PAL_REQUEST_ID_IS_REQUIRED_IF_YOU_ARE_TRYING_TO_PROCESS_PAYMENT_FOR_AN_ORDER__PLEASE_SPECIFY_A_PAY_PAL_REQUEST_ID_OR_CREATE_THE_ORDER_WITHOUT_A_PAYMENT_SOURCE_SPECIFIED = 'A PayPal-Request-Id is required if you are trying to process payment for an Order. Please specify a PayPal-Request-Id or Create the Order without a 'payment_source' specified.';
    ...
    {
        return [
            self::ISSUE_PAYPAL_REQUEST_ID_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_A_PAY_PAL_REQUEST_ID_IS_REQUIRED_IF_YOU_ARE_TRYING_TO_PROCESS_PAYMENT_FOR_AN_ORDER__PLEASE_SPECIFY_A_PAY_PAL_REQUEST_ID_OR_CREATE_THE_ORDER_WITHOUT_A_PAYMENT_SOURCE_SPECIFIED,
        ];
    }
