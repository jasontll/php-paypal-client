...
/**
 * PAYEECOUNTRYNOTSUPPORTEDFORPAYMENTSOURCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEECOUNTRYNOTSUPPORTEDFORPAYMENTSOURCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_COUNTRY_NOT_SUPPORTED_FOR_PAYMENT_SOURCE';
    ...
    public const ISSUE_PAYEE_COUNTRY_NOT_SUPPORTED_FOR_PAYMENT_SOURCE = 'PAYEE_COUNTRY_NOT_SUPPORTED_FOR_PAYMENT_SOURCE';
    public const DESCRIPTION_PAYEE_COUNTRY_CODE_IS_NOT_SUPPORTED_BY_THE_PROVIDED_PAYMENT_SOURCE = 'Payee country code is not supported by the provided payment source.';
    ...
    {
        return [
            self::ISSUE_PAYEE_COUNTRY_NOT_SUPPORTED_FOR_PAYMENT_SOURCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PAYEE_COUNTRY_CODE_IS_NOT_SUPPORTED_BY_THE_PROVIDED_PAYMENT_SOURCE,
        ];
    }
