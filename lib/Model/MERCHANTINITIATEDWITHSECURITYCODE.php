...
/**
 * MERCHANTINITIATEDWITHSECURITYCODE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MERCHANTINITIATEDWITHSECURITYCODE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MERCHANT_INITIATED_WITH_SECURITY_CODE';
    ...
    public const ISSUE_MERCHANT_INITIATED_WITH_SECURITY_CODE = 'MERCHANT_INITIATED_WITH_SECURITY_CODE';
    public const DESCRIPTION_STORED_PAYMENT_SOURCE_PAYMENT_INITIATOR__MERCHANT_IS_NOT_SUPPORTED_IF_PAYMENT_SOURCE_CARD_SECURITY_CODE_IS_PRESENT_IN_THE_ORDER__SECURITY_CODE_CAN_BE_PRESENT_IN_THE_ORDER_ONLY_WHEN_CUSTOMER_IS_THE_PAYMENT_INITIATOR__IT_IS_SEMANTICALLY_INCORRECT_TO_PERFORM_A_MERCHANT_INITIATED_PAYMENT_WITH_SECURITY_CODE_IS_THE_ORDER = '`stored_payment_source.payment_initiator` = `MERCHANT` is not supported if `payment_source.card.security_code` is present in the order. `security_code` can be present in the order only when customer is the payment initiator. It is semantically incorrect to perform a merchant initiated payment with `security_code` is the order.';
    ...
    {
        return [
            self::ISSUE_MERCHANT_INITIATED_WITH_SECURITY_CODE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_STORED_PAYMENT_SOURCE_PAYMENT_INITIATOR__MERCHANT_IS_NOT_SUPPORTED_IF_PAYMENT_SOURCE_CARD_SECURITY_CODE_IS_PRESENT_IN_THE_ORDER__SECURITY_CODE_CAN_BE_PRESENT_IN_THE_ORDER_ONLY_WHEN_CUSTOMER_IS_THE_PAYMENT_INITIATOR__IT_IS_SEMANTICALLY_INCORRECT_TO_PERFORM_A_MERCHANT_INITIATED_PAYMENT_WITH_SECURITY_CODE_IS_THE_ORDER,
        ];
    }
