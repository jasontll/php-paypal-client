...
/**
 * OrdersAuthorize403IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersAuthorize403IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_authorize_403_issues_inner';
    ...
    public const ISSUE_PERMISSION_DENIED_FOR_DONATION_ITEMS = 'PERMISSION_DENIED_FOR_DONATION_ITEMS';
    public const DESCRIPTION_THE_API_CALLER_OR_PAYEE_HAVE_NOT_BEEN_GRANTED_APPROPRIATE_PERMISSIONS_TO_SEND_ITEMS_CATEGORY_AS_DONATION__PLEASE_SPEAK_TO_YOUR_ACCOUNT_MANAGER_IF_YOU_WANT_TO_PROCESS_THESE_TYPE_OF_ITEMS = 'The API Caller or Payee have not been granted appropriate permissions to send 'items.category' as 'DONATION'. Please speak to your account manager if you want to process these type of items.';
    ...
    {
        return [
            self::ISSUE_PERMISSION_DENIED_FOR_DONATION_ITEMS,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_OR_PAYEE_HAVE_NOT_BEEN_GRANTED_APPROPRIATE_PERMISSIONS_TO_SEND_ITEMS_CATEGORY_AS_DONATION__PLEASE_SPEAK_TO_YOUR_ACCOUNT_MANAGER_IF_YOU_WANT_TO_PROCESS_THESE_TYPE_OF_ITEMS,
        ];
    }
