...
/**
 * ITEMTOTALREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ITEMTOTALREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ITEM_TOTAL_REQUIRED';
    ...
    public const ISSUE_ITEM_TOTAL_REQUIRED = 'ITEM_TOTAL_REQUIRED';
    public const DESCRIPTION_IF_ITEM_DETAILS_ARE_SPECIFIED__ITEMS_UNIT_AMOUNT_AND_ITEMS_QUANTITY_CORRESPONDING_AMOUNT_BREAKDOWN_ITEM_TOTAL_IS_REQUIRED = 'If item details are specified (items.unit_amount and items.quantity) corresponding amount.breakdown.item_total is required.';
    ...
    {
        return [
            self::ISSUE_ITEM_TOTAL_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_IF_ITEM_DETAILS_ARE_SPECIFIED__ITEMS_UNIT_AMOUNT_AND_ITEMS_QUANTITY_CORRESPONDING_AMOUNT_BREAKDOWN_ITEM_TOTAL_IS_REQUIRED,
        ];
    }
