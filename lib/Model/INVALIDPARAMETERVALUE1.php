...
/**
 * INVALIDPARAMETERVALUE1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPARAMETERVALUE1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PARAMETER_VALUE_1';
    ...
    public const DESCRIPTION_THE_VALUE_OF_A_FIELD_IS_INVALID = 'The value of a field is invalid.';
    ...
    {
        return [
            self::ISSUE_INVALID_PARAMETER_VALUE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_VALUE_OF_A_FIELD_IS_INVALID,
        ];
    }
