...
/**
 * NOTELIGIBLEFORPNREFPROCESSING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTELIGIBLEFORPNREFPROCESSING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ELIGIBLE_FOR_PNREF_PROCESSING';
    ...
    public const ISSUE_NOT_ELIGIBLE_FOR_PNREF_PROCESSING = 'NOT_ELIGIBLE_FOR_PNREF_PROCESSING';
    public const DESCRIPTION_API_CALLER_IS_NOT_ENABLED_TO_PROCESS_PAYMENTS_WITH_THE_PNREF__PLEASE_CONTACT_CUSTOMER_SUPPORT_TO_REQUEST_PERMISSIONS_TO_PROCESS_TRANSACTIONS_WITH_PNREF = 'API caller is not enabled to process payments with the `pnref`. Please contact customer support to request permissions to process transactions with PNREF.';
    ...
    {
        return [
            self::ISSUE_NOT_ELIGIBLE_FOR_PNREF_PROCESSING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_API_CALLER_IS_NOT_ENABLED_TO_PROCESS_PAYMENTS_WITH_THE_PNREF__PLEASE_CONTACT_CUSTOMER_SUPPORT_TO_REQUEST_PERMISSIONS_TO_PROCESS_TRANSACTIONS_WITH_PNREF,
        ];
    }
