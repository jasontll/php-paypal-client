...
/**
 * PREFERREDPAYMENTSOURCEMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PREFERREDPAYMENTSOURCEMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PREFERRED_PAYMENT_SOURCE_MISMATCH';
    ...
    public const ISSUE_PREFERRED_PAYMENT_SOURCE_MISMATCH = 'PREFERRED_PAYMENT_SOURCE_MISMATCH';
    public const DESCRIPTION_PAYMENT_SOURCE_MUST_EXACTLY_MATCH_THE_PREFERRED_PAYMENT_SOURCE_THAT_WAS_PROVIDED_DURING_ORDER_CREATION = 'Payment Source must exactly match the Preferred Payment Source that was provided during order creation.';
    ...
    {
        return [
            self::ISSUE_PREFERRED_PAYMENT_SOURCE_MISMATCH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PAYMENT_SOURCE_MUST_EXACTLY_MATCH_THE_PREFERRED_PAYMENT_SOURCE_THAT_WAS_PROVIDED_DURING_ORDER_CREATION,
        ];
    }
