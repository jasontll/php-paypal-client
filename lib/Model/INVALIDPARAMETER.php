...
/**
 * INVALIDPARAMETER Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPARAMETER implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PARAMETER';
    ...
    public const ISSUE_INVALID_PARAMETER = 'INVALID_PARAMETER';
    public const DESCRIPTION_CANNOT_BE_SPECIFIED_AS_PART_OF_THE_REQUEST = 'Cannot be specified as part of the request.';
    ...
    {
        return [
            self::DESCRIPTION_CANNOT_BE_SPECIFIED_AS_PART_OF_THE_REQUEST,
        ];
    }
