...
/**
 * TRANSACTIONREFUSED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TRANSACTIONREFUSED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TRANSACTION_REFUSED';
    ...
    public const ISSUE_TRANSACTION_REFUSED = 'TRANSACTION_REFUSED';
    public const DESCRIPTION_THE_REQUEST_WAS_REFUSED = 'The request was refused.';
    ...
    {
        return [
            self::ISSUE_TRANSACTION_REFUSED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_REQUEST_WAS_REFUSED,
        ];
    }
