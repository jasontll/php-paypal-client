...
/**
 * MULTIPLESHIPPINGADDRESSNOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MULTIPLESHIPPINGADDRESSNOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MULTIPLE_SHIPPING_ADDRESS_NOT_SUPPORTED';
    ...
    public const ISSUE_MULTIPLE_SHIPPING_ADDRESS_NOT_SUPPORTED = 'MULTIPLE_SHIPPING_ADDRESS_NOT_SUPPORTED';
    public const DESCRIPTION_MULTIPLE_SHIPPING_ADDRESSES_ARE_NOT_SUPPORTED = 'Multiple shipping addresses are not supported.';
    ...
    {
        return [
            self::ISSUE_MULTIPLE_SHIPPING_ADDRESS_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_MULTIPLE_SHIPPING_ADDRESSES_ARE_NOT_SUPPORTED,
        ];
    }
