...
/**
 * VaultVenmoWalletBaseAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VaultVenmoWalletBaseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vault_venmo_wallet_base_allOf';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 128)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VaultVenmoWalletBaseAllOf., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VaultVenmoWalletBaseAllOf., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_'\\-., :;\\!?\"]*$/", $description))) {
            throw new \InvalidArgumentException("invalid value for \$description when calling VaultVenmoWalletBaseAllOf., must conform to the pattern /^[a-zA-Z0-9_'\\-., :;\\!?\"]*$/.");
        }
    ...
    public function setUsagePattern($usage_pattern)
    {
        ...
        if ((mb_strlen($usage_pattern) > 30)) {
            throw new \InvalidArgumentException('invalid length for $usage_pattern when calling VaultVenmoWalletBaseAllOf., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($usage_pattern) < 1)) {
            throw new \InvalidArgumentException('invalid length for $usage_pattern when calling VaultVenmoWalletBaseAllOf., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $usage_pattern))) {
            throw new \InvalidArgumentException("invalid value for \$usage_pattern when calling VaultVenmoWalletBaseAllOf., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
     ...
     * Sets usage_type
     *
     * @param string|null $usage_type The usage type associated with the Venmo payment token.
     *
     * @return self
     */
    public function setUsageType($usage_type)
    {
        ...
        if ((mb_strlen($usage_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $usage_type when calling VaultVenmoWalletBaseAllOf., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($usage_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $usage_type when calling VaultVenmoWalletBaseAllOf., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $usage_type))) {
            throw new \InvalidArgumentException("invalid value for \$usage_type when calling VaultVenmoWalletBaseAllOf., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
    ...
    public function setCustomerType($customer_type)
    {
        ...
        if ((mb_strlen($customer_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_type when calling VaultVenmoWalletBaseAllOf., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($customer_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_type when calling VaultVenmoWalletBaseAllOf., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $customer_type))) {
            throw new \InvalidArgumentException("invalid value for \$customer_type when calling VaultVenmoWalletBaseAllOf., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
