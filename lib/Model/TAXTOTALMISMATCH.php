...
/**
 * TAXTOTALMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TAXTOTALMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TAX_TOTAL_MISMATCH';
    ...
    public const ISSUE_TAX_TOTAL_MISMATCH = 'TAX_TOTAL_MISMATCH';
    public const DESCRIPTION_SHOULD_EQUAL_SUM_OF__TAX__QUANTITY_ACROSS_ALL_ITEMS_FOR_A_GIVEN_PURCHASE_UNIT = 'Should equal sum of (tax * quantity) across all items for a given purchase_unit.';
    ...
    {
        return [
            self::DESCRIPTION_SHOULD_EQUAL_SUM_OF__TAX__QUANTITY_ACROSS_ALL_ITEMS_FOR_A_GIVEN_PURCHASE_UNIT,
        ];
    }
