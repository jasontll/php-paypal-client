...
/**
 * INVALIDPARAMETERSYNTAX1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPARAMETERSYNTAX1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PARAMETER_SYNTAX_1';
    ...
    public const DESCRIPTION_THE_VALUE_OF_THE_FIELD_DOES_NOT_CONFORM_TO_THE_EXPECTED_FORMAT = 'The value of the field does not conform to the expected format.';
    ...
    {
        return [
            self::DESCRIPTION_THE_VALUE_OF_THE_FIELD_DOES_NOT_CONFORM_TO_THE_EXPECTED_FORMAT,
        ];
    }
