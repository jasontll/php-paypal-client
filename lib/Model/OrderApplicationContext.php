...
/**
 * OrderApplicationContext Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderApplicationContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order_application_context';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['shipping_preference']) && (mb_strlen($this->container['shipping_preference']) > 20)) {
            $invalidProperties[] = "invalid value for 'shipping_preference', the character length must be smaller than or equal to 20.";
        }
        ...
        if (!is_null($this->container['shipping_preference']) && !preg_match("/^[0-9A-Z_]+$/", $this->container['shipping_preference'])) {
            $invalidProperties[] = "invalid value for 'shipping_preference', must be conform to the pattern /^[0-9A-Z_]+$/.";
        }
     ...
     * Sets brand_name
     *
     * @param string|null $brand_name DEPRECATED. The label that overrides the business name in the PayPal account on the PayPal site. The fields in `application_context` are now available in the `experience_context` object under the `payment_source` which supports them (eg. `payment_source.paypal.experience_context.brand_name`). Please specify this field in the `experience_context` object instead of the `application_context` object.
     *
     * @return self
     */
    public function setBrandName($brand_name)
    {
        ...
        if ((mb_strlen($brand_name) > 127)) {
            throw new \InvalidArgumentException('invalid length for $brand_name when calling OrderApplicationContext., must be smaller than or equal to 127.');
        }
        if ((mb_strlen($brand_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $brand_name when calling OrderApplicationContext., must be bigger than or equal to 1.');
        }
    ...
    public function setLocale($locale)
    {
        ...
        if ((mb_strlen($locale) > 10)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling OrderApplicationContext., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($locale) < 2)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling OrderApplicationContext., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[a-z]{2}(?:-[A-Z][a-z]{3})?(?:-(?:[A-Z]{2}|[0-9]{3}))?$/", $locale))) {
            throw new \InvalidArgumentException("invalid value for \$locale when calling OrderApplicationContext., must conform to the pattern /^[a-z]{2}(?:-[A-Z][a-z]{3})?(?:-(?:[A-Z]{2}|[0-9]{3}))?$/.");
        }
     ...
     * Sets landing_page
     *
     * @param string|null $landing_page DEPRECATED. DEPRECATED. The type of landing page to show on the PayPal site for customer checkout.  The fields in `application_context` are now available in the `experience_context` object under the `payment_source` which supports them (eg. `payment_source.paypal.experience_context.landing_page`). Please specify this field in the `experience_context` object instead of the `application_context` object.
     *
     * @return self
     * @deprecated
     */
    public function setLandingPage($landing_page)
    {
        ...
        if ((mb_strlen($landing_page) > 13)) {
            throw new \InvalidArgumentException('invalid length for $landing_page when calling OrderApplicationContext., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($landing_page) < 1)) {
            throw new \InvalidArgumentException('invalid length for $landing_page when calling OrderApplicationContext., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $landing_page))) {
            throw new \InvalidArgumentException("invalid value for \$landing_page when calling OrderApplicationContext., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
     ...
     *
     * @param string|null $shipping_preference DEPRECATED. DEPRECATED. The shipping preference:<ul><li>Displays the shipping address to the customer.</li><li>Enables the customer to choose an address on the PayPal site.</li><li>Restricts the customer from changing the address during the payment-approval process.</li></ul>.  The fields in `application_context` are now available in the `experience_context` object under the `payment_source` which supports them (eg. `payment_source.paypal.experience_context.shipping_preference`). Please specify this field in the `experience_context` object instead of the `application_context` object.
     *
     * @return self
     * @deprecated
     */
    public function setShippingPreference($shipping_preference)
    {
        ...
        if ((mb_strlen($shipping_preference) > 20)) {
            throw new \InvalidArgumentException('invalid length for $shipping_preference when calling OrderApplicationContext., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($shipping_preference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipping_preference when calling OrderApplicationContext., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $shipping_preference))) {
            throw new \InvalidArgumentException("invalid value for \$shipping_preference when calling OrderApplicationContext., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
     ...
     * Sets user_action
     *
     * @param string|null $user_action DEPRECATED. Configures a <strong>Continue</strong> or <strong>Pay Now</strong> checkout flow.  The fields in `application_context` are now available in the `experience_context` object under the `payment_source` which supports them (eg. `payment_source.paypal.experience_context.user_action`). Please specify this field in the `experience_context` object instead of the `application_context` object.
     *
     * @return self
     */
    public function setUserAction($user_action)
    {
        ...
        if ((mb_strlen($user_action) > 8)) {
            throw new \InvalidArgumentException('invalid length for $user_action when calling OrderApplicationContext., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($user_action) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_action when calling OrderApplicationContext., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $user_action))) {
            throw new \InvalidArgumentException("invalid value for \$user_action when calling OrderApplicationContext., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
     ...
     * Sets return_url
     *
     * @param string|null $return_url DEPRECATED. The URL where the customer is redirected after the customer approves the payment. The fields in `application_context` are now available in the `experience_context` object under the `payment_source` which supports them (eg. `payment_source.paypal.experience_context.return_url`). Please specify this field in the `experience_context` object instead of the `application_context` object.
     *
     * @return self
     */
     ...
     * Sets cancel_url
     *
     * @param string|null $cancel_url DEPRECATED. The URL where the customer is redirected after the customer cancels the payment. The fields in `application_context` are now available in the `experience_context` object under the `payment_source` which supports them (eg. `payment_source.paypal.experience_context.cancel_url`). Please specify this field in the `experience_context` object instead of the `application_context` object.
     *
     * @return self
     */
