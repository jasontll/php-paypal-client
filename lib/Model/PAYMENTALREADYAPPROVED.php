...
/**
 * PAYMENTALREADYAPPROVED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYMENTALREADYAPPROVED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYMENT_ALREADY_APPROVED';
    ...
    public const ISSUE_PAYMENT_ALREADY_APPROVED = 'PAYMENT_ALREADY_APPROVED';
    public const DESCRIPTION_THE_PAYMENT_HAS_ALREADY_BEEN_APPROVED___PLEASE_CAPTURE_THE_ORDER_OR_CREATE_AND_CONFIRM_A_NEW_ORDER_WITH_THIS_PAYMENT_SOURCE = 'The payment has already been approved.  Please capture the order, or create and confirm a new order with this payment source.';
    ...
    {
        return [
            self::ISSUE_PAYMENT_ALREADY_APPROVED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PAYMENT_HAS_ALREADY_BEEN_APPROVED___PLEASE_CAPTURE_THE_ORDER_OR_CREATE_AND_CONFIRM_A_NEW_ORDER_WITH_THIS_PAYMENT_SOURCE,
        ];
    }
