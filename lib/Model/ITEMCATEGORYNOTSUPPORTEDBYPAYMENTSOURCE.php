...
/**
 * ITEMCATEGORYNOTSUPPORTEDBYPAYMENTSOURCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ITEMCATEGORYNOTSUPPORTEDBYPAYMENTSOURCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ITEM_CATEGORY_NOT_SUPPORTED_BY_PAYMENT_SOURCE';
    ...
    public const ISSUE_ITEM_CATEGORY_NOT_SUPPORTED_BY_PAYMENT_SOURCE = 'ITEM_CATEGORY_NOT_SUPPORTED_BY_PAYMENT_SOURCE';
    public const DESCRIPTION_THE_PROVIDED_PAYMENT_SOURCE_DOES_NOT_SUPPORT_PROVIDED_ITEM_CATEGORY = 'The provided payment source does not support provided item category.';
    ...
    {
        return [
            self::ISSUE_ITEM_CATEGORY_NOT_SUPPORTED_BY_PAYMENT_SOURCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PROVIDED_PAYMENT_SOURCE_DOES_NOT_SUPPORT_PROVIDED_ITEM_CATEGORY,
        ];
    }
