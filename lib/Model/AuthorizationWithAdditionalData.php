...
/**
 * AuthorizationWithAdditionalData Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthorizationWithAdditionalData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'authorization_with_additional_data';
    ...
    protected static $openAPITypes = [
        ...
        'create_time' => 'string',
        'update_time' => 'string',
        'processor_response' => '\OpenAPI\Client\Model\ProcessorResponse'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('processor_response', $data ?? [], null);
    }
    ...
    */
    ...
    public function setCustomId($custom_id)
    {
        ...
        if ((mb_strlen($custom_id) > 127)) {
            throw new \InvalidArgumentException('invalid length for $custom_id when calling AuthorizationWithAdditionalData., must be smaller than or equal to 127.');
        }
    ...
    public function setExpirationTime($expiration_time)
    {
        ...
        if ((mb_strlen($expiration_time) > 64)) {
            throw new \InvalidArgumentException('invalid length for $expiration_time when calling AuthorizationWithAdditionalData., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($expiration_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $expiration_time when calling AuthorizationWithAdditionalData., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/", $expiration_time))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_time when calling AuthorizationWithAdditionalData., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/.");
        }
    ...
    public function setCreateTime($create_time)
    {
        ...
        if ((mb_strlen($create_time) > 64)) {
            throw new \InvalidArgumentException('invalid length for $create_time when calling AuthorizationWithAdditionalData., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($create_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $create_time when calling AuthorizationWithAdditionalData., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/", $create_time))) {
            throw new \InvalidArgumentException("invalid value for \$create_time when calling AuthorizationWithAdditionalData., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/.");
        }
    ...
    public function setUpdateTime($update_time)
    {
        ...
        if ((mb_strlen($update_time) > 64)) {
            throw new \InvalidArgumentException('invalid length for $update_time when calling AuthorizationWithAdditionalData., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($update_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $update_time when calling AuthorizationWithAdditionalData., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/", $update_time))) {
            throw new \InvalidArgumentException("invalid value for \$update_time when calling AuthorizationWithAdditionalData., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ProcessorResponse|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ProcessorResponse|null $processor_response processor_response
     *
     * @return self
     */
    public function setProcessorResponse($processor_response)
    {
        if (is_null($processor_response)) {
            throw new \InvalidArgumentException('non-nullable processor_response cannot be null');
        }
