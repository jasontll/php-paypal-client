...
/**
 * INVALIDPARAMETERVALUE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPARAMETERVALUE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PARAMETER_VALUE';
    ...
    public const DESCRIPTION_A_PARAMETER_VALUE_IS_NOT_VALID = 'A parameter value is not valid.';
    ...
    {
        return [
            self::DESCRIPTION_A_PARAMETER_VALUE_IS_NOT_VALID,
        ];
    }
