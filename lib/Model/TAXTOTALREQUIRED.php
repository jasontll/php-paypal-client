...
/**
 * TAXTOTALREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TAXTOTALREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TAX_TOTAL_REQUIRED';
    ...
    public const ISSUE_TAX_TOTAL_REQUIRED = 'TAX_TOTAL_REQUIRED';
    public const DESCRIPTION_IF_ITEM_DETAILS_ARE_SPECIFIED__ITEMS_TAX_TOTAL_AND_ITEMS_QUANTITY_CORRESPONDING_AMOUNT_BREAKDOWN_TAX_TOTAL_IS_REQUIRED = 'If item details are specified (items.tax_total and items.quantity) corresponding amount.breakdown.tax_total is required.';
    ...
    {
        return [
            self::DESCRIPTION_IF_ITEM_DETAILS_ARE_SPECIFIED__ITEMS_TAX_TOTAL_AND_ITEMS_QUANTITY_CORRESPONDING_AMOUNT_BREAKDOWN_TAX_TOTAL_IS_REQUIRED,
        ];
    }
