...
/**
 * DEVICEDATANOTAVAILABLE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DEVICEDATANOTAVAILABLE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DEVICE_DATA_NOT_AVAILABLE';
    ...
    public const ISSUE_DEVICE_DATA_NOT_AVAILABLE = 'DEVICE_DATA_NOT_AVAILABLE';
    public const DESCRIPTION_DEVICE_DATA_IS_NOT_AVAILABLE_FOR_PROCESSING_THIS_ORDER__THE_PAY_PAL_CLIENT_METADATA_ID_HEADER_VALUE_SENT_DURING_CREATE_ORDER_API_CALL_IS_EITHER_MISSING_OR_INCORRECT_OR_THERE_WAS_AN_ERROR_IN_COLLECTING_REQUIRED_DATA__PLEASE_VERIFY_IF_APPROPRIATE_VALUE_FOR_PAY_PAL_CLIENT_METADATA_ID_HEADER_IS_BEING_SENT_DURING_CREATE_ORDER_API_CALL__PLEASE_NOTE_THIS_ERROR_ONLY_APPLIES_TO_PAYMENT_SOURCE_PAY_UPON_INVOICE_AT_THE_MOMENT = 'Device Data is not available for processing this order. The PayPal-Client-Metadata-Id header value sent during `Create Order` api call is either missing or incorrect or there was an error in collecting required data. Please verify if appropriate value for PayPal-Client-Metadata-Id header is being sent during 'Create Order' api call. Please note this error only applies to payment_source.pay_upon_invoice at the moment.';
    ...
    {
        return [
            self::ISSUE_DEVICE_DATA_NOT_AVAILABLE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_DEVICE_DATA_IS_NOT_AVAILABLE_FOR_PROCESSING_THIS_ORDER__THE_PAY_PAL_CLIENT_METADATA_ID_HEADER_VALUE_SENT_DURING_CREATE_ORDER_API_CALL_IS_EITHER_MISSING_OR_INCORRECT_OR_THERE_WAS_AN_ERROR_IN_COLLECTING_REQUIRED_DATA__PLEASE_VERIFY_IF_APPROPRIATE_VALUE_FOR_PAY_PAL_CLIENT_METADATA_ID_HEADER_IS_BEING_SENT_DURING_CREATE_ORDER_API_CALL__PLEASE_NOTE_THIS_ERROR_ONLY_APPLIES_TO_PAYMENT_SOURCE_PAY_UPON_INVOICE_AT_THE_MOMENT,
        ];
    }
