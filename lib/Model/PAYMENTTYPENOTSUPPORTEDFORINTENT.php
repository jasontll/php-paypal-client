...
/**
 * PAYMENTTYPENOTSUPPORTEDFORINTENT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYMENTTYPENOTSUPPORTEDFORINTENT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYMENT_TYPE_NOT_SUPPORTED_FOR_INTENT';
    ...
    public const ISSUE_PAYMENT_TYPE_NOT_SUPPORTED_FOR_INTENT = 'PAYMENT_TYPE_NOT_SUPPORTED_FOR_INTENT';
    public const DESCRIPTION_PROVIDED_PAYMENT_TYPE_NOT_SUPPORTED_FOR_ORDER_INTENT__PAYMENT_AUTHORIZATIONS_ARE_SUPPORTED_ONLY_FOR_ORDER_WITH_INTENTAUTHORIZE_AND_PAYMENT_CAPTURES_ARE_SUPPORTED_ONLY_FOR_ORDER_WITH_INTENTCAPTURE = 'Provided payment type not supported for order intent. Payment authorizations are supported only for order with `intent=AUTHORIZE` and payment captures are supported only for order with `intent=CAPTURE`.';
    ...
    {
        return [
            self::ISSUE_PAYMENT_TYPE_NOT_SUPPORTED_FOR_INTENT,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PROVIDED_PAYMENT_TYPE_NOT_SUPPORTED_FOR_ORDER_INTENT__PAYMENT_AUTHORIZATIONS_ARE_SUPPORTED_ONLY_FOR_ORDER_WITH_INTENTAUTHORIZE_AND_PAYMENT_CAPTURES_ARE_SUPPORTED_ONLY_FOR_ORDER_WITH_INTENTCAPTURE,
        ];
    }
