...
/**
 * INVALIDCOUNTRYCODE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDCOUNTRYCODE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_COUNTRY_CODE';
    ...
    public const ISSUE_INVALID_COUNTRY_CODE = 'INVALID_COUNTRY_CODE';
    public const DESCRIPTION_COUNTRY_CODE_IS_INVALID__PLEASE_REFER_TO_HTTPS__DEVELOPER_PAYPAL_COM_API_REST_REFERENCE_COUNTRY_CODES__FOR_A_LIST_OF_SUPPORTED_COUNTRY_CODES = 'Country code is invalid. Please refer to https://developer.paypal.com/api/rest/reference/country-codes/ for a list of supported country codes.';
    ...
    {
        return [
            self::ISSUE_INVALID_COUNTRY_CODE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_COUNTRY_CODE_IS_INVALID__PLEASE_REFER_TO_HTTPS__DEVELOPER_PAYPAL_COM_API_REST_REFERENCE_COUNTRY_CODES__FOR_A_LIST_OF_SUPPORTED_COUNTRY_CODES,
        ];
    }
