...
/**
 * PAYMENTSOURCECANNOTBEUSED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYMENTSOURCECANNOTBEUSED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYMENT_SOURCE_CANNOT_BE_USED';
    ...
    public const ISSUE_PAYMENT_SOURCE_CANNOT_BE_USED = 'PAYMENT_SOURCE_CANNOT_BE_USED';
    public const DESCRIPTION_THE_PROVIDED_PAYMENT_SOURCE_CANNOT_BE_USED_TO_PAY_FOR_THE_ORDER__PLEASE_TRY_AGAIN_WITH_A_DIFFERENT_PAYMENT_SOURCE_BY_CREATING_A_NEW_ORDER = 'The provided payment source cannot be used to pay for the order. Please try again with a different payment source by creating a new order.';
    ...
    {
        return [
            self::ISSUE_PAYMENT_SOURCE_CANNOT_BE_USED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PROVIDED_PAYMENT_SOURCE_CANNOT_BE_USED_TO_PAY_FOR_THE_ORDER__PLEASE_TRY_AGAIN_WITH_A_DIFFERENT_PAYMENT_SOURCE_BY_CREATING_A_NEW_ORDER,
        ];
    }
