...
/**
 * ORDERALREADYCOMPLETED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERALREADYCOMPLETED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_ALREADY_COMPLETED';
    ...
    public const ISSUE_ORDER_ALREADY_COMPLETED = 'ORDER_ALREADY_COMPLETED';
    public const DESCRIPTION_THE_ORDER_CANNOT_BE_PATCHED_AFTER_IT_IS_COMPLETED = 'The order cannot be patched after it is completed.';
    ...
    {
        return [
            self::ISSUE_ORDER_ALREADY_COMPLETED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_ORDER_CANNOT_BE_PATCHED_AFTER_IT_IS_COMPLETED,
        ];
    }
