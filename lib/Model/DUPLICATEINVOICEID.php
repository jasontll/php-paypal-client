...
/**
 * DUPLICATEINVOICEID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DUPLICATEINVOICEID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DUPLICATE_INVOICE_ID';
    ...
    public const DESCRIPTION_DUPLICATE_INVOICE_ID_DETECTED__TO_AVOID_A_POTENTIAL_DUPLICATE_TRANSACTION_YOUR_ACCOUNT_SETTING_REQUIRES_THAT_INVOICE_ID_BE_UNIQUE_FOR_EACH_TRANSACTION = 'Duplicate Invoice ID detected. To avoid a potential duplicate transaction your account setting requires that Invoice Id be unique for each transaction.';
    ...
    {
        return [
            self::ISSUE_DUPLICATE_INVOICE_ID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_DUPLICATE_INVOICE_ID_DETECTED__TO_AVOID_A_POTENTIAL_DUPLICATE_TRANSACTION_YOUR_ACCOUNT_SETTING_REQUIRES_THAT_INVOICE_ID_BE_UNIQUE_FOR_EACH_TRANSACTION,
        ];
    }
