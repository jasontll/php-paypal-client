...
/**
 * NOTELIGIBLEFORTOKENPROCESSING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTELIGIBLEFORTOKENPROCESSING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ELIGIBLE_FOR_TOKEN_PROCESSING';
    ...
    public const ISSUE_NOT_ELIGIBLE_FOR_TOKEN_PROCESSING = 'NOT_ELIGIBLE_FOR_TOKEN_PROCESSING';
    public const DESCRIPTION_API_CALLER_IS_NOT_ENABLED_TO_PROCESS_PAYMENTS_WITH_THE_SPECIFIED_TYPE_OF_TOKEN__PLEASE_CONTACT_CUSTOMER_SUPPORT_TO_REQUEST_PERMISSIONS_TO_PROCESS_TRANSACTIONS_WITH_THIS_TYPE_OF_TOKEN = 'API caller is not enabled to process payments with the specified type of token. Please contact customer support to request permissions to process transactions with this type of token.';
    ...
    {
        return [
            self::ISSUE_NOT_ELIGIBLE_FOR_TOKEN_PROCESSING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_API_CALLER_IS_NOT_ENABLED_TO_PROCESS_PAYMENTS_WITH_THE_SPECIFIED_TYPE_OF_TOKEN__PLEASE_CONTACT_CUSTOMER_SUPPORT_TO_REQUEST_PERMISSIONS_TO_PROCESS_TRANSACTIONS_WITH_THIS_TYPE_OF_TOKEN,
        ];
    }
