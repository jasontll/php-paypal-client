...
/**
 * CURRENCYNOTSUPPORTEDFORBANK Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CURRENCYNOTSUPPORTEDFORBANK implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURRENCY_NOT_SUPPORTED_FOR_BANK';
    ...
    public const ISSUE_CURRENCY_NOT_SUPPORTED_FOR_BANK = 'CURRENCY_NOT_SUPPORTED_FOR_BANK';
    public const DESCRIPTION_THE_PAYMENT_SOURCE_DOES_NOT_SUPPORT_THE_CURRENCY_OF_THE_ORDER__FOR_ACH_DEBIT_ONLY_USD_IS_SUPPORTED_AND_FOR_SEPA_DEBIT_ONLY_EUR_IS_SUPPORTED = 'The payment_source does not support the currency of the Order. For ACH debit, only USD is supported and for SEPA debit, only EUR is supported.';
    ...
    {
        return [
            self::ISSUE_CURRENCY_NOT_SUPPORTED_FOR_BANK,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PAYMENT_SOURCE_DOES_NOT_SUPPORT_THE_CURRENCY_OF_THE_ORDER__FOR_ACH_DEBIT_ONLY_USD_IS_SUPPORTED_AND_FOR_SEPA_DEBIT_ONLY_EUR_IS_SUPPORTED,
        ];
    }
