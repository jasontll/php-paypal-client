...
/**
 * REFERENCEDCARDEXPIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class REFERENCEDCARDEXPIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'REFERENCED_CARD_EXPIRED';
    ...
    public const ISSUE_REFERENCED_CARD_EXPIRED = 'REFERENCED_CARD_EXPIRED';
    public const DESCRIPTION_THE_CARD_UNDERLYING_THE_TOKEN_HAS_EXPIRED_AND_HENCE_CANNOT_BE_USED_TO_PROCESS_A_PAYMENT = 'The card underlying the token has expired and hence cannot be used to process a payment.';
    ...
    {
        return [
            self::ISSUE_REFERENCED_CARD_EXPIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_CARD_UNDERLYING_THE_TOKEN_HAS_EXPIRED_AND_HENCE_CANNOT_BE_USED_TO_PROCESS_A_PAYMENT,
        ];
    }
