...
/**
 * AMOUNTMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AMOUNTMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AMOUNT_MISMATCH';
    ...
    public const DESCRIPTION_SHOULD_EQUAL_ITEM_TOTAL__TAX_TOTAL__SHIPPING__HANDLING__INSURANCE___SHIPPING_DISCOUNT___DISCOUNT = 'Should equal item_total + tax_total + shipping + handling + insurance - shipping_discount - discount.';
    ...
    {
        return [
            self::DESCRIPTION_SHOULD_EQUAL_ITEM_TOTAL__TAX_TOTAL__SHIPPING__HANDLING__INSURANCE___SHIPPING_DISCOUNT___DISCOUNT,
        ];
    }
