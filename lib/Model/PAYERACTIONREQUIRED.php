...
/**
 * PAYERACTIONREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYERACTIONREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYER_ACTION_REQUIRED';
    ...
    public const DESCRIPTION_TRANSACTION_CANNOT_COMPLETE_SUCCESSFULLY_INSTRUCT_THE_BUYER_TO_RETURN_TO_PAY_PAL = 'Transaction cannot complete successfully, instruct the buyer to return to PayPal.';
    ...
    {
        return [
            self::DESCRIPTION_TRANSACTION_CANNOT_COMPLETE_SUCCESSFULLY_INSTRUCT_THE_BUYER_TO_RETURN_TO_PAY_PAL,
        ];
    }
