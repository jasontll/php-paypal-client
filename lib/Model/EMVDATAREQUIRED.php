...
/**
 * EMVDATAREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EMVDATAREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EMV_DATA_REQUIRED';
    ...
    public const ISSUE_EMV_DATA_REQUIRED = 'EMV_DATA_REQUIRED';
    public const DESCRIPTION_EMV_DATA_IS_REQUIRED_IF_AUTHENTICATION_METHOD_IS_EMV = 'EMV Data is required if authentication method is EMV.';
    ...
    {
        return [
            self::DESCRIPTION_EMV_DATA_IS_REQUIRED_IF_AUTHENTICATION_METHOD_IS_EMV,
        ];
    }
