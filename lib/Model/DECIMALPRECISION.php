...
/**
 * DECIMALPRECISION Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DECIMALPRECISION implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DECIMAL_PRECISION';
    ...
    public const ISSUE_DECIMAL_PRECISION = 'DECIMAL_PRECISION';
    public const DESCRIPTION_IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED = 'If the currency supports decimals, only two decimal place precision is supported.';
    ...
    {
        return [
            self::DESCRIPTION_IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED,
        ];
    }
