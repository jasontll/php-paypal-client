...
/**
 * PNREFNOTFOUND Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PNREFNOTFOUND implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PNREF_NOT_FOUND';
    ...
    public const ISSUE_PNREF_NOT_FOUND = 'PNREF_NOT_FOUND';
    public const DESCRIPTION_SPECIFIED_PNREF_WAS_NOT_FOUND__VERIFY_THE_VALUE_AND_TRY_THE_REQUEST_AGAIN = 'Specified `pnref` was not found. Verify the value and try the request again.';
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_PNREF_WAS_NOT_FOUND__VERIFY_THE_VALUE_AND_TRY_THE_REQUEST_AGAIN,
        ];
    }
