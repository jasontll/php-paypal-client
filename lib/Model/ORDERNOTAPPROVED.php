...
/**
 * ORDERNOTAPPROVED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERNOTAPPROVED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_NOT_APPROVED';
    ...
    public const DESCRIPTION_PAYER_HAS_NOT_YET_APPROVED_THE_ORDER_FOR_PAYMENT__PLEASE_REDIRECT_THE_PAYER_TO_THE_RELAPPROVE_URL_RETURNED_AS_PART_OF_THE_HATEOAS_LINKS_WITHIN_THE_CREATE_ORDER_CALL = 'Payer has not yet approved the Order for payment. Please redirect the payer to the 'rel':'approve' url returned as part of the HATEOAS links within the Create Order call.';
    ...
    {
        return [
            self::DESCRIPTION_PAYER_HAS_NOT_YET_APPROVED_THE_ORDER_FOR_PAYMENT__PLEASE_REDIRECT_THE_PAYER_TO_THE_RELAPPROVE_URL_RETURNED_AS_PART_OF_THE_HATEOAS_LINKS_WITHIN_THE_CREATE_ORDER_CALL,
        ];
    }
