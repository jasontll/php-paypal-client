...
/**
 * PAYPALTRANSACTIONIDEXPIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYPALTRANSACTIONIDEXPIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYPAL_TRANSACTION_ID_EXPIRED';
    ...
    public const ISSUE_PAYPAL_TRANSACTION_ID_EXPIRED = 'PAYPAL_TRANSACTION_ID_EXPIRED';
    public const DESCRIPTION_SPECIFIED_PAYPAL_TRANSACTION_ID_HAS_EXPIRED__PAY_PAL_TRANSACTION_ID_EXPIRES_4_YEARS_AFTER_THE_DATE_OF_THE_INITIAL_TRANSACTION = 'Specified `paypal_transaction_id` has expired. PayPal transaction ID expires 4 years after the date of the initial transaction.';
    ...
    {
        return [
            self::ISSUE_PAYPAL_TRANSACTION_ID_EXPIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_PAYPAL_TRANSACTION_ID_HAS_EXPIRED__PAY_PAL_TRANSACTION_ID_EXPIRES_4_YEARS_AFTER_THE_DATE_OF_THE_INITIAL_TRANSACTION,
        ];
    }
