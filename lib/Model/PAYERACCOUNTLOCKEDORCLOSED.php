...
/**
 * PAYERACCOUNTLOCKEDORCLOSED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYERACCOUNTLOCKEDORCLOSED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYER_ACCOUNT_LOCKED_OR_CLOSED';
    ...
    public const ISSUE_PAYER_ACCOUNT_LOCKED_OR_CLOSED = 'PAYER_ACCOUNT_LOCKED_OR_CLOSED';
    public const DESCRIPTION_THE_PAYER_ACCOUNT_CANNOT_BE_USED_FOR_THIS_TRANSACTION = 'The payer account cannot be used for this transaction.';
    ...
    {
        return [
            self::ISSUE_PAYER_ACCOUNT_LOCKED_OR_CLOSED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PAYER_ACCOUNT_CANNOT_BE_USED_FOR_THIS_TRANSACTION,
        ];
    }
