...
/**
 * PATCHVALUEREQUIRED1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PATCHVALUEREQUIRED1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PATCH_VALUE_REQUIRED_1';
    ...
    public const DESCRIPTION_SPECIFY_A_VALUE_FOR_THE_FIELD_BEING_PATCHED = 'Specify a `value` for the field being patched.';
    ...
    {
        return [
            self::DESCRIPTION_SPECIFY_A_VALUE_FOR_THE_FIELD_BEING_PATCHED,
        ];
    }
