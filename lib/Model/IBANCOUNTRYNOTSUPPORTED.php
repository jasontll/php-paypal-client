...
/**
 * IBANCOUNTRYNOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IBANCOUNTRYNOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IBAN_COUNTRY_NOT_SUPPORTED';
    ...
    public const ISSUE_IBAN_COUNTRY_NOT_SUPPORTED = 'IBAN_COUNTRY_NOT_SUPPORTED';
    public const DESCRIPTION_COUNTRY_CODE_OF_ISSUER_BANK_FOR_THE_PROVIDED_IBAN_IS_NOT_SUPPORTED_FOR_SEPA_DEBIT_PAYMENTS = 'Country code of issuer bank for the provided IBAN is not supported for SEPA debit payments.';
    ...
    {
        return [
            self::ISSUE_IBAN_COUNTRY_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_COUNTRY_CODE_OF_ISSUER_BANK_FOR_THE_PROVIDED_IBAN_IS_NOT_SUPPORTED_FOR_SEPA_DEBIT_PAYMENTS,
        ];
    }
