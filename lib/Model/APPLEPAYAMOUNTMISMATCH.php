...
/**
 * APPLEPAYAMOUNTMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class APPLEPAYAMOUNTMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'APPLE_PAY_AMOUNT_MISMATCH';
    ...
    public const ISSUE_APPLE_PAY_AMOUNT_MISMATCH = 'APPLE_PAY_AMOUNT_MISMATCH';
    public const DESCRIPTION_THE_AMOUNT_SPECIFIED_IN_THE_ORDER_SHOULD_MATCH_THE_AMOUNT_THAT_WAS_VIEWED_AND_AUTHORIZED_BY_THE_PAYER_BUYER_ON_APPLE_PAY__IF_THE_AMOUNT_HAS_CHANGED_PLEASE_REDIRECT_THE_BUYER_TO_AUTHORIZE_THE_ORDER_AGAIN_VIA_APPLE_PAY = 'The 'amount' specified in the Order should match the amount that was viewed and authorized by the payer/buyer on Apple Pay. If the amount has changed, please redirect the buyer to authorize the order again via Apple Pay.';
    ...
    {
        return [
            self::ISSUE_APPLE_PAY_AMOUNT_MISMATCH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_AMOUNT_SPECIFIED_IN_THE_ORDER_SHOULD_MATCH_THE_AMOUNT_THAT_WAS_VIEWED_AND_AUTHORIZED_BY_THE_PAYER_BUYER_ON_APPLE_PAY__IF_THE_AMOUNT_HAS_CHANGED_PLEASE_REDIRECT_THE_BUYER_TO_AUTHORIZE_THE_ORDER_AGAIN_VIA_APPLE_PAY,
        ];
    }
