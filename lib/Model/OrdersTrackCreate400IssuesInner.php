...
/**
 * OrdersTrackCreate400IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersTrackCreate400IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_track_create_400_issues_inner';
    ...
    public const ISSUE_INVALID_PARAMETER_SYNTAX = 'INVALID_PARAMETER_SYNTAX';
    public const DESCRIPTION_THE_VALUE_OF_A_FIELD_DOES_NOT_CONFORM_TO_THE_EXPECTED_FORMAT = 'The value of a field does not conform to the expected format.';
    ...
    {
        return [
            self::ISSUE_INVALID_PARAMETER_SYNTAX,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_VALUE_OF_A_FIELD_DOES_NOT_CONFORM_TO_THE_EXPECTED_FORMAT,
        ];
    }
