...
/**
 * PAYEEACCOUNTINVALID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEEACCOUNTINVALID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_ACCOUNT_INVALID';
    ...
    public const ISSUE_PAYEE_ACCOUNT_INVALID = 'PAYEE_ACCOUNT_INVALID';
    public const DESCRIPTION_PAYEE_ACCOUNT_SPECIFIED_IS_INVALID__PLEASE_CHECK_THE_PAYEE_EMAIL_ADDRESS_OR_PAYEE_MERCHANT_ID_SPECIFIED_AND_TRY_AGAIN__ENSURE_THAT_EITHER__PAYEE_MERCHANT_ID_OR_PAYEE_EMAIL_ADDRESS_IS_SPECIFIED = 'Payee account specified is invalid. Please check the `payee.email_address` or `payee.merchant_id` specified and try again. Ensure that either  `payee.merchant_id` or `payee.email_address` is specified.';
    ...
    {
        return [
            self::ISSUE_PAYEE_ACCOUNT_INVALID,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PAYEE_ACCOUNT_SPECIFIED_IS_INVALID__PLEASE_CHECK_THE_PAYEE_EMAIL_ADDRESS_OR_PAYEE_MERCHANT_ID_SPECIFIED_AND_TRY_AGAIN__ENSURE_THAT_EITHER__PAYEE_MERCHANT_ID_OR_PAYEE_EMAIL_ADDRESS_IS_SPECIFIED,
        ];
    }
