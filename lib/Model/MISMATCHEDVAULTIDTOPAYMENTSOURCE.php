...
/**
 * MISMATCHEDVAULTIDTOPAYMENTSOURCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MISMATCHEDVAULTIDTOPAYMENTSOURCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MISMATCHED_VAULT_ID_TO_PAYMENT_SOURCE';
    ...
    public const ISSUE_MISMATCHED_VAULT_ID_TO_PAYMENT_SOURCE = 'MISMATCHED_VAULT_ID_TO_PAYMENT_SOURCE';
    public const DESCRIPTION_THE_VAULT_ID_DOES_NOT_MATCH_THE_PAYMENT_SOURCE_PROVIDED__PLEASE_VERIFY_THAT_THE_VAULT_ID_TOKEN_USED_REFERS_TO_THE_MATCHING_PAYMENT_SOURCE_AND_TRY_AGAIN__FOR_EXAMPLE_A_PAY_PAL_TOKEN_CANNOT_BE_PASSED_IN_THE_VAULT_ID_FIELD_IN_THE_PAYMENT_SOURCE_CARD_OBJECT = 'The vault_id does not match the payment_source provided. Please verify that the vault_id token used refers to the matching payment_source and try again. For example, a PayPal token cannot be passed in the vault_id field in the payment_source.card object.';
    ...
    {
        return [
            self::ISSUE_MISMATCHED_VAULT_ID_TO_PAYMENT_SOURCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_VAULT_ID_DOES_NOT_MATCH_THE_PAYMENT_SOURCE_PROVIDED__PLEASE_VERIFY_THAT_THE_VAULT_ID_TOKEN_USED_REFERS_TO_THE_MATCHING_PAYMENT_SOURCE_AND_TRY_AGAIN__FOR_EXAMPLE_A_PAY_PAL_TOKEN_CANNOT_BE_PASSED_IN_THE_VAULT_ID_FIELD_IN_THE_PAYMENT_SOURCE_CARD_OBJECT,
        ];
    }
