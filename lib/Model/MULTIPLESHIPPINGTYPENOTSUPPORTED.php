...
/**
 * MULTIPLESHIPPINGTYPENOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MULTIPLESHIPPINGTYPENOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MULTIPLE_SHIPPING_TYPE_NOT_SUPPORTED';
    ...
    public const ISSUE_MULTIPLE_SHIPPING_TYPE_NOT_SUPPORTED = 'MULTIPLE_SHIPPING_TYPE_NOT_SUPPORTED';
    public const DESCRIPTION_DIFFERENT_SHIPPING_TYPE_ARE_NOT_SUPPORTED_ACROSS_PURCHASE_UNITS = 'Different `shipping.type` are not supported across purchase units.';
    ...
    {
        return [
            self::ISSUE_MULTIPLE_SHIPPING_TYPE_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_DIFFERENT_SHIPPING_TYPE_ARE_NOT_SUPPORTED_ACROSS_PURCHASE_UNITS,
        ];
    }
