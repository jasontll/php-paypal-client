...
/**
 * MAXNUMBEROFPAYMENTATTEMPTSEXCEEDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MAXNUMBEROFPAYMENTATTEMPTSEXCEEDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MAX_NUMBER_OF_PAYMENT_ATTEMPTS_EXCEEDED';
    ...
    public const ISSUE_MAX_NUMBER_OF_PAYMENT_ATTEMPTS_EXCEEDED = 'MAX_NUMBER_OF_PAYMENT_ATTEMPTS_EXCEEDED';
    public const DESCRIPTION_YOU_HAVE_EXCEEDED_THE_MAXIMUM_NUMBER_OF_PAYMENT_ATTEMPTS = 'You have exceeded the maximum number of payment attempts.';
    ...
    {
        return [
            self::ISSUE_MAX_NUMBER_OF_PAYMENT_ATTEMPTS_EXCEEDED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_YOU_HAVE_EXCEEDED_THE_MAXIMUM_NUMBER_OF_PAYMENT_ATTEMPTS,
        ];
    }
