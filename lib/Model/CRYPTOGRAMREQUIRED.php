...
/**
 * CRYPTOGRAMREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CRYPTOGRAMREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CRYPTOGRAM_REQUIRED';
    ...
    public const ISSUE_CRYPTOGRAM_REQUIRED = 'CRYPTOGRAM_REQUIRED';
    public const DESCRIPTION_CRYPTOGRAM_IS_REQUIRED_IF_AUTHENTICATION_METHOD_IS_CRYPTOGRAM_3_DS = 'Cryptogram is required if authentication method is CRYPTOGRAM 3DS.';
    ...
    {
        return [
            self::ISSUE_CRYPTOGRAM_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_CRYPTOGRAM_IS_REQUIRED_IF_AUTHENTICATION_METHOD_IS_CRYPTOGRAM_3_DS,
        ];
    }
