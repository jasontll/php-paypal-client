...
/**
 * PAYEEACCOUNTNOTVERIFIED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEEACCOUNTNOTVERIFIED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_ACCOUNT_NOT_VERIFIED';
    ...
    public const ISSUE_PAYEE_ACCOUNT_NOT_VERIFIED = 'PAYEE_ACCOUNT_NOT_VERIFIED';
    public const DESCRIPTION_PAYEE_HAS_NOT_VERIFIED_THEIR_ACCOUNT_WITH_PAY_PAL__THE_SELECTED_PAYMENT_METHOD_REQUIRES_THE_RECIPIENT_TO_HAVE_A_VERIFIED_PAY_PAL_ACCOUNT_BEFORE_TRANSACTIONS_CAN_BE_PROCESSED_ON_THEIR_BEHALF = 'Payee has not verified their account with PayPal. The selected payment method requires the recipient to have a verified PayPal account before transactions can be processed on their behalf.';
    ...
    {
        return [
            self::ISSUE_PAYEE_ACCOUNT_NOT_VERIFIED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PAYEE_HAS_NOT_VERIFIED_THEIR_ACCOUNT_WITH_PAY_PAL__THE_SELECTED_PAYMENT_METHOD_REQUIRES_THE_RECIPIENT_TO_HAVE_A_VERIFIED_PAY_PAL_ACCOUNT_BEFORE_TRANSACTIONS_CAN_BE_PROCESSED_ON_THEIR_BEHALF,
        ];
    }
