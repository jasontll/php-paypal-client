...
/**
 * PATCHPATHREQUIRED1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PATCHPATHREQUIRED1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PATCH_PATH_REQUIRED_1';
    ...
    public const DESCRIPTION_SPECIFY_A_VALUE_FOR_THE_FIELD_IN_WHICH_THE_OPERATION_NEEDS_TO_BE_PERFORMED = 'Specify a `value` for the field in which the operation needs to be performed.';
    ...
    {
        return [
            self::DESCRIPTION_SPECIFY_A_VALUE_FOR_THE_FIELD_IN_WHICH_THE_OPERATION_NEEDS_TO_BE_PERFORMED,
        ];
    }
