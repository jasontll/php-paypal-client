...
/**
 * PAYEEFXRATEIDCURRENCYMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEEFXRATEIDCURRENCYMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_FX_RATE_ID_CURRENCY_MISMATCH';
    ...
    public const ISSUE_PAYEE_FX_RATE_ID_CURRENCY_MISMATCH = 'PAYEE_FX_RATE_ID_CURRENCY_MISMATCH';
    public const DESCRIPTION_THE_SPECIFIED_FX_RATE_ID_IS_FOR_A_CURRENCY_THAT_DOES_NOT_MATCH_WITH_THE_CURRENCY_OF_THIS_REQUEST__PLEASE_SPECIFY_A_DIFFERENT_FX_RATE_ID_AND_TRY_THE_REQUEST_AGAIN__ALTERNATELY_REMOVE_THE_FX_RATE_ID_TO_PROCESS_THE_REQUEST_USING_THE_DEFAULT_EXCHANGE_RATE = 'The specified FX Rate ID is for a currency that does not match with the currency of this request. Please specify a different FX Rate ID and try the request again. Alternately, remove the FX Rate ID to process the request using the default exchange rate.';
    ...
    {
        return [
            self::ISSUE_PAYEE_FX_RATE_ID_CURRENCY_MISMATCH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_SPECIFIED_FX_RATE_ID_IS_FOR_A_CURRENCY_THAT_DOES_NOT_MATCH_WITH_THE_CURRENCY_OF_THIS_REQUEST__PLEASE_SPECIFY_A_DIFFERENT_FX_RATE_ID_AND_TRY_THE_REQUEST_AGAIN__ALTERNATELY_REMOVE_THE_FX_RATE_ID_TO_PROCESS_THE_REQUEST_USING_THE_DEFAULT_EXCHANGE_RATE,
        ];
    }
