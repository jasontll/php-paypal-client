...
/**
 * PAYEENOTENABLEDFORBANKPROCESSING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEENOTENABLEDFORBANKPROCESSING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_NOT_ENABLED_FOR_BANK_PROCESSING';
    ...
    public const ISSUE_PAYEE_NOT_ENABLED_FOR_BANK_PROCESSING = 'PAYEE_NOT_ENABLED_FOR_BANK_PROCESSING';
    public const DESCRIPTION_PAYEE_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_BANK_PAYMENTS__PLEASE_CONTACT_YOUR_PAY_PAL_ACCOUNT_MANAGER = 'Payee account is not setup to be able to process bank payments. Please contact your PayPal account manager.';
    ...
    {
        return [
            self::ISSUE_PAYEE_NOT_ENABLED_FOR_BANK_PROCESSING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PAYEE_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_BANK_PAYMENTS__PLEASE_CONTACT_YOUR_PAY_PAL_ACCOUNT_MANAGER,
        ];
    }
