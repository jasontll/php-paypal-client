...
/**
 * ONLYONEPAYMENTSOURCEALLOWED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ONLYONEPAYMENTSOURCEALLOWED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ONLY_ONE_PAYMENT_SOURCE_ALLOWED';
    ...
    public const ISSUE_ONLY_ONE_PAYMENT_SOURCE_ALLOWED = 'ONLY_ONE_PAYMENT_SOURCE_ALLOWED';
    public const DESCRIPTION_MORE_THAN_ONE_PAYMENT_METHOD_WITHIN_THE_PAYMENT_SOURCE_IS_NOT_SUPPORTED = 'More than one payment method within the payment source is not supported.';
    ...
    {
        return [
            self::ISSUE_ONLY_ONE_PAYMENT_SOURCE_ALLOWED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_MORE_THAN_ONE_PAYMENT_METHOD_WITHIN_THE_PAYMENT_SOURCE_IS_NOT_SUPPORTED,
        ];
    }
