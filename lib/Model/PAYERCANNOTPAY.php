...
/**
 * PAYERCANNOTPAY Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYERCANNOTPAY implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYER_CANNOT_PAY';
    ...
    public const DESCRIPTION_COMBINATION_OF_PAYER_AND_PAYEE_SETTINGS_MEAN_THAT_THIS_BUYER_CANNOT_PAY_THIS_SELLER = 'Combination of payer and payee settings mean that this buyer cannot pay this seller.';
    ...
    {
        return [
            self::DESCRIPTION_COMBINATION_OF_PAYER_AND_PAYEE_SETTINGS_MEAN_THAT_THIS_BUYER_CANNOT_PAY_THIS_SELLER,
        ];
    }
