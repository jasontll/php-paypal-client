...
/**
 * BILLINGAGREEMENTIDMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BILLINGAGREEMENTIDMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BILLING_AGREEMENT_ID_MISMATCH';
    ...
    public const ISSUE_BILLING_AGREEMENT_ID_MISMATCH = 'BILLING_AGREEMENT_ID_MISMATCH';
    public const DESCRIPTION_BILLING_AGREEMENT_ID_MUST_EXACTLY_MATCH_THE_BILLING_AGREEMENT_ID_THAT_WAS_PROVIDED_DURING_ORDER_CREATION = 'Billing Agreement ID must exactly match the Billing Agreement ID that was provided during order creation.';
    ...
    {
        return [
            self::ISSUE_BILLING_AGREEMENT_ID_MISMATCH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_BILLING_AGREEMENT_ID_MUST_EXACTLY_MATCH_THE_BILLING_AGREEMENT_ID_THAT_WAS_PROVIDED_DURING_ORDER_CREATION,
        ];
    }
