...
/**
 * UNSUPPORTEDPAYMENTINSTRUCTION Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UNSUPPORTEDPAYMENTINSTRUCTION implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNSUPPORTED_PAYMENT_INSTRUCTION';
    ...
    public const ISSUE_UNSUPPORTED_PAYMENT_INSTRUCTION = 'UNSUPPORTED_PAYMENT_INSTRUCTION';
    public const DESCRIPTION_YOU_MUST_PROVIDE_THE_PAYMENT_INSTRUCTION_WHEN_YOU_CAPTURE_AN_AUTHORIZED_PAYMENT_FOR_INTENTAUTHORIZE__FOR_DETAILS_SEE_A_HREF_DOCS_API_PAYMENTS_V2_AUTHORIZATIONS_CAPTURECAPTURE_AUTHORIZATION_A__FOR_INTENTCAPTURE_SEND_THE_PAYMENT_INSTRUCTION_WHEN_YOU_CREATE_THE_ORDER = 'You must provide the payment instruction when you capture an authorized payment for `intent=AUTHORIZE`. For details, see <a href=\"/docs/api/payments/v2/#authorizations_capture\">Capture authorization</a>. For `intent=CAPTURE`, send the payment instruction when you create the order.';
    ...
    {
        return [
            self::ISSUE_UNSUPPORTED_PAYMENT_INSTRUCTION,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_YOU_MUST_PROVIDE_THE_PAYMENT_INSTRUCTION_WHEN_YOU_CAPTURE_AN_AUTHORIZED_PAYMENT_FOR_INTENTAUTHORIZE__FOR_DETAILS_SEE_A_HREF_DOCS_API_PAYMENTS_V2_AUTHORIZATIONS_CAPTURECAPTURE_AUTHORIZATION_A__FOR_INTENTCAPTURE_SEND_THE_PAYMENT_INSTRUCTION_WHEN_YOU_CREATE_THE_ORDER,
        ];
    }
