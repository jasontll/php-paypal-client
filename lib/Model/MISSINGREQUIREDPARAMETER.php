...
/**
 * MISSINGREQUIREDPARAMETER Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MISSINGREQUIREDPARAMETER implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MISSING_REQUIRED_PARAMETER';
    ...
    public const DESCRIPTION_A_REQUIRED_PARAMETER_IS_MISSING = 'A required parameter is missing.';
    ...
    {
        return [
            self::DESCRIPTION_A_REQUIRED_PARAMETER_IS_MISSING,
        ];
    }
