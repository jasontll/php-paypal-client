...
/**
 * INVALIDCURRENCYCODE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDCURRENCYCODE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_CURRENCY_CODE';
    ...
    public const ISSUE_INVALID_CURRENCY_CODE = 'INVALID_CURRENCY_CODE';
    public const DESCRIPTION_CURRENCY_CODE_IS_INVALID_OR_IS_NOT_CURRENTLY_SUPPORTED__PLEASE_REFER_HTTPS__DEVELOPER_PAYPAL_COM_API_REST_REFERENCE_CURRENCY_CODES__FOR_LIST_OF_SUPPORTED_CURRENCY_CODES = 'Currency code is invalid or is not currently supported. Please refer https://developer.paypal.com/api/rest/reference/currency-codes/ for list of supported currency codes.';
    ...
    {
        return [
            self::ISSUE_INVALID_CURRENCY_CODE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_CURRENCY_CODE_IS_INVALID_OR_IS_NOT_CURRENTLY_SUPPORTED__PLEASE_REFER_HTTPS__DEVELOPER_PAYPAL_COM_API_REST_REFERENCE_CURRENCY_CODES__FOR_LIST_OF_SUPPORTED_CURRENCY_CODES,
        ];
    }
