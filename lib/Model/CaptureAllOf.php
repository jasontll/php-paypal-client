...
/**
 * CaptureAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CaptureAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'capture_allOf';
    ...
    */
    ...
    public function setCustomId($custom_id)
    {
        ...
        if ((mb_strlen($custom_id) > 127)) {
            throw new \InvalidArgumentException('invalid length for $custom_id when calling CaptureAllOf., must be smaller than or equal to 127.');
        }
