...
/**
 * BlikOneClickResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class BlikOneClickResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blik_one_click_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['consumer_reference']) && (mb_strlen($this->container['consumer_reference']) > 64)) {
            $invalidProperties[] = "invalid value for 'consumer_reference', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['consumer_reference']) && (mb_strlen($this->container['consumer_reference']) < 3)) {
            $invalidProperties[] = "invalid value for 'consumer_reference', the character length must be bigger than or equal to 3.";
        }

        if (!is_null($this->container['consumer_reference']) && !preg_match("/^[ -~]{3,64}$/", $this->container['consumer_reference'])) {
    ...
    public function setConsumerReference($consumer_reference)
    {
        ...
        if ((mb_strlen($consumer_reference) > 64)) {
            throw new \InvalidArgumentException('invalid length for $consumer_reference when calling BlikOneClickResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($consumer_reference) < 3)) {
            throw new \InvalidArgumentException('invalid length for $consumer_reference when calling BlikOneClickResponse., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[ -~]{3,64}$/", $consumer_reference))) {
            throw new \InvalidArgumentException("invalid value for \$consumer_reference when calling BlikOneClickResponse., must conform to the pattern /^[ -~]{3,64}$/.");
        }
