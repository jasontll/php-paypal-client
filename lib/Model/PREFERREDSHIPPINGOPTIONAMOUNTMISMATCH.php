...
/**
 * PREFERREDSHIPPINGOPTIONAMOUNTMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PREFERREDSHIPPINGOPTIONAMOUNTMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PREFERRED_SHIPPING_OPTION_AMOUNT_MISMATCH';
    ...
    public const ISSUE_PREFERRED_SHIPPING_OPTION_AMOUNT_MISMATCH = 'PREFERRED_SHIPPING_OPTION_AMOUNT_MISMATCH';
    public const DESCRIPTION_THE_AMOUNT_PROVIDED_IN_THE_PREFERRED_SHIPPING_OPTION_SHOULD_MATCH_THE_AMOUNT_PROVIDED_IN_AMOUNT_BREAKDOWN = 'The amount provided in the preferred shipping option should match the amount provided in amount breakdown';
    ...
    {
        return [
            self::ISSUE_PREFERRED_SHIPPING_OPTION_AMOUNT_MISMATCH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_AMOUNT_PROVIDED_IN_THE_PREFERRED_SHIPPING_OPTION_SHOULD_MATCH_THE_AMOUNT_PROVIDED_IN_AMOUNT_BREAKDOWN,
        ];
    }
