...
/**
 * INVALIDSTRINGLENGTH1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDSTRINGLENGTH1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_STRING_LENGTH_1';
    ...
    public const ISSUE_INVALID_STRING_LENGTH = 'INVALID_STRING_LENGTH';
    public const DESCRIPTION_THE_VALUE_OF_A_FIELD_IS_EITHER_TOO_SHORT_OR_TOO_LONG = 'The value of a field is either too short or too long.';
    ...
    {
        return [
            self::ISSUE_INVALID_STRING_LENGTH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_VALUE_OF_A_FIELD_IS_EITHER_TOO_SHORT_OR_TOO_LONG,
        ];
    }
