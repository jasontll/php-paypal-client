...
/**
 * PAYMENTSOURCEINFOCANNOTBEVERIFIED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYMENTSOURCEINFOCANNOTBEVERIFIED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYMENT_SOURCE_INFO_CANNOT_BE_VERIFIED';
    ...
    public const ISSUE_PAYMENT_SOURCE_INFO_CANNOT_BE_VERIFIED = 'PAYMENT_SOURCE_INFO_CANNOT_BE_VERIFIED';
    public const DESCRIPTION_THE_COMBINATION_OF_THE_PAYMENT_SOURCE_NAME_BILLING_ADDRESS_SHIPPING_NAME_AND_SHIPPING_ADDRESS_COULD_NOT_BE_VERIFIED__PLEASE_CORRECT_THIS_INFORMATION_AND_TRY_AGAIN_BY_CREATING_A_NEW_ORDER = 'The combination of the payment_source name, billing address, shipping name and shipping address could not be verified. Please correct this information and try again by creating a new order.';
    ...
    {
        return [
            self::ISSUE_PAYMENT_SOURCE_INFO_CANNOT_BE_VERIFIED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_COMBINATION_OF_THE_PAYMENT_SOURCE_NAME_BILLING_ADDRESS_SHIPPING_NAME_AND_SHIPPING_ADDRESS_COULD_NOT_BE_VERIFIED__PLEASE_CORRECT_THIS_INFORMATION_AND_TRY_AGAIN_BY_CREATING_A_NEW_ORDER,
        ];
    }
