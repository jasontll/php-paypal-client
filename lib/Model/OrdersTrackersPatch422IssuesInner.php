...
/**
 * OrdersTrackersPatch422IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersTrackersPatch422IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_trackers_patch_422_issues_inner';
    ...
    public const ISSUE_ITEM_SKU_MISMATCH = 'ITEM_SKU_MISMATCH';
    public const DESCRIPTION_ITEM_SKU_MUST_MATCH_ONE_OF_THE_ITEMS_SKU_THAT_WAS_PROVIDED_DURING_ORDER_CREATION = 'Item sku must match one of the items sku that was provided during order creation.';
    ...
    {
        return [
            self::DESCRIPTION_ITEM_SKU_MUST_MATCH_ONE_OF_THE_ITEMS_SKU_THAT_WAS_PROVIDED_DURING_ORDER_CREATION,
        ];
    }
