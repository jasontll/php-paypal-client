...
/**
 * CANNOTBEZEROORNEGATIVE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CANNOTBEZEROORNEGATIVE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CANNOT_BE_ZERO_OR_NEGATIVE';
    ...
    public const ISSUE_CANNOT_BE_ZERO_OR_NEGATIVE = 'CANNOT_BE_ZERO_OR_NEGATIVE';
    public const DESCRIPTION_MUST_BE_GREATER_THAN_ZERO__IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED = 'Must be greater than zero. If the currency supports decimals, only two decimal place precision is supported.';
    ...
    {
        return [
            self::ISSUE_CANNOT_BE_ZERO_OR_NEGATIVE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_MUST_BE_GREATER_THAN_ZERO__IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED,
        ];
    }
