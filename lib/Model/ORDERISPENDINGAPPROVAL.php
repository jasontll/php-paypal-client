...
/**
 * ORDERISPENDINGAPPROVAL Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERISPENDINGAPPROVAL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_IS_PENDING_APPROVAL';
    ...
    public const ISSUE_ORDER_IS_PENDING_APPROVAL = 'ORDER_IS_PENDING_APPROVAL';
    public const DESCRIPTION_THE_ORDER_WAS_CONFIRMED_AND_PAYER_ACTION_COMPLETED_BUT_ORDER_APPROVAL_PROCESSING_FROM_PAY_PAL_IS_PENDING__NO_ACTION_IS_NEEDED_FROM_PAYEE_OR_PAYER__PLEASE_WAIT_UNTIL_ORDER_STATUS_CHANGES_TO_APPROVED = 'The order was confirmed and payer action completed but order approval processing from PayPal is pending. No action is needed from Payee or Payer. Please wait until order status changes to 'APPROVED'.';
    ...
    {
        return [
            self::ISSUE_ORDER_IS_PENDING_APPROVAL,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_ORDER_WAS_CONFIRMED_AND_PAYER_ACTION_COMPLETED_BUT_ORDER_APPROVAL_PROCESSING_FROM_PAY_PAL_IS_PENDING__NO_ACTION_IS_NEEDED_FROM_PAYEE_OR_PAYER__PLEASE_WAIT_UNTIL_ORDER_STATUS_CHANGES_TO_APPROVED,
        ];
    }
