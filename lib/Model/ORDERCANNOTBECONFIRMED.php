...
/**
 * ORDERCANNOTBECONFIRMED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERCANNOTBECONFIRMED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_CANNOT_BE_CONFIRMED';
    ...
    public const ISSUE_ORDER_CANNOT_BE_CONFIRMED = 'ORDER_CANNOT_BE_CONFIRMED';
    public const DESCRIPTION_AN_ORDER_WITH_STATUS__COMPLETED_CANNOT_BE_CONFIRMED_AGAIN = 'An order with status = 'COMPLETED' cannot be confirmed again.';
    ...
    {
        return [
            self::ISSUE_ORDER_CANNOT_BE_CONFIRMED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_AN_ORDER_WITH_STATUS__COMPLETED_CANNOT_BE_CONFIRMED_AGAIN,
        ];
    }
