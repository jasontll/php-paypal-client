...
/**
 * REFERENCEIDNOTFOUND Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class REFERENCEIDNOTFOUND implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'REFERENCE_ID_NOT_FOUND';
    ...
    public const ISSUE_REFERENCE_ID_NOT_FOUND = 'REFERENCE_ID_NOT_FOUND';
    public const DESCRIPTION_FILTER_EXPRESSION_VALUE_IS_INCORRECT__PLEASE_CHECK_THE_VALUE_OF_THE_REFERENCE_ID_AND_TRY_AGAIN = 'Filter expression value is incorrect. Please check the value of the reference_id and try again.';
    ...
    {
        return [
            self::ISSUE_REFERENCE_ID_NOT_FOUND,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_FILTER_EXPRESSION_VALUE_IS_INCORRECT__PLEASE_CHECK_THE_VALUE_OF_THE_REFERENCE_ID_AND_TRY_AGAIN,
        ];
    }
