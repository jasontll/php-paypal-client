...
/**
 * VenmoWalletResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class VenmoWalletResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'venmo_wallet_response';
    ...
    protected static $openAPITypes = [
        ...
        'attributes' => '\OpenAPI\Client\Model\VenmoWalletAttributesResponse'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['user_name']) && (mb_strlen($this->container['user_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'user_name', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['user_name']) && !preg_match("/^[-a-zA-Z0-9_]*$/", $this->container['user_name'])) {
            $invalidProperties[] = "invalid value for 'user_name', must be conform to the pattern /^[-a-zA-Z0-9_]*$/.";
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling VenmoWalletResponse., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($email_address) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling VenmoWalletResponse., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/(?:[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\\.[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+)*|(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21\\x23-\\x5b\\x5d-\\x7f]|\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])*\")@(?:(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?|\\[(?:(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9]))\\.){3}(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9])|[a-zA-Z0-9-]*[a-zA-Z0-9]:(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21-\\x5a\\x53-\\x7f]|\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])+)\\])/", $email_address))) {
            throw new \InvalidArgumentException("invalid value for \$email_address when calling VenmoWalletResponse., must conform to the pattern /(?:[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\\.[a-zA-Z0-9!#$%&'*+\/=?^_`{|}~-]+)*|(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21\\x23-\\x5b\\x5d-\\x7f]|\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])*\")@(?:(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?|\\[(?:(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9]))\\.){3}(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9])|[a-zA-Z0-9-]*[a-zA-Z0-9]:(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21-\\x5a\\x53-\\x7f]|\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])+)\\])/.");
        }
    ...
    public function setAccountId($account_id)
    {
        ...
        if ((mb_strlen($account_id) > 13)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling VenmoWalletResponse., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($account_id) < 13)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling VenmoWalletResponse., must be bigger than or equal to 13.');
        }
        if ((!preg_match("/^[2-9A-HJ-NP-Z]{13}$/", $account_id))) {
            throw new \InvalidArgumentException("invalid value for \$account_id when calling VenmoWalletResponse., must conform to the pattern /^[2-9A-HJ-NP-Z]{13}$/.");
        }
    ...
    public function setUserName($user_name)
    {
        ...
        if ((mb_strlen($user_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling VenmoWalletResponse., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling VenmoWalletResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]*$/", $user_name))) {
            throw new \InvalidArgumentException("invalid value for \$user_name when calling VenmoWalletResponse., must conform to the pattern /^[-a-zA-Z0-9_]*$/.");
        }
     ...
     * Gets attributes
     *
     * @return \OpenAPI\Client\Model\VenmoWalletAttributesResponse|null
     */
     ...
     * Sets attributes
     *
     * @param \OpenAPI\Client\Model\VenmoWalletAttributesResponse|null $attributes attributes
     *
     * @return self
     */
