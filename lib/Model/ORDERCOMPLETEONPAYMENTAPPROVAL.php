...
/**
 * ORDERCOMPLETEONPAYMENTAPPROVAL Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERCOMPLETEONPAYMENTAPPROVAL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_COMPLETE_ON_PAYMENT_APPROVAL';
    ...
    public const ISSUE_ORDER_COMPLETE_ON_PAYMENT_APPROVAL = 'ORDER_COMPLETE_ON_PAYMENT_APPROVAL';
    public const DESCRIPTION_A_PROCESSING_INSTRUCTION_OF_ORDER_COMPLETE_ON_PAYMENT_APPROVAL_IS_REQUIRED_FOR_THE_SPECIFIED_PAYMENT_SOURCE__PLEASE_REFER_TO_THE_INTEGRATION_GUIDE_HTTPS__DEVELOPER_PAYPAL_COM_DOCS_LIMITED_RELEASE_ALTERNATIVE_PAYMENT_METHODS_WITH_ORDERS__FOR_MORE_DETAILS = 'A processing_instruction of `ORDER_COMPLETE_ON_PAYMENT_APPROVAL` is required for the specified payment_source. Please refer to the integration guide https://developer.paypal.com/docs/limited-release/alternative-payment-methods-with-orders/ for more details';
    ...
    {
        return [
            self::ISSUE_ORDER_COMPLETE_ON_PAYMENT_APPROVAL,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_A_PROCESSING_INSTRUCTION_OF_ORDER_COMPLETE_ON_PAYMENT_APPROVAL_IS_REQUIRED_FOR_THE_SPECIFIED_PAYMENT_SOURCE__PLEASE_REFER_TO_THE_INTEGRATION_GUIDE_HTTPS__DEVELOPER_PAYPAL_COM_DOCS_LIMITED_RELEASE_ALTERNATIVE_PAYMENT_METHODS_WITH_ORDERS__FOR_MORE_DETAILS,
        ];
    }
