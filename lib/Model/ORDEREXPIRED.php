...
/**
 * ORDEREXPIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDEREXPIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_EXPIRED';
    ...
    public const ISSUE_ORDER_EXPIRED = 'ORDER_EXPIRED';
    public const DESCRIPTION_ORDER_IS_EXPIRED_AND_HENCE_CANNOT_BE_AUTHORIZED__PLEASE_CONTACT_CUSTOMER_SUPPORT_IF_YOU_NEED_TO_INCREASE_YOUR_ORDER_VALIDITY_PERIOD = 'Order is expired and hence cannot be authorized. Please contact Customer Support if you need to increase your order validity period.';
    ...
    {
        return [
            self::DESCRIPTION_ORDER_IS_EXPIRED_AND_HENCE_CANNOT_BE_AUTHORIZED__PLEASE_CONTACT_CUSTOMER_SUPPORT_IF_YOU_NEED_TO_INCREASE_YOUR_ORDER_VALIDITY_PERIOD,
        ];
    }
