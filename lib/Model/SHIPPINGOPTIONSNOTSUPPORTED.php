...
/**
 * SHIPPINGOPTIONSNOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SHIPPINGOPTIONSNOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SHIPPING_OPTIONS_NOT_SUPPORTED';
    ...
    public const DESCRIPTION_SHIPPING_OPTIONS_ARE_NOT_SUPPORTED_WHEN_SHIPPING_TYPE_IS_SPECIFIED_OR_WHEN_APPLICATION_CONTEXT_SHIPPING_PREFERENCE_IS_SET_AS_NO_SHIPPING_OR_SET_PROVIDED_ADDRESS = 'Shipping options are not supported when `shipping.type` is specified or when 'application_context.shipping_preference' is set as 'NO_SHIPPING' or 'SET_PROVIDED_ADDRESS'.';
    ...
    {
        return [
            self::DESCRIPTION_SHIPPING_OPTIONS_ARE_NOT_SUPPORTED_WHEN_SHIPPING_TYPE_IS_SPECIFIED_OR_WHEN_APPLICATION_CONTEXT_SHIPPING_PREFERENCE_IS_SET_AS_NO_SHIPPING_OR_SET_PROVIDED_ADDRESS,
        ];
    }
