...
/**
 * CURRENCYNOTSUPPORTEDFORCARDTYPE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CURRENCYNOTSUPPORTEDFORCARDTYPE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURRENCY_NOT_SUPPORTED_FOR_CARD_TYPE';
    ...
    public const ISSUE_CURRENCY_NOT_SUPPORTED_FOR_CARD_TYPE = 'CURRENCY_NOT_SUPPORTED_FOR_CARD_TYPE';
    public const DESCRIPTION_THE_ISSUED_CURRENCY_CODE_OF_THIS_CARD_IS_NOT_SUPPORTED_FOR_DIRECT_CARD_PAYMENTS__PLEASE_REFER_HTTPS__DEVELOPER_PAYPAL_COM_API_REST_REFERENCE_CURRENCY_CODES__FOR_LIST_OF_SUPPORTED_CURRENCY_CODES = 'The issued currency code of this card is not supported for direct card payments. Please refer https://developer.paypal.com/api/rest/reference/currency-codes/ for list of supported currency codes.';
    ...
    {
        return [
            self::ISSUE_CURRENCY_NOT_SUPPORTED_FOR_CARD_TYPE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_ISSUED_CURRENCY_CODE_OF_THIS_CARD_IS_NOT_SUPPORTED_FOR_DIRECT_CARD_PAYMENTS__PLEASE_REFER_HTTPS__DEVELOPER_PAYPAL_COM_API_REST_REFERENCE_CURRENCY_CODES__FOR_LIST_OF_SUPPORTED_CURRENCY_CODES,
        ];
    }
