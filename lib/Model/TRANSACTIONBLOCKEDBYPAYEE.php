...
/**
 * TRANSACTIONBLOCKEDBYPAYEE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TRANSACTIONBLOCKEDBYPAYEE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TRANSACTION_BLOCKED_BY_PAYEE';
    ...
    public const ISSUE_TRANSACTION_BLOCKED_BY_PAYEE = 'TRANSACTION_BLOCKED_BY_PAYEE';
    public const DESCRIPTION_TRANSACTION_BLOCKED_BY_PAYEES_FRAUD_PROTECTION_SETTINGS = 'Transaction blocked by Payee’s Fraud Protection settings.';
    ...
    {
        return [
            self::ISSUE_TRANSACTION_BLOCKED_BY_PAYEE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_TRANSACTION_BLOCKED_BY_PAYEES_FRAUD_PROTECTION_SETTINGS,
        ];
    }
