...
/**
 * OrdersTrackersPatch404IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersTrackersPatch404IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_trackers_patch_404_issues_inner';
    ...
    public const ISSUE_TRACKER_ID_NOT_FOUND = 'TRACKER_ID_NOT_FOUND';
    public const DESCRIPTION_SPECIFIED_TRACKER_ID_DOES_NOT_EXIST__CHECK_THE_TRACKER_ID_AND_TRY_AGAIN = 'Specified tracker ID does not exist. Check the tracker ID and try again.';
    ...
    {
        return [
            self::ISSUE_TRACKER_ID_NOT_FOUND,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_TRACKER_ID_DOES_NOT_EXIST__CHECK_THE_TRACKER_ID_AND_TRY_AGAIN,
        ];
    }
