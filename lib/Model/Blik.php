...
class Blik implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'country_code' => 'string',
        'email' => 'string',
        'one_click' => '\OpenAPI\Client\Model\BlikOneClickResponse'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 300)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Blik., must be smaller than or equal to 300.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Blik., must be bigger than or equal to 3.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Blik., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Blik., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^([A-Z]{2}|C2)$/", $country_code))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling Blik., must conform to the pattern /^([A-Z]{2}|C2)$/.");
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Blik., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Blik., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^.+@[^\"\\-].+$/", $email))) {
            throw new \InvalidArgumentException("invalid value for \$email when calling Blik., must conform to the pattern /^.+@[^\"\\-].+$/.");
        }
     ...
     * Gets one_click
     *
     * @return \OpenAPI\Client\Model\BlikOneClickResponse|null
     */
     ...
     * Sets one_click
     *
     * @param \OpenAPI\Client\Model\BlikOneClickResponse|null $one_click one_click
     *
     * @return self
     */
