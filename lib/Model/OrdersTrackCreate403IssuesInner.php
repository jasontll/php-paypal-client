...
/**
 * OrdersTrackCreate403IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersTrackCreate403IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_track_create_403_issues_inner';
    ...
    public const ISSUE_PERMISSION_DENIED = 'PERMISSION_DENIED';
    public const DESCRIPTION_YOU_DO_NOT_HAVE_PERMISSION_TO_ACCESS_OR_PERFORM_OPERATIONS_ON_THIS_RESOURCE = 'You do not have permission to access or perform operations on this resource.';
    ...
    {
        return [
            self::DESCRIPTION_YOU_DO_NOT_HAVE_PERMISSION_TO_ACCESS_OR_PERFORM_OPERATIONS_ON_THIS_RESOURCE,
        ];
    }
