...
/**
 * PLATFORMFEEPAYEECANNOTBESAMEASPAYER Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PLATFORMFEEPAYEECANNOTBESAMEASPAYER implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PLATFORM_FEE_PAYEE_CANNOT_BE_SAME_AS_PAYER';
    ...
    public const ISSUE_PLATFORM_FEE_PAYEE_CANNOT_BE_SAME_AS_PAYER = 'PLATFORM_FEE_PAYEE_CANNOT_BE_SAME_AS_PAYER';
    public const DESCRIPTION_THE_PAYER_CANNOT_PAY_THEMSELVES__THE_RECIPIENT_ACCOUNT_OF_THE_PLATFORM_FEES_MUST_BE_DIFFERENT_FROM_THE_PAYER_ACCOUNT = 'The payer cannot pay themselves. The recipient account of the platform fees must be different from the payer account.';
    ...
    {
        return [
            self::ISSUE_PLATFORM_FEE_PAYEE_CANNOT_BE_SAME_AS_PAYER,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PAYER_CANNOT_PAY_THEMSELVES__THE_RECIPIENT_ACCOUNT_OF_THE_PLATFORM_FEES_MUST_BE_DIFFERENT_FROM_THE_PAYER_ACCOUNT,
        ];
    }
