...
/**
 * INVALIDJSONPOINTERFORMAT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDJSONPOINTERFORMAT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_JSON_POINTER_FORMAT';
    ...
    public const DESCRIPTION_PATH_SHOULD_BE_A_VALID_JSON_POINTER_HTTPS__TOOLS_IETF_ORG_HTML_RFC6901_THAT_REFERENCES_A_LOCATION_WITHIN_THE_REQUEST_WHERE_THE_OPERATION_IS_PERFORMED = 'Path should be a valid JSON Pointer https://tools.ietf.org/html/rfc6901 that references a location within the request where the operation is performed.';
    ...
    {
        return [
            self::DESCRIPTION_PATH_SHOULD_BE_A_VALID_JSON_POINTER_HTTPS__TOOLS_IETF_ORG_HTML_RFC6901_THAT_REFERENCES_A_LOCATION_WITHIN_THE_REQUEST_WHERE_THE_OPERATION_IS_PERFORMED,
        ];
    }
