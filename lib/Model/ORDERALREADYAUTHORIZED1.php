...
/**
 * ORDERALREADYAUTHORIZED1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ORDERALREADYAUTHORIZED1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ORDER_ALREADY_AUTHORIZED_1';
    ...
    public const ISSUE_ORDER_ALREADY_AUTHORIZED = 'ORDER_ALREADY_AUTHORIZED';
    public const DESCRIPTION_ORDER_ALREADY_AUTHORIZED_IF_INTENTAUTHORIZE_ONLY_ONE_AUTHORIZATION_PER_ORDER_IS_ALLOWED = 'Order already authorized.If 'intent=AUTHORIZE' only one authorization per order is allowed.';
    ...
    {
        return [
            self::ISSUE_ORDER_ALREADY_AUTHORIZED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_ORDER_ALREADY_AUTHORIZED_IF_INTENTAUTHORIZE_ONLY_ONE_AUTHORIZATION_PER_ORDER_IS_ALLOWED,
        ];
    }
