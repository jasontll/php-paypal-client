...
/**
 * FIELDNOTPATCHABLE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FIELDNOTPATCHABLE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FIELD_NOT_PATCHABLE';
    ...
    public const ISSUE_FIELD_NOT_PATCHABLE = 'FIELD_NOT_PATCHABLE';
    public const DESCRIPTION_FIELD_CANNOT_BE_PATCHED = 'Field cannot be patched.';
    ...
    {
        return [
            self::ISSUE_FIELD_NOT_PATCHABLE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_FIELD_CANNOT_BE_PATCHED,
        ];
    }
