...
/**
 * BANKNOTSUPPORTEDFORVERIFICATION Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BANKNOTSUPPORTEDFORVERIFICATION implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BANK_NOT_SUPPORTED_FOR_VERIFICATION';
    ...
    public const ISSUE_BANK_NOT_SUPPORTED_FOR_VERIFICATION = 'BANK_NOT_SUPPORTED_FOR_VERIFICATION';
    public const DESCRIPTION_VERIFICATION_FOR_THIS_BANK_ACCOUNT_IS_NOT_SUPPORTED = 'Verification for this bank account is not supported.';
    ...
    {
        return [
            self::ISSUE_BANK_NOT_SUPPORTED_FOR_VERIFICATION,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_VERIFICATION_FOR_THIS_BANK_ACCOUNT_IS_NOT_SUPPORTED,
        ];
    }
