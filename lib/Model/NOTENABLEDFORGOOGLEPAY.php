...
/**
 * NOTENABLEDFORGOOGLEPAY Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOTENABLEDFORGOOGLEPAY implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NOT_ENABLED_FOR_GOOGLE_PAY';
    ...
    public const ISSUE_NOT_ENABLED_FOR_GOOGLE_PAY = 'NOT_ENABLED_FOR_GOOGLE_PAY';
    public const DESCRIPTION_THE_API_CALLER_AND_OR_PAYEE_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_GOOGLE_PAY__PLEASE_CONTACT_YOUR_ACCOUNT_MANAGER = 'The 'API caller' and/or 'payee' is not setup to be able to process google pay. Please contact your Account Manager.';
    ...
    {
        return [
            self::ISSUE_NOT_ENABLED_FOR_GOOGLE_PAY,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_AND_OR_PAYEE_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_GOOGLE_PAY__PLEASE_CONTACT_YOUR_ACCOUNT_MANAGER,
        ];
    }
