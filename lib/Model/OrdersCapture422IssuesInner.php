...
/**
 * OrdersCapture422IssuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrdersCapture422IssuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders_capture_422_issues_inner';
    ...
    public const ISSUE_IDENTIFIER_NOT_FOUND = 'IDENTIFIER_NOT_FOUND';
    public const DESCRIPTION_SPECIFIED_IDENTIFIER_WAS_NOT_FOUND__PLEASE_VERIFY_THE_CORRECT_IDENTIFIER_WAS_USED_AND_TRY_THE_REQUEST_AGAIN = 'Specified identifier was not found. Please verify the correct identifier was used and try the request again.';
    ...
    {
        return [
            self::ISSUE_IDENTIFIER_NOT_FOUND,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_IDENTIFIER_WAS_NOT_FOUND__PLEASE_VERIFY_THE_CORRECT_IDENTIFIER_WAS_USED_AND_TRY_THE_REQUEST_AGAIN,
        ];
    }
