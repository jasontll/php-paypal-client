...
/**
 * MISSINGREQUIREDPARAMETER3 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MISSINGREQUIREDPARAMETER3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MISSING_REQUIRED_PARAMETER_3';
    ...
    public const ISSUE_MISSING_REQUIRED_PARAMETER = 'MISSING_REQUIRED_PARAMETER';
    public const DESCRIPTION_A_REQUIRED_FIELD_OR_PARAMETER_IS_MISSING = 'A required field or parameter is missing.';
    ...
    {
        return [
            self::ISSUE_MISSING_REQUIRED_PARAMETER,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_A_REQUIRED_FIELD_OR_PARAMETER_IS_MISSING,
        ];
    }
