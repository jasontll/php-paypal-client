...
/**
 * REFERENCEIDREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class REFERENCEIDREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'REFERENCE_ID_REQUIRED';
    ...
    public const ISSUE_REFERENCE_ID_REQUIRED = 'REFERENCE_ID_REQUIRED';
    public const DESCRIPTION_REFERENCE_ID_IS_REQUIRED_FOR_EACH_PURCHASE_UNIT_IF_MULTIPLE_PURCHASE_UNIT_ARE_PROVIDED = ''reference_id' is required for each 'purchase_unit' if multiple 'purchase_unit' are provided.';
    ...
    {
        return [
            self::ISSUE_REFERENCE_ID_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_REFERENCE_ID_IS_REQUIRED_FOR_EACH_PURCHASE_UNIT_IF_MULTIPLE_PURCHASE_UNIT_ARE_PROVIDED,
        ];
    }
