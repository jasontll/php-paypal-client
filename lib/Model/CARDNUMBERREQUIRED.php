...
/**
 * CARDNUMBERREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CARDNUMBERREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CARD_NUMBER_REQUIRED';
    ...
    public const ISSUE_CARD_NUMBER_REQUIRED = 'CARD_NUMBER_REQUIRED';
    public const DESCRIPTION_THE_CARD_NUMBER_IS_REQUIRED_WHEN_ATTEMPTING_TO_PROCESS_PAYMENT_WITH_CARD = 'The card number is required when attempting to process payment with card.';
    ...
    {
        return [
            self::ISSUE_CARD_NUMBER_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_CARD_NUMBER_IS_REQUIRED_WHEN_ATTEMPTING_TO_PROCESS_PAYMENT_WITH_CARD,
        ];
    }
