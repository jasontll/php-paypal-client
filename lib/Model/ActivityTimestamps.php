...
/**
 * ActivityTimestamps Class Doc Comment
 *
 * @category Class
 ...
 */
class ActivityTimestamps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'activity_timestamps';
    ...
    */
    ...
    public function setCreateTime($create_time)
    {
        ...
        if ((mb_strlen($create_time) > 64)) {
            throw new \InvalidArgumentException('invalid length for $create_time when calling ActivityTimestamps., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($create_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $create_time when calling ActivityTimestamps., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/", $create_time))) {
            throw new \InvalidArgumentException("invalid value for \$create_time when calling ActivityTimestamps., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/.");
        }
    ...
    public function setUpdateTime($update_time)
    {
        ...
        if ((mb_strlen($update_time) > 64)) {
            throw new \InvalidArgumentException('invalid length for $update_time when calling ActivityTimestamps., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($update_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $update_time when calling ActivityTimestamps., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/", $update_time))) {
            throw new \InvalidArgumentException("invalid value for \$update_time when calling ActivityTimestamps., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/.");
        }
