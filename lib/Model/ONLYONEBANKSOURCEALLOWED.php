...
/**
 * ONLYONEBANKSOURCEALLOWED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ONLYONEBANKSOURCEALLOWED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ONLY_ONE_BANK_SOURCE_ALLOWED';
    ...
    public const ISSUE_ONLY_ONE_BANK_SOURCE_ALLOWED = 'ONLY_ONE_BANK_SOURCE_ALLOWED';
    public const DESCRIPTION_MORE_THAN_ONE_PAYMENT_METHOD_WITHIN_THE_BANK_PAYMENT_OBJECT_IS_NOT_SUPPORTED = 'More than one payment method within the bank payment object is not supported.';
    ...
    {
        return [
            self::ISSUE_ONLY_ONE_BANK_SOURCE_ALLOWED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_MORE_THAN_ONE_PAYMENT_METHOD_WITHIN_THE_BANK_PAYMENT_OBJECT_IS_NOT_SUPPORTED,
        ];
    }
