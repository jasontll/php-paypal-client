...
/**
 * PATCHPATHREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PATCHPATHREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PATCH_PATH_REQUIRED';
    ...
    public const ISSUE_PATCH_PATH_REQUIRED = 'PATCH_PATH_REQUIRED';
    public const DESCRIPTION_PLEASE_SPECIFY_A_PATH_FOR_THE_FIELD_FOR_WHICH_THE_OPERATION_NEEDS_TO_BE_PERFORMED = 'Please specify a 'path' for the field for which the operation needs to be performed.';
    ...
    {
        return [
            self::ISSUE_PATCH_PATH_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PLEASE_SPECIFY_A_PATH_FOR_THE_FIELD_FOR_WHICH_THE_OPERATION_NEEDS_TO_BE_PERFORMED,
        ];
    }
