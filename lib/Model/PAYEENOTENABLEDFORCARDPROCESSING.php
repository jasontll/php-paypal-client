...
/**
 * PAYEENOTENABLEDFORCARDPROCESSING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEENOTENABLEDFORCARDPROCESSING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_NOT_ENABLED_FOR_CARD_PROCESSING';
    ...
    public const ISSUE_PAYEE_NOT_ENABLED_FOR_CARD_PROCESSING = 'PAYEE_NOT_ENABLED_FOR_CARD_PROCESSING';
    public const DESCRIPTION_PAYEE_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_CARD_PAYMENTS__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT = 'Payee account is not setup to be able to process card payments. Please contact PayPal customer support.';
    ...
    {
        return [
            self::ISSUE_PAYEE_NOT_ENABLED_FOR_CARD_PROCESSING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PAYEE_ACCOUNT_IS_NOT_SETUP_TO_BE_ABLE_TO_PROCESS_CARD_PAYMENTS__PLEASE_CONTACT_PAY_PAL_CUSTOMER_SUPPORT,
        ];
    }
