...
class ShippingDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipping_detail';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ShippingDetail., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ShippingDetail., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $type))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling ShippingDetail., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
    ...
    public function setOptions($options)
    {
        ...
        if ((count($options) > 10)) {
            throw new \InvalidArgumentException('invalid value for $options when calling ShippingDetail., number of items must be less than or equal to 10.');
        }
        if ((count($options) < 0)) {
            throw new \InvalidArgumentException('invalid length for $options when calling ShippingDetail., number of items must be greater than or equal to 0.');
        }
