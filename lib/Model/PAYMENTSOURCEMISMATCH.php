...
/**
 * PAYMENTSOURCEMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYMENTSOURCEMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYMENT_SOURCE_MISMATCH';
    ...
    public const ISSUE_PAYMENT_SOURCE_MISMATCH = 'PAYMENT_SOURCE_MISMATCH';
    public const DESCRIPTION_THE_PAYMENT_SOURCE_IN_THE_REQUEST_MUST_MATCH_THE_PAYMENT_SOURCE_USED_FOR_THE_AUTHORIZATION_OR_CAPTURE_REFERENCED_BY_PREVIOUS_TRANSACTION_REFERENCE__PLEASE_USE_PREVIOUS_TRANSACTION_REFERENCE_WHOSE_PAYMENT_SOURCE_MATCHES_WITH_THE_PAYMENT_SOURCE_SPECIFIED_IN_THE_ORDER = 'The `payment_source` in the request must match the `payment_source` used for the authorization or capture referenced by `previous_transaction_reference`. Please use `previous_transaction_reference` whose `payment_source` matches with the `payment_source` specified in the order.';
    ...
    {
        return [
            self::ISSUE_PAYMENT_SOURCE_MISMATCH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PAYMENT_SOURCE_IN_THE_REQUEST_MUST_MATCH_THE_PAYMENT_SOURCE_USED_FOR_THE_AUTHORIZATION_OR_CAPTURE_REFERENCED_BY_PREVIOUS_TRANSACTION_REFERENCE__PLEASE_USE_PREVIOUS_TRANSACTION_REFERENCE_WHOSE_PAYMENT_SOURCE_MATCHES_WITH_THE_PAYMENT_SOURCE_SPECIFIED_IN_THE_ORDER,
        ];
    }
