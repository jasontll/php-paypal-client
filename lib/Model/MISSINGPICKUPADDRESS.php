...
/**
 * MISSINGPICKUPADDRESS Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MISSINGPICKUPADDRESS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MISSING_PICKUP_ADDRESS';
    ...
    public const ISSUE_MISSING_PICKUP_ADDRESS = 'MISSING_PICKUP_ADDRESS';
    public const DESCRIPTION_A_PICKUP_ADDRESS_SHIPPING_ADDRESS_IS_REQUIRED_FOR_THE_PROVIDED_SHIPPING_TYPE = 'A pickup address(`shipping.address`) is required for the provided `shipping.type`.';
    ...
    {
        return [
            self::ISSUE_MISSING_PICKUP_ADDRESS,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_A_PICKUP_ADDRESS_SHIPPING_ADDRESS_IS_REQUIRED_FOR_THE_PROVIDED_SHIPPING_TYPE,
        ];
    }
