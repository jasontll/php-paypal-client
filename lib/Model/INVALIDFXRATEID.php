...
/**
 * INVALIDFXRATEID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDFXRATEID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_FX_RATE_ID';
    ...
    public const ISSUE_INVALID_FX_RATE_ID = 'INVALID_FX_RATE_ID';
    public const DESCRIPTION_THE_SPECIFIC_FX_RATE_ID_IS_NOT_VALID__THIS_COULD_BE_EITHER_BECAUSE_WE_ARE_NOT_ABLE_TO_LOOK_UP_THE_FX_RATE_BASED_ON_THIS_ID_OR_IT_COULD_BE_BECAUSE_THE_ID_BELONGS_TO_ANOTHER_API_CALLER = 'The specific FX Rate ID is not valid. This could be either because we are not able to look up the FX Rate based on this ID or it could be because the ID belongs to another API Caller.';
    ...
    {
        return [
            self::DESCRIPTION_THE_SPECIFIC_FX_RATE_ID_IS_NOT_VALID__THIS_COULD_BE_EITHER_BECAUSE_WE_ARE_NOT_ABLE_TO_LOOK_UP_THE_FX_RATE_BASED_ON_THIS_ID_OR_IT_COULD_BE_BECAUSE_THE_ID_BELONGS_TO_ANOTHER_API_CALLER,
        ];
    }
