...
/**
 * ITEMTOTALMISMATCH Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ITEMTOTALMISMATCH implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ITEM_TOTAL_MISMATCH';
    ...
    public const ISSUE_ITEM_TOTAL_MISMATCH = 'ITEM_TOTAL_MISMATCH';
    public const DESCRIPTION_SHOULD_EQUAL_SUM_OF__UNIT_AMOUNT__QUANTITY_ACROSS_ALL_ITEMS_FOR_A_GIVEN_PURCHASE_UNIT = 'Should equal sum of (unit_amount * quantity) across all items for a given purchase_unit.';
    ...
    {
        return [
            self::ISSUE_ITEM_TOTAL_MISMATCH,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_SHOULD_EQUAL_SUM_OF__UNIT_AMOUNT__QUANTITY_ACROSS_ALL_ITEMS_FOR_A_GIVEN_PURCHASE_UNIT,
        ];
    }
