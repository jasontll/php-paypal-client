...
/**
 * ALIASDECLINEDBYPROCESSOR Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ALIASDECLINEDBYPROCESSOR implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ALIAS_DECLINED_BY_PROCESSOR';
    ...
    public const ISSUE_ALIAS_DECLINED_BY_PROCESSOR = 'ALIAS_DECLINED_BY_PROCESSOR';
    public const DESCRIPTION_THE_PROVIDED_ALIAS_WAS_DECLINED_BY_THE_PROCESSOR__PLEASE_CREATE_A_NEW_ORDER_WITH_A_DIFFERENT_ALIAS_KEY_AND_OR_ALIAS_LABEL_AND_TRY_AGAIN = 'The provided alias was declined by the processor. Please create a new order with a different alias_key and/or alias_label and try again.';
    ...
    {
        return [
            self::ISSUE_ALIAS_DECLINED_BY_PROCESSOR,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_PROVIDED_ALIAS_WAS_DECLINED_BY_THE_PROCESSOR__PLEASE_CREATE_A_NEW_ORDER_WITH_A_DIFFERENT_ALIAS_KEY_AND_OR_ALIAS_LABEL_AND_TRY_AGAIN,
        ];
    }
