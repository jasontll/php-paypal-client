...
/**
 * INVALIDPICKUPADDRESS Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class INVALIDPICKUPADDRESS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'INVALID_PICKUP_ADDRESS';
    ...
    public const ISSUE_INVALID_PICKUP_ADDRESS = 'INVALID_PICKUP_ADDRESS';
    public const DESCRIPTION_IF_THE_SHIPPING_OPTION_TYPE_IS_SET_AS_PICKUP_THEN_THE_SHIPPING_DETAIL_NAME_FULL_NAME_SHOULD_START_WITH_S2_S_MEANING_SHIP_TO_STORE__EXAMPLE_S2_S_MY_STORE = 'If the 'shipping_option.type' is set as 'PICKUP' then the 'shipping_detail.name.full_name' should start with 'S2S' meaning Ship To Store. Example: 'S2S My Store'.';
    ...
    {
        return [
            self::ISSUE_INVALID_PICKUP_ADDRESS,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_IF_THE_SHIPPING_OPTION_TYPE_IS_SET_AS_PICKUP_THEN_THE_SHIPPING_DETAIL_NAME_FULL_NAME_SHOULD_START_WITH_S2_S_MEANING_SHIP_TO_STORE__EXAMPLE_S2_S_MY_STORE,
        ];
    }
