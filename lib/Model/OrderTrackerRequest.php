...
/**
 * OrderTrackerRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderTrackerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order_tracker_request';
    ...
    */
    ...
    public function setTransactionId($transaction_id)
    {
        ...
        if ((mb_strlen($transaction_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $transaction_id when calling OrderTrackerRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($transaction_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $transaction_id when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]*$/", $transaction_id))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_id when calling OrderTrackerRequest., must conform to the pattern /^[a-zA-Z0-9]*$/.");
        }
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if ((mb_strlen($tracking_number) > 64)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling OrderTrackerRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($tracking_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setShipmentDate($shipment_date)
    {
        ...
        if ((mb_strlen($shipment_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $shipment_date when calling OrderTrackerRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($shipment_date) < 10)) {
            throw new \InvalidArgumentException('invalid length for $shipment_date when calling OrderTrackerRequest., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $shipment_date))) {
            throw new \InvalidArgumentException("invalid value for \$shipment_date when calling OrderTrackerRequest., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
    ...
    public function setCarrierNameOther($carrier_name_other)
    {
        ...
        if ((mb_strlen($carrier_name_other) > 64)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name_other when calling OrderTrackerRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($carrier_name_other) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name_other when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPostagePaymentId($postage_payment_id)
    {
        ...
        if ((mb_strlen($postage_payment_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $postage_payment_id when calling OrderTrackerRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($postage_payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postage_payment_id when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 100)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderTrackerRequest., must be smaller than or equal to 100.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastUpdatedTime($last_updated_time)
    {
        ...
        if ((mb_strlen($last_updated_time) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_updated_time when calling OrderTrackerRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($last_updated_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $last_updated_time when calling OrderTrackerRequest., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/", $last_updated_time))) {
            throw new \InvalidArgumentException("invalid value for \$last_updated_time when calling OrderTrackerRequest., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])[T,t]([0-1][0-9]|2[0-3]):[0-5][0-9]:([0-5][0-9]|60)([.][0-9]+)?([Zz]|[+-][0-9]{2}:[0-9]{2})$/.");
        }
    ...
    public function setShipmentDirection($shipment_direction)
    {
        ...
        if ((mb_strlen($shipment_direction) > 50)) {
            throw new \InvalidArgumentException('invalid length for $shipment_direction when calling OrderTrackerRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($shipment_direction) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_direction when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $shipment_direction))) {
            throw new \InvalidArgumentException("invalid value for \$shipment_direction when calling OrderTrackerRequest., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
    ...
    public function setShipmentUploader($shipment_uploader)
    {
        ...
        if ((mb_strlen($shipment_uploader) > 50)) {
            throw new \InvalidArgumentException('invalid length for $shipment_uploader when calling OrderTrackerRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($shipment_uploader) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_uploader when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9A-Z_]+$/", $shipment_uploader))) {
            throw new \InvalidArgumentException("invalid value for \$shipment_uploader when calling OrderTrackerRequest., must conform to the pattern /^[0-9A-Z_]+$/.");
        }
    ...
    public function setCaptureId($capture_id)
    {
        ...
        if ((mb_strlen($capture_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $capture_id when calling OrderTrackerRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($capture_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $capture_id when calling OrderTrackerRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]*$/", $capture_id))) {
            throw new \InvalidArgumentException("invalid value for \$capture_id when calling OrderTrackerRequest., must conform to the pattern /^[a-zA-Z0-9]*$/.");
        }
