...
/**
 * CARDTYPENOTSUPPORTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CARDTYPENOTSUPPORTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CARD_TYPE_NOT_SUPPORTED';
    ...
    public const ISSUE_CARD_TYPE_NOT_SUPPORTED = 'CARD_TYPE_NOT_SUPPORTED';
    public const DESCRIPTION_PROCESSING_OF_THIS_CARD_TYPE_IS_NOT_SUPPORTED__USE_ANOTHER_CARD_TYPE = 'Processing of this card type is not supported. Use another card type.';
    ...
    {
        return [
            self::ISSUE_CARD_TYPE_NOT_SUPPORTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_PROCESSING_OF_THIS_CARD_TYPE_IS_NOT_SUPPORTED__USE_ANOTHER_CARD_TYPE,
        ];
    }
