...
/**
 * SETUPERRORFORBANK Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SETUPERRORFORBANK implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SETUP_ERROR_FOR_BANK';
    ...
    public const ISSUE_SETUP_ERROR_FOR_BANK = 'SETUP_ERROR_FOR_BANK';
    public const DESCRIPTION_THE_API_CALLER_ACCOUNT_SETUP_FOR_BANK_PAYMENTS_IS_INCOMPLETE_OR_INCORRECT__PLEASE_CONTACT_YOUR_PAY_PAL_ACCOUNT_MANAGER = 'The API Caller account setup, for bank payments, is incomplete or incorrect. Please contact your PayPal account manager.';
    ...
    {
        return [
            self::ISSUE_SETUP_ERROR_FOR_BANK,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_API_CALLER_ACCOUNT_SETUP_FOR_BANK_PAYMENTS_IS_INCOMPLETE_OR_INCORRECT__PLEASE_CONTACT_YOUR_PAY_PAL_ACCOUNT_MANAGER,
        ];
    }
