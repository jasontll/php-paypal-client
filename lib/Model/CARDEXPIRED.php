 ...
 */
class CARDEXPIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CARD_EXPIRED';
    ...
    public const ISSUE_CARD_EXPIRED = 'CARD_EXPIRED';
    public const DESCRIPTION_THE_CARD_IS_EXPIRED = 'The card is expired';
    ...
    {
        return [
            self::DESCRIPTION_THE_CARD_IS_EXPIRED,
        ];
    }
