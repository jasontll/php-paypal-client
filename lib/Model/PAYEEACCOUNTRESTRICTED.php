...
/**
 * PAYEEACCOUNTRESTRICTED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEEACCOUNTRESTRICTED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_ACCOUNT_RESTRICTED';
    ...
    public const ISSUE_PAYEE_ACCOUNT_RESTRICTED = 'PAYEE_ACCOUNT_RESTRICTED';
    public const DESCRIPTION_THE_MERCHANT_ACCOUNT_IS_RESTRICTED = 'The merchant account is restricted.';
    ...
    {
        return [
            self::ISSUE_PAYEE_ACCOUNT_RESTRICTED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_MERCHANT_ACCOUNT_IS_RESTRICTED,
        ];
    }
