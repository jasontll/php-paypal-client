...
/**
 * MISSINGPREVIOUSREFERENCE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MISSINGPREVIOUSREFERENCE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MISSING_PREVIOUS_REFERENCE';
    ...
    public const ISSUE_MISSING_PREVIOUS_REFERENCE = 'MISSING_PREVIOUS_REFERENCE';
    public const DESCRIPTION_FOR_MERCHANT_INITIATED_NETWORK_TOKEN_TRANSACTIONS_EITHER_THE_PAYMENT_SOURCE_CARD_STORED_CREDENTIAL_PREVIOUS_NETWORK_TRANSACTION_REFERENCE_OR_PAYMENT_SOURCE_CARD_STORED_CREDENTIAL_PREVIOUS_TRANSACTION_REFERENCE_MUST_BE_INCLUDED_IN_THE_REQUEST = 'For Merchant initiated network token transactions, either the payment_source.card.stored_credential.previous_network_transaction_reference or payment_source.card.stored_credential.previous_transaction_reference must be included in the request.';
    ...
    {
        return [
            self::ISSUE_MISSING_PREVIOUS_REFERENCE,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_FOR_MERCHANT_INITIATED_NETWORK_TOKEN_TRANSACTIONS_EITHER_THE_PAYMENT_SOURCE_CARD_STORED_CREDENTIAL_PREVIOUS_NETWORK_TRANSACTION_REFERENCE_OR_PAYMENT_SOURCE_CARD_STORED_CREDENTIAL_PREVIOUS_TRANSACTION_REFERENCE_MUST_BE_INCLUDED_IN_THE_REQUEST,
        ];
    }
