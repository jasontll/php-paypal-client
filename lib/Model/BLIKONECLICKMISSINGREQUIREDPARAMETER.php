...
/**
 * BLIKONECLICKMISSINGREQUIREDPARAMETER Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BLIKONECLICKMISSINGREQUIREDPARAMETER implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BLIK_ONE_CLICK_MISSING_REQUIRED_PARAMETER';
    ...
    public const ISSUE_BLIK_ONE_CLICK_MISSING_REQUIRED_PARAMETER = 'BLIK_ONE_CLICK_MISSING_REQUIRED_PARAMETER';
    public const DESCRIPTION_BLIKS_ONE_CLICK_FLOW_REQUIRES_ONE_CLICK_AUTH_CODE_AND_ONE_CLICK_ALIAS_LABEL_PARAMETERS_FOR_THE_BUYERS_FIRST_TRANSACTION__FOR_ALL_SUBSEQUENT_TRANSACTIONSONLY_THE_ONE_CLICK_ALIAS_KEY_PARAMETER_IS_REQUIRED = 'Blik's one_click flow requires one_click.auth_code and one_click.alias_label parameters for the buyer's first transaction. For all subsequent transactions,only the one_click.alias_key parameter is required.';
    ...
    {
        return [
            self::ISSUE_BLIK_ONE_CLICK_MISSING_REQUIRED_PARAMETER,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_BLIKS_ONE_CLICK_FLOW_REQUIRES_ONE_CLICK_AUTH_CODE_AND_ONE_CLICK_ALIAS_LABEL_PARAMETERS_FOR_THE_BUYERS_FIRST_TRANSACTION__FOR_ALL_SUBSEQUENT_TRANSACTIONSONLY_THE_ONE_CLICK_ALIAS_KEY_PARAMETER_IS_REQUIRED,
        ];
    }
