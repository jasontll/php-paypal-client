...
/**
 * PAYEEFXRATEIDEXPIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEEFXRATEIDEXPIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_FX_RATE_ID_EXPIRED';
    ...
    public const ISSUE_PAYEE_FX_RATE_ID_EXPIRED = 'PAYEE_FX_RATE_ID_EXPIRED';
    public const DESCRIPTION_THE_SPECIFIED_FX_RATE_ID_HAS_EXPIRED__PLEASE_SPECIFY_A_DIFFERENT_FX_RATE_ID_AND_TRY_THE_REQUEST_AGAIN__ALTERNATELY_REMOVE_THE_FX_RATE_ID_TO_PROCESS_THE_REQUEST_USING_THE_DEFAULT_EXCHANGE_RATE = 'The specified FX Rate ID has expired. Please specify a different FX Rate Id and try the request again. Alternately, remove the FX Rate ID to process the request using the default exchange rate.';
    ...
    {
        return [
            self::ISSUE_PAYEE_FX_RATE_ID_EXPIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_SPECIFIED_FX_RATE_ID_HAS_EXPIRED__PLEASE_SPECIFY_A_DIFFERENT_FX_RATE_ID_AND_TRY_THE_REQUEST_AGAIN__ALTERNATELY_REMOVE_THE_FX_RATE_ID_TO_PROCESS_THE_REQUEST_USING_THE_DEFAULT_EXCHANGE_RATE,
        ];
    }
