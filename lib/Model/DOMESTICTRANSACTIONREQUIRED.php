...
/**
 * DOMESTICTRANSACTIONREQUIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DOMESTICTRANSACTIONREQUIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DOMESTIC_TRANSACTION_REQUIRED';
    ...
    public const ISSUE_DOMESTIC_TRANSACTION_REQUIRED = 'DOMESTIC_TRANSACTION_REQUIRED';
    public const DESCRIPTION_THIS_TRANSACTION_REQUIRES_THE_PAYEE_AND_PAYER_TO_BE_RESIDENT_IN_THE_SAME_COUNTRY_A_DOMESTIC_TRANSACTION_IS_REQUIRED_TO_CREATE_THIS_PAYMENT = 'This transaction requires the payee and payer to be resident in the same country, a domestic transaction is required to create this payment.';
    ...
    {
        return [
            self::ISSUE_DOMESTIC_TRANSACTION_REQUIRED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THIS_TRANSACTION_REQUIRES_THE_PAYEE_AND_PAYER_TO_BE_RESIDENT_IN_THE_SAME_COUNTRY_A_DOMESTIC_TRANSACTION_IS_REQUIRED_TO_CREATE_THIS_PAYMENT,
        ];
    }
