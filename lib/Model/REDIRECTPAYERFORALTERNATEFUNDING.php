...
/**
 * REDIRECTPAYERFORALTERNATEFUNDING Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class REDIRECTPAYERFORALTERNATEFUNDING implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'REDIRECT_PAYER_FOR_ALTERNATE_FUNDING';
    ...
    public const ISSUE_REDIRECT_PAYER_FOR_ALTERNATE_FUNDING = 'REDIRECT_PAYER_FOR_ALTERNATE_FUNDING';
    public const DESCRIPTION_TRANSACTION_FAILED__REDIRECT_THE_PAYER_TO_SELECT_ANOTHER_FUNDING_SOURCE = 'Transaction failed. Redirect the payer to select another funding source.';
    ...
    {
        return [
            self::ISSUE_REDIRECT_PAYER_FOR_ALTERNATE_FUNDING,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_TRANSACTION_FAILED__REDIRECT_THE_PAYER_TO_SELECT_ANOTHER_FUNDING_SOURCE,
        ];
    }
