...
/**
 * PNREFEXPIRED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PNREFEXPIRED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PNREF_EXPIRED';
    ...
    public const ISSUE_PNREF_EXPIRED = 'PNREF_EXPIRED';
    public const DESCRIPTION_SPECIFIED_PNREF_HAS_EXPIRED__PNREF_EXPIRES_15_MONTHS_AFTER_THE_DATE_OF_THE_INITIAL_TRANSACTION = 'Specified `pnref` has expired. PNREF expires 15 months after the date of the initial transaction.';
    ...
    {
        return [
            self::DESCRIPTION_SPECIFIED_PNREF_HAS_EXPIRED__PNREF_EXPIRES_15_MONTHS_AFTER_THE_DATE_OF_THE_INITIAL_TRANSACTION,
        ];
    }
