...
/**
 * PAYEEACCOUNTLOCKEDORCLOSED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PAYEEACCOUNTLOCKEDORCLOSED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PAYEE_ACCOUNT_LOCKED_OR_CLOSED';
    ...
    public const ISSUE_PAYEE_ACCOUNT_LOCKED_OR_CLOSED = 'PAYEE_ACCOUNT_LOCKED_OR_CLOSED';
    public const DESCRIPTION_THE_MERCHANT_ACCOUNT_IS_LOCKED_OR_CLOSED = 'The merchant account is locked or closed.';
    ...
    {
        return [
            self::ISSUE_PAYEE_ACCOUNT_LOCKED_OR_CLOSED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_THE_MERCHANT_ACCOUNT_IS_LOCKED_OR_CLOSED,
        ];
    }
