...
/**
 * NOPAYMENTSOURCEPROVIDED Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NOPAYMENTSOURCEPROVIDED implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NO_PAYMENT_SOURCE_PROVIDED';
    ...
    public const ISSUE_NO_PAYMENT_SOURCE_PROVIDED = 'NO_PAYMENT_SOURCE_PROVIDED';
    public const DESCRIPTION_AT_LEAST_ONE_PAYMENT_METHOD_IS_REQUIRED_WITHIN_THE_PAYMENT_SOURCE = 'At least one payment method is required within the payment source.';
    ...
    {
        return [
            self::ISSUE_NO_PAYMENT_SOURCE_PROVIDED,
        ];
    }
    ...
    {
        return [
            self::DESCRIPTION_AT_LEAST_ONE_PAYMENT_METHOD_IS_REQUIRED_WITHIN_THE_PAYMENT_SOURCE,
        ];
    }
